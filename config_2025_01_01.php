...
switch ($_SERVER['SERVER_NAME']){
	...
	$conn=mysqli_connect('database-1.cluster-cvr3hgtayido.me-central-1.rds.amazonaws.com','zigo_dbuser','zigo1234','zigoshop');
	$conn2=mysqli_connect('database-1.cluster-ro-cvr3hgtayido.me-central-1.rds.amazonaws.com','zigo_dbuser','zigo1234','zigoshop');
	if(mysqli_connect_errno()){  echo "Failed to connect to MySQL: " . mysqli_connect_error();  }	
	break;
