...
for($j=0;$j<sizeof($po_item);$j++){
	$cell1=$k+7;
 	if($cat!=$po_category[$j]){
		...
		$objPHPExcel->getActiveSheet()->getStyle("A$cell1:C$cell1")->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);
		$objPHPExcel->getActiveSheet()->getStyle("A$cell1:C$cell1")->getFill()->getStartColor()->setARGB('FF808080');
 		$k++; $cell1=$k+7;
 		$cat=$po_category[$j];
 	}
...
$objPHPExcel->getActiveSheet()->getStyle('A4:C4')->getFill()->getStartColor()->setARGB('FF808080');
