      ...
      <tr>
        ...
        <?php
          ...
          if ($_REQUEST['components'] == 'supervisor') { ?>
            ...
            <a href="index.php?components=supervisor&action=credit&gp=&display=2" <?php print $slect3; ?>>Credit Report</a>
          ...
          if($_REQUEST['components'] == 'qb'){ ?>
            <button onmouseover="billingMenu2()" <?php print $slect1; ?> onclick="window.location = 'index.php?components=qb&action=accounts'">Accounts</button>
            <button onmouseover="billingMenu2()" <?php print $slect2; ?> onclick="window.location = 'index.php?components=qb&action=profit_and_loss'">Profit & Loss</button>
            <button onmouseover="billingMenu2()" <?php print $slect3; ?> onclick="window.location = 'index.php?components=qb&action=trial_balance'">Trail Balance</button>
            <button onmouseover="billingMenu2()" <?php print $slect4; ?> onclick="window.location = 'index.php?components=qb&action=balance_sheet'">Balance Sheet</button>
            <button onmouseover="billingMenu2()" <?php print $slect5; ?> onclick="window.location = 'index.php?components=qb&action=journal_report'">Journal Report</button>
            <button onmouseover="billingMenu2()" <?php print $slect6; ?> onclick="window.location = 'index.php?components=qb&action=vendors'">Vendors</button>
        <?php }
