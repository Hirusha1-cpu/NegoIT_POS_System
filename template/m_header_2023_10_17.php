	...
	<nav class="w3-sidenav w3-card-2 w3-white w3-top" style="width:30%;display:none;z-index:2" id="mySidenav">
		...
		<?php
			...
			<?php if ($_REQUEST['components'] == 'availability') { ?>
				...
				<?php if (($systemid == 13) || ($systemid == 14) || ($systemid == 15) || ($systemid == 16) || ($systemid == 17)) print '<a href="index.php?components=availability&action=catalog">Catalog</a>'; ?>
			...
			<?php if ($_REQUEST['components'] == 'order_process') { ?>
				...
				<a href="index.php?components=order_process&action=list_packed">Packed</a>
				<a href="index.php?components=order_process&action=list_shipped">Shipped</a>
				<a href="index.php?components=order_process&action=list_delivered">Delivered</a>
			...
			if ($_REQUEST['components'] == 'supervisor') { ?>
				...
				<?php if(bill_module() == 'bill2') { ?> <a href="index.php?components=supervisor&action=temporary_bills">Temporary Bills</a> <?php } ?>
			...
			<?php if ($_REQUEST['components'] == 'manager') { ?>
				...
				<?php if(bill_module() == 'bill2') { ?> <a href="index.php?components=manager&action=temporary_bills">Temporary Bills</a> <?php } ?>
			...
			<?php if ($_REQUEST['components'] == 'topmanager') { ?>
				...
				<?php if(bill_module() == 'bill2') { ?> <a href="index.php?components=topmanager&action=temporary_bills">Temporary Bills</a> <?php } ?>
					...
					<?php
						switch ($_REQUEST['components']) {
							...
							case "order_process":
								...
								} else if ($_REQUEST['action'] == 'list_shipped') {
							...
							case "topmanager":
								if ($_REQUEST['action'] == 'device_mgmt') {
									...
									print '<td> Unlocked Bills</td><td align="right"></td>';
								} else if ((bill_module() == 'bill2') && ($_REQUEST['action'] == 'temporary_bills')) {
							...
							case "to":
									if ($_REQUEST['action'] == 'home') {
										print '<td>TO</td><td align="right">Create Spec</td>';
									}
							break;
