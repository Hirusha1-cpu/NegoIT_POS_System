    ...
    <table align="center" bgcolor="<?php print $headercolor; ?>" width="95%">
      <?php
              ...
              <td>
                <div
                    <?php
                        ...
                        <a class="Main_menu_letters" href="index.php?components=inventory&action=show_all_item&category=<?php print $menu_cat; ?>&store=<?php print $store; ?>&type=1" <?php print $localstyle5; ?> title="Inventory">INV</a>
                </div>
              </td>
              <td width="30px"></td>
        <?php }
        if (isset($_COOKIE['stk'])) {
          $module_count += 2; ?>
          <td>
            <div <?php if ($components == 'stk') print 'class="Main_menu1"';
                  else print 'class="Main_menu2"'; ?>><a class="Main_menu_letters" href="index.php?components=stk&action=show_add_shipment_tmp&sub=show_add_qty_tmp" title="Stocks">STK</a></div>
          </td>
          <td width="30px"></td>
        <?php }
        ...
        if (isset($_COOKIE['qb'])) {
          $module_count += 2; ?>
          <td>
            <div <?php if ($components == 'qb') print 'class="Main_menu1"';
                  else print 'class="Main_menu2"'; ?>><a class="Main_menu_letters" href="index.php?components=qb&action=accounts" title="Accounts">QB</a></div>
          </td>
          <td width="30px"></td>
        <?php }
        ...
        <?php
            ...
            <div class="dropdown">
              <button onmouseover="billingMenu3()" onmouseleave="billingMenu3()" <?php print $slect11; ?>>Reports</button>
                <div id="myDropdown3" class="dropdown-content">
                  ...
                  <?php }else{ ?>
                    <a onmouseover="billingMenu3()" onmouseleave="billingMenu3()" style="font-size:11pt" href="index.php?components=billing&action=credit&gp=&display=2">Credit Report</a>
                  <?php } ?>
          ...
          if ($_REQUEST['components'] == 'bill2') { ?>
            ...
            <div class="dropdown">
                <button onmouseover="billingMenu3()" onmouseleave="billingMenu3()" <?php print $slect11; ?>>Reports</button>
                <div id="myDropdown3" class="dropdown-content">
                  <a onmouseover="billingMenu3()" onmouseleave="billingMenu3()" style="font-size:11pt" href="index.php?components=bill2&action=credit&gp=&display=2">Credit Report</a>
            ...
            <?php if(isSalesmanPaymentDepositActive()){ ?>
              <div class="dropdown">
                <button onmouseover="billingMenu4()" onmouseleave="billingMenu4()" <?php print $slect13; ?>>Payment Deposit</button>
                <div id="myDropdown4" class="dropdown-content">
                  <a onmouseover="billingMenu4()" onmouseleave="billingMenu4()" style="font-size:11pt" href="index.php?components=bill2&action=cash_payment_deposit">Add Cash Deposit</a>
                  <a onmouseover="billingMenu4()" onmouseleave="billingMenu4()" style="font-size:11pt" href="index.php?components=bill2&action=bank_payment_deposit">Add Bank Deposit</a>
                  <a onmouseover="billingMenu4()" onmouseleave="billingMenu4()" style="font-size:11pt" href="index.php?components=bill2&action=cheque_transfer">Add Cheque Trans</a>
                  <a onmouseover="billingMenu4()" onmouseleave="billingMenu4()" style="font-size:11pt" href="index.php?components=bill2&action=cash_sent_report">Cash Payments Sent Report</a>
                  <a onmouseover="billingMenu4()" onmouseleave="billingMenu4()" style="font-size:11pt" href="index.php?components=bill2&action=bank_payments_sent_report">Bank Payments Sent Report</a>
                  <a onmouseover="billingMenu4()" onmouseleave="billingMenu4()" style="font-size:11pt" href="index.php?components=bill2&action=cheque_transfer_summery">Cheque Trans Summery</a>
                  <a onmouseover="billingMenu4()" onmouseleave="billingMenu4()" style="font-size:11pt" href="index.php?components=bill2&action=cheque_transfer_status_summery">Cheque Trans Status Summery</a>
                  <a onmouseover="billingMenu4()" onmouseleave="billingMenu4()" style="font-size:11pt" href="index.php?components=bill2&action=cheque_transfer_returns">Cheque Trans Returns</a>
                </div>
              </div>
            <?php } ?>
          <?php }
          ...
          // ------------------------ SUPERVISOR ------------------------ //
          if ($_REQUEST['components'] == 'supervisor') { $component_name = 'supervisor'; ?>
            <a href="index.php?components=<?php echo $component_name; ?>&action=sale&store=<?php print $_COOKIE['store']; ?>&group=all&salesman=all&processby=all&lock=1&type=" <?php print $slect1; ?>>Sales Report</a>
            ...
            <a href="index.php?components=<?php echo $component_name; ?>&action=sales_byrep" <?php print $slect4; ?>>Sales by Rep</a>
            ...
            <div class="dropdown">
              <button onmouseover="billingMenu2()" onmouseleave="billingMenu2()" onclick="window.location = 'index.php?components=<?php echo $component_name; ?>&action=quotation'" <?php print $slect8; ?>>Quotation</button>
              <div id="myDropdown" class="dropdown-content">
                <a onmouseover="billingMenu2()" onmouseleave="billingMenu2()" style="font-size:11pt" href="index.php?components=<?php echo $component_name; ?>&action=quotation">New Quotation</a>
                <a onmouseover="billingMenu2()" onmouseleave="billingMenu2()" style="font-size:11pt" href="index.php?components=<?php echo $component_name; ?>&action=quotation_ongoing">On-Going Quotation</a>
                <a onmouseover="billingMenu2()" onmouseleave="billingMenu2()" style="font-size:11pt" href="index.php?components=<?php echo $component_name; ?>&action=quotation_list&cust=&item=&st=&sm=&status=all">Quotation List</a>
                <a onmouseover="billingMenu2()" onmouseleave="billingMenu2()" style="font-size:11pt" href="index.php?components=<?php echo $component_name; ?>&action=quotation_report&cust=&qo_no=&st=&sm=&status=all">Report</a>
              </div>
            </div>
            <div class="dropdown">
              <button onmouseover="billingMenu3()" onmouseleave="billingMenu3()" <?php print $slect10; ?>>Incompleted</button>
              <div id="myDropdown3" class="dropdown-content">
                <a onmouseover="billingMenu3()" onmouseleave="billingMenu3()" style="font-size:11pt" href="index.php?components=<?php echo $component_name; ?>&action=unlocked">Unlocked Bills</a>
                <?php if(bill_module(1) == 'bill2') { ?> <a onmouseover="billingMenu3()" onmouseleave="billingMenu3()" style="font-size:11pt" href="index.php?components=<?php echo $component_name; ?>&action=temporary_bills">Temporary Bills</a> <?php } ?>
              </div>
            </div>
            <a href="index.php?components=<?php echo $component_name; ?>&action=newcust" <?php print $localstyle2; print $slect9; ?>>Customer MGMT</a>
            ...
            <?php if(isSalesmanPaymentDepositActive()){ ?>
              ...
              <div class="dropdown">
                ...
                <div id="myDropdown9" class="dropdown-content">
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=<?php echo $component_name; ?>&action=pending_payment_cash_deposits">Pending Cash Deposits</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=<?php echo $component_name; ?>&action=pending_payment_bank_deposits">Pending Bank Deposits</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=<?php echo $component_name; ?>&action=pending_cheque_transfers">Pending Cheque Trans</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=<?php echo $component_name; ?>&action=cash_transfer_deposits_report">Cash Trans Summery</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=<?php echo $component_name; ?>&action=bank_transfer_deposits_report">Bank Trans Summery</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=<?php echo $component_name; ?>&action=cheque_transfer">Cheque Trans</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=<?php echo $component_name; ?>&action=approved_cheque_transfers">Modify Cheque</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=<?php echo $component_name; ?>&action=trans_return_cheque">Trans Return Cheque</a>
                </div>
              </div>
            <?php } ?>
          <?php }
          ...
          if ($_REQUEST['components'] == 'manager') { ?>
            ...
            <div class="dropdown">
              ...
              <div id="myDropdown" class="dropdown-content">
                ...
                <a onmouseover="billingMenu2()" onmouseleave="billingMenu2()" style="font-size:11pt" href="index.php?components=manager&action=credit&display=2">Credit Report</a>
                ...
                <?php
                  if($systemid == 24){
                    if($_COOKIE['user_id'] == 6 || $_COOKIE['user_id'] == 15 || $_COOKIE['user_id'] == 17){ ?>
                        <a onmouseover="billingMenu7()" onmouseleave="billingMenu7()" style="font-size:11pt" href="index.php?components=manager&action=chque_pending_finalyze">Tobe Deposit Cheque</a>
                   <?php }
                  }else{ ?>
                    <a onmouseover="billingMenu7()" onmouseleave="billingMenu7()" style="font-size:11pt" href="index.php?components=manager&action=chque_pending_finalyze">Tobe Deposit Cheque</a>
                    <? if(isSalesmanPaymentDepositActive()) { ?>
                      <a onmouseover="billingMenu7()" onmouseleave="billingMenu7()" style="font-size:11pt" href="index.php?components=manager&action=chque_pending_finalyze2">Tobe Deposit Cheque 2</a>
                    <? } ?>
                 <?php }
                ?>
            ...
            <?php if(isSalesmanPaymentDepositActive()){ ?>
              ...
              <div class="dropdown">
                ...
                <div id="myDropdown9" class="dropdown-content">
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=manager&action=pending_payment_cash_deposits">Pending Cash Deposits</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=manager&action=pending_payment_bank_deposits">Pending Bank Deposits</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=manager&action=pending_cheque_transfers">Pending Cheque Trans</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=manager&action=cash_transfer_deposits_report">Cash Trans Summery</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=manager&action=bank_transfer_deposits_report">Bank Trans Summery</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=manager&action=cash_on_hand_report">Cash On Hand Report</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=manager&action=cheque_transfer">Cheque Trans</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=manager&action=approved_cheque_transfers">Modify Cheque</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=manager&action=cheque_trans_summery">Cheque Trans Summery</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=manager&action=cheque_on_hand">Cheque On Hand</a>
                  <a onmouseover="billingMenu9()" onmouseleave="billingMenu9()" style="font-size:11pt" href="index.php?components=manager&action=trans_return_cheque">Trans Return Cheque</a>
                </div>
              </div>
            <?php } ?>
          <?php }
          ...
          if ($_REQUEST['components'] == 'topmanager') { ?>
            <div class="dropdown">
              ...
              <div id="myDropdown" class="dropdown-content">
                ...
                <a onmouseover="billingMenu2()" onmouseleave="billingMenu2()" style="font-size:11pt" href="index.php?components=topmanager&action=credit&display=2&sub_system=0">Credit Report</a>
                ...
                <a onmouseover="billingMenu2()" onmouseleave="billingMenu2()" style="font-size:11pt" href="index.php?components=topmanager&action=trans_report">Trans Report</a>
              </div>
            </div>
            ...
            <div class="dropdown">
              ...
              <div id="myDropdown5" class="dropdown-content">
                <a onmouseover="billingMenu5()" onmouseleave="billingMenu5()" style="font-size:11pt" href="index.php?components=topmanager&action=chque_pending_finalyze">Tobe Deposit Cheque</a>
                <? if(isSalesmanPaymentDepositActive()) { ?>
                    <a onmouseover="billingMenu5()" onmouseleave="billingMenu5()" style="font-size:11pt" href="index.php?components=topmanager&action=chque_pending_finalyze2">Tobe Deposit Cheque 2</a>
                <? } ?>
          ...
          if ($_REQUEST['components'] == 'marketing') { ?>
            ...
            <a href="index.php?components=marketing&action=credit&display=2&sub_system=0" <?php print $slect7; ?>>Credit Report</a>
          ...
          if ($_REQUEST['components'] == 'fin') { ?>
            ...
            <div class="dropdown">
              ...
              <div id="myDropdown4" class="dropdown-content">
                <a onmouseover="billingMenu4()" onmouseleave="billingMenu4()" style="font-size:11pt" href="index.php?components=fin&action=chque_pending_finalyze">Tobe Deposit Cheque</a>
                <? if(isSalesmanPaymentDepositActive()) { ?>
                    <a onmouseover="billingMenu4()" onmouseleave="billingMenu4()" style="font-size:11pt" href="index.php?components=fin&action=chque_pending_finalyze2">Tobe Deposit Cheque 2</a>
                <? } ?>
          ...
          if ($_REQUEST['components'] == 'report') { ?>
            ...
            <div class="dropdown">
              ...
              <div id="myDropdown7" class="dropdown-content">
                <a  onmouseover="billingMenu7()" onmouseleave="billingMenu7()" style="font-size:11pt" href="index.php?components=report&action=chque_pending_finalyze">Tobe Deposit Cheque</a>
                <? if(isSalesmanPaymentDepositActive()) { ?>
                    <a onmouseover="billingMenu7()" onmouseleave="billingMenu7()" style="font-size:11pt" href="index.php?components=report&action=chque_pending_finalyze2">Tobe Deposit Cheque 2</a>
                <? } ?>
              </div>
            </div>
