...
<body>
  ...
  <?php
    if (isset($_COOKIE['user_id'])) {
      ...
      switch ($components){
        case 'inventory':
          $guid_link = "http://billinguserguide.negoit.net/index.php?components=home&action=inventory";
          break;
        case 'availability':
          $guid_link = "http://billinguserguide.negoit.net/index.php?components=home&action=availability";
          break;
        case 'trans':
          $guid_link = "http://billinguserguide.negoit.net/index.php?components=home&action=trans";
          break;
        case 'billing':
          $guid_link = "http://billinguserguide.negoit.net/index.php?components=home&action=billing";
          break;
        case 'bill2':
          $guid_link = "http://billinguserguide.negoit.net/index.php?components=home&action=bill2";
          break;
        case 'supervisor':
          $guid_link = "http://billinguserguide.negoit.net/index.php?components=home&action=supervisor";
          break;
        case 'manager':
          $guid_link = "http://billinguserguide.negoit.net/index.php?components=home&action=manager";
          break;
        case 'topmanager':
          $guid_link = "http://billinguserguide.negoit.net/index.php?components=home&action=top_manager";
          break;
        case 'purchase_order':
          $guid_link = "http://billinguserguide.negoit.net/index.php?components=home&action=po";
          break;
        case 'accounts':
          $guid_link = "http://billinguserguide.negoit.net/";
          break;
        case 'hire_purchase':
          $guid_link = "http://billinguserguide.negoit.net/index.php?components=home&action=hire_purchase";
          break;
        case 'fin':
          $guid_link = "http://billinguserguide.negoit.net/index.php?components=home&action=finance";
          break;
        case 'hr':
          $guid_link = "http://billinguserguide.negoit.net/index.php?components=home&action=hr";
          break;
        case 'report':
          $guid_link = "http://billinguserguide.negoit.net/index.php?components=home&action=reports";
          break;
        case 'settings':
          $guid_link = "http://billinguserguide.negoit.net/index.php?components=home&action=settings";
          break;
        default:
          $guid_link = "http://billinguserguide.negoit.net/";
          break;
  ...
  <div style="background-color: <?php print $headercolor; ?>; border-radius: 5px;">
    <table align="center" bgcolor="<?php print $headercolor; ?>" width="95%">
      ...
      if (isset($_COOKIE['inventory'])) {
        ...
        <tr>
          <td>
            <div <?php if ($components == 'inventory') print 'class="Main_menu1"';
                  else print 'class="Main_menu2"'; ?>><a class="Main_menu_letters" href="index.php?components=inventory&action=show_all_item&category=<?php print $menu_cat; ?>&store=<?php print $_COOKIE['store']; ?>&type=1" <?php print $localstyle5; ?> title="Inventory">INV</a></div>
          </td>
          <td width="30px"></td>
      <?php }
          ...
          ?>
            <td>
              <div <?php if ($components == 'manager') print 'class="Main_menu1"';
                    else print 'class="Main_menu2"'; ?>><a class="Main_menu_letters" href="index.php?components=manager&action=quotation_approve" <?php print $localstyle1; ?> title="Manager">MGR</a></div>
            </td>
          <?php } else { ?>
            <td>
              <div <?php if ($components == 'manager') print 'class="Main_menu1"';
                    else print 'class="Main_menu2"'; ?>><a class="Main_menu_letters" href="index.php?components=manager&action=daily_sale&store=all&group=all&salesman=all&processby=all&lock=1&cashback=no&type=" <?php print $localstyle1; ?> title="Manager">MGR</a></div>
            </td>
          <?php } ?>
          <td width="30px"></td>
        <?php }
        ...
        <tr>
          <td colspan="<?php print $module_count; ?>" align="center">
            <?php if ($_REQUEST['components'] == 'availability'){
	              ...
	              if(($systemid == 1 && $approver1) || ($systemid == 13) || ($systemid == 14) || ($systemid == 15) || ($systemid == 16) || ($systemid == 17)) print '<button onmouseover="billingMenu2()" '.$slect2.' onclick="window.location = \'index.php?components=availability&action=catalog\'">Catalog</button> ';
            ...
            if ($_REQUEST['components'] == 'inventory') {
              if (($systemid != 1) || ($systemid == 1 && $sub_system == 0) || ($systemid == 1 && $sub_system == 1)) { ?>
                ...
                <!-- <a href="index.php?components=inventory&action=show_add_shipment&sub=show_add_qty" <?php print $slect2; ?>>Add Qty</a>  -->
                <a href="index.php?components=inventory&action=show_add_shipment_tmp&sub=show_add_qty_tmp" <?php print $slect2; ?>>Add Qty</a>
                <!-- <a href="index.php?components=inventory&action=show_add_shipment&sub=show_add_unic" <?php print $slect3; ?>>Add Unique</a>  -->
              ...
              <a href="index.php?components=inventory&action=shipmentlist&month=<?php print date("Y-m", time()); ?>" <?php print $slect10; ?>>Shipments</a>
            <?php }
            ...
            if ($_REQUEST['components'] == 'billing') { ?>
              ...
              <?php if ($systemid != 15) print '<a href="index.php?components=billing&action=item_return" ' . $slect8 . ' >Item Return</a>'; ?>
            ...
            if ($_REQUEST['components'] == 'bill2') { ?>
              ...
              <div class="dropdown">
                <button onmouseover="billingMenu2()" onmouseleave="billingMenu2()" onclick="#" <?php print $slect11; ?>>Quotation</button>
                <div id="myDropdown" class="dropdown-content">
            ...
            if ($_REQUEST['components'] == 'order_process') { ?>
              ...
              <a href="index.php?components=order_process&action=list_packed" <?php print $slect4; ?>>Packed</a>
              <a href="index.php?components=order_process&action=list_shipped" <?php print $slect5; ?>>Shipped</a>
              <a href="index.php?components=order_process&action=list_delivered" <?php print $slect6; ?>>Delivered</a>
              ...
              <?php if ($approver2) { ?>
                <div class="dropdown">
                  ...
                  <div id="myDropdown3" class="dropdown-content">
                    <a onmouseover="billingMenu3()" onmouseleave="billingMenu3()" style="font-size:11pt" href="index.php?components=order_process&action=report_commision">Commision Report</a>
            ...
            if ($_REQUEST['components'] == 'supervisor') { ?>
              ...
              <?php if ($_COOKIE['user'] == 'nimesha' || $_COOKIE['user'] == 'udari' || $_COOKIE['user'] == 'chathurangi')
              ...
              <div class="dropdown">
                ...
                <div id="myDropdown3" class="dropdown-content">
                  ...
                  <?php if(bill_module() == 'bill2') { ?> <a onmouseover="billingMenu3()" onmouseleave="billingMenu3()" style="font-size:11pt" href="index.php?components=supervisor&action=temporary_bills">Temporary Bills</a> <?php } ?>
                </div>
              </div>
            ...
            if ($_REQUEST['components'] == 'manager') { ?>
              ...
              <div class="dropdown">
                ...
                <div id="myDropdown3" class="dropdown-content">
                  ...
                  <?php if(bill_module() == 'bill2') { ?>  <a onmouseover="billingMenu3()" onmouseleave="billingMenu3()" style="font-size:11pt" href="index.php?components=manager&action=temporary_bills">Temporary Bills</a> <?php } ?>
                </div>
              </div>
              ...
              <!--
                  <div class="dropdown" >
                    <button onmouseover="billingMenu5()" onmouseleave="billingMenu5()" <?php print $slect7; ?> >Unique Items</button>
                    <div id="myDropdown5" class="dropdown-content">
                      <a onmouseover="billingMenu5()" onmouseleave="billingMenu5()" style="font-size:11pt" href="index.php?components=manager&action=unic_items&item&store=all&status=0">Unique Search</a>
                      <a onmouseover="billingMenu5()" onmouseleave="billingMenu5()" style="font-size:11pt" href="index.php?components=manager&action=sn_lookup&item_id=">S/N Lookup</a>
                    </div>
                  </div>
                  -->
              ...
              <!-- /Hirepurchase dropdown -->
              <?php if ($sub_system == 0) print '<a href="index.php?components=manager&action=shipment" ' . $slect10 . '>Shipment</a>'; ?>
              <!-- Cheque dropdown -->
              <div class="dropdown">
              ...
              <!-- Payment dropdown -->
              <div class="dropdown">
                <button onmouseover="billingMenu3()" onmouseleave="billingMenu3()" onclick="window.location = 'index.php?components=manager&action=payment'" <?php print $slect16; ?>>Payment</button>
                <div id="myDropdown3" class="dropdown-content">
                  <a onmouseover="billingMenu3()" onmouseleave="billingMenu3()" style="font-size:11pt" href="index.php?components=manager&action=payment">Payment Dashboard</a>
                  <a onmouseover="billingMenu3()" onmouseleave="billingMenu3()" style="font-size:11pt" href="index.php?components=manager&action=payment_history">Report History</a>
                </div>
              </div>
              <!--/ Payment dropdown -->
            <?php }
            ...
            if ($_REQUEST['components'] == 'topmanager') { ?>
              ...
              <div class="dropdown">
                ...
                <div id="myDropdown3" class="dropdown-content">
                  ...
                  <?php if(bill_module() == 'bill2') { ?> <a onmouseover="billingMenu3()" onmouseleave="billingMenu3()" style="font-size:11pt" href="index.php?components=topmanager&action=temporary_bills">Temporary Bills</a> <?php } ?>
                </div>
              </div>
              <div class="dropdown">
              ...
              <a href="index.php?components=topmanager&action=shipment" <?php print $slect9; ?>>Shipment</a>
              <div class="dropdown">
              ...
              <div class="dropdown">
                <button onmouseover="billingMenu3()" onmouseleave="billingMenu3()" onclick="window.location = 'index.php?components=topmanager&action=payment'" <?php print $slect14; ?>>Payment</button>
                <div id="myDropdown3" class="dropdown-content">
                  <a onmouseover="billingMenu3()" onmouseleave="billingMenu3()" style="font-size:11pt" href="index.php?components=topmanager&action=payment">Payment Dashboard</a>
                  <a onmouseover="billingMenu3()" onmouseleave="billingMenu3()" style="font-size:11pt" href="index.php?components=topmanager&action=payment_history">Report History</a>
                </div>
              </div>
