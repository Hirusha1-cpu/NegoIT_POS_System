        ...
        <tr>
          <td colspan="<?php print $module_count; ?>" align="center">
            ...
            if ($_REQUEST['components'] == 'supervisor') { ?>
              ...
              <?php if ($_COOKIE['user'] == 'nimesha' || $_COOKIE['user'] == 'udari')
            ...
            if ($_REQUEST['components'] == 'marketing') { ?>
              ...
              <a href="index.php?components=marketing&action=cust_sale" <?php print $slect5; ?>>Customer Report</a>
              <a href="index.php?components=marketing&action=credit&st=1&display=2&sub_system=0" <?php print $slect6; ?>>Credit Report</a>
              <a href="index.php?components=marketing&action=credit_trend" <?php print $slect7; ?>>Credit Trend</a>
              <a href="index.php?components=marketing&action=catalog" <?php print $slect8; ?>>Catalog</a>
            <?php }
            ...
            if ($_REQUEST['components'] == 'report') { ?>
              <a href="index.php?components=report&action=sales_report" <?php print $slect1; ?>>Sales Report</a>
              <a href="index.php?components=report&action=category_profit&subsys=all" <?php print $slect2; ?>>Category <?php if($systemid==1) print 'Cash'; else print 'Profit'; ?></a>
              <div class="dropdown">
