            ...
            <tr>
              <td>
                <div
                    ...
                    <?php if ($components == 'inventory') print 'class="Main_menu1"';
                        else print 'class="Main_menu2"'; ?>><a class="Main_menu_letters" href="index.php?components=inventory&action=show_all_item&category=<?php print $menu_cat; ?>&store=<?php print $_COOKIE['store']; ?>&type=1" <?php print $localstyle5; ?> title="Inventory">INV</a>
                  </div>
      ...
      <tr>
        ...
        <?php
          ...
          if ($_REQUEST['components'] == 'availability'){
              ...
              if(($systemid == 1 && $approver1) || ($systemid == 14) || ($systemid == 15) || ($systemid == 16) || ($systemid == 17)) print '<button onmouseover="billingMenu2()" '.$slect2.' onclick="window.location = \'index.php?components=availability&action=catalog\'">Catalog</button> ';
          ...
          if ($_REQUEST['components'] == 'order_process') { ?>
            ...
            <a href="index.php?components=order_process&action=list_packed" <?php print $slect4; ?>><?php if($systemid == 13) echo 'Started'; else print 'Packed';?></a>
            <?php if($systemid !=  13) { ?>
              <a href="index.php?components=order_process&action=list_shipped" <?php print $slect5; ?>>Shipped</a>
            <?php } ?>
            <a href="index.php?components=order_process&action=list_delivered" <?php print $slect6; ?>><?php if($systemid == 13) echo 'Finished'; else print 'Delivered';?></a>
