...
<body>
	<nav class="w3-sidenav w3-card-2 w3-white w3-top" style="width:30%;display:none;z-index:2" id="mySidenav">
		...
		<?php if ($_REQUEST['components'] == 'bill2') { ?>
			...
			if ($systemid != 15)
				print '<a href="index.php?components=bill2&action=select_cust_item_return">Item Return</a>';
			?>
		...
		<?php if ($_REQUEST['components'] == 'order_process') { ?>
			...
			<?php if (isOdrCrossCheckActive()) { ?>
				<a href="index.php?components=order_process&action=list_cross_check">Cross Check</a>
				<a href="index.php?components=order_process&action=list_my_cross_check">My Cross Check List</a>
			<?php } ?>
		...
		<?php if ($_REQUEST['components'] == 'manager') { ?>
			...
			<a href="index.php?components=manager&action=item_monthly_sales_report">Item Sale Monthly Report</a>
			<?php
			if ($systemid == 24) {
		...
		if ($_REQUEST['components'] == 'marketing') { ?>
			...
			<a href="index.php?components=marketing&action=item_monthly_sales_report">Sales Monthly</a>
		<?php }
					...
					switch ($_REQUEST['components']) {
						...
						case "manager":
							if ($_REQUEST['action'] == 'device_mgmt') {
								...
								print '<td>Quotation Finish</td><td align="right"></td>';
							} else if ($_REQUEST['action'] == 'item_monthly_sales_report') {
								print '<td>Item Monthly Sales Report</td><td align="right"></td>';
							} else {
