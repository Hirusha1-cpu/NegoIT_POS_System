	...
	<nav class="w3-sidenav w3-card-2 w3-white w3-top" style="width:30%;display:none;z-index:2" id="mySidenav">
		...
		<?php
			...
			<?php if ($_REQUEST['components'] == 'order_process') { ?>
				...
				<a href="index.php?components=order_process&action=list_packed"><?php if($systemid == 13) echo 'Started'; else print 'Packed';?></a>
				<?php if($systemid =!  13) { ?> <a href="index.php?components=order_process&action=list_shipped">Shipped</a>  <?php } ?>
				<a href="index.php?components=order_process&action=list_delivered"><?php if($systemid == 13) echo 'Finished'; else print 'Delivered';?></a>
			...
			<?php if ($_REQUEST['components'] == 'inventory') {
				...
				if ($sub_system == 0) {
					...
					print '<a href="index.php?components=inventory&action=shipmentlist&month=' . date("Y-m", time()) . '">Shipments</a>';
				}
			} ?>
						...
						switch ($_REQUEST['components']) {
							...
							case "order_process":
								if ($_REQUEST['action'] == 'list_custodr') {
									...
									if($systemid == 13) $packed = 'Started'; else $packed = 'Packed';
									...
									if($systemid == 13) $delivered = 'Finished'; else $delivered = 'Delivered';
							...
							case "inventory":
								...
								<?php
									...
									print '<td>Inventory</td><td align="right">Shipments</td>';
