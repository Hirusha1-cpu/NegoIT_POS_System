	...
	<nav class="w3-sidenav w3-card-2 w3-white w3-top" style="width:30%;display:none;z-index:2" id="mySidenav">
		...
		<?php
			...
			if (isset($_COOKIE['supervisor'])) { ?>
				<a href="index.php?components=supervisor&action=daily_sale&store=<?php print $_COOKIE['store']; ?>&group=all&salesman=all&processby=all&lock=1&cashback=no&type=" <?php print $localstyle1; ?>><strong>Supervisor</strong></a>
			<?php }
			...
			<?php if ($_REQUEST['components'] == 'billing') { ?>
				...
				<?php
				if ($systemid != 1 && $systemid != 4) print '<a href="index.php?components=billing&action=daily_sale&store=all&group=all&salesman=' . $_COOKIE['user_id'] . '&processby=all&lock=1&type=">My Sales</a>';
			...
			if ($_REQUEST['components'] == 'supervisor') { ?>
				<a href="index.php?components=supervisor&action=daily_sale&store=<?php print $_COOKIE['store']; ?>&group=all&salesman=all&processby=all&lock=1&type=">Sales Report</a>
