...
switch ($_SERVER['SERVER_NAME']) {
	...
	case "billing1.negohosting.com":
		$conn = mysqli_connect('database-1.cluster-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'zigo_dbuser', 'zigo1234', 'zigotech');
		$conn2 = mysqli_connect('database-1.cluster-ro-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'zigo_dbuser', 'zigo1234', 'zigotech');
	...
	case "billing25.negohosting.com":
		$conn = mysqli_connect('database-1.cluster-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'zigo_dbuser', 'zigo1234', 'zigotech25');
		$conn2 = mysqli_connect('database-1.cluster-ro-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'zigo_dbuser', 'zigo1234', 'zigotech25');
		if (mysqli_connect_errno()) {
			echo "Failed to connect to MySQL: " . mysqli_connect_error();
		}
		break;
	...
	case "billing4.negohosting.com":
		$conn = mysqli_connect('database-2.cluster-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'zigo_dbuser', 'zigo1234', 'zigoshop');
		$conn2 = mysqli_connect('database-2.cluster-ro-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'zigo_dbuser', 'zigo1234', 'zigoshop');
		if (mysqli_connect_errno()) {
			echo "Failed to connect to MySQL: " . mysqli_connect_error();
		}
		break;
	...
	case "billing13.negohosting.com":
		$conn = mysqli_connect('database-1.cluster-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'techneeds_dbuser', 'tech#76132', 'techneeds');
		$conn2 = mysqli_connect('database-1.cluster-ro-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'techneeds_dbuser', 'tech#76132', 'techneeds');
		if (mysqli_connect_errno()) {
			echo "Failed to connect to MySQL: " . mysqli_connect_error();
		}
		break;
	...
	case "billing24.negohosting.com":
		$conn = mysqli_connect('database-1.cluster-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'orient_dbuser', 'orient#44512', 'orientcare24');
		$conn2 = mysqli_connect('database-1.cluster-ro-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'orient_dbuser', 'orient#44512', 'orientcare24');
		if (mysqli_connect_errno()) {
			echo "Failed to connect to MySQL: " . mysqli_connect_error();
		}
		break;
	...
	case "billing14.negohosting.com":
		$conn = mysqli_connect('database-1.cluster-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'orient_dbuser', 'orient#44512', 'orientcare');
		$conn2 = mysqli_connect('database-1.cluster-ro-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'orient_dbuser', 'orient#44512', 'orientcare');
		if (mysqli_connect_errno()) {
			echo "Failed to connect to MySQL: " . mysqli_connect_error();
		}
		break;
	...
	case "billing15.negohosting.com":
		$conn = mysqli_connect('database-1.cluster-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'ebenterprises_dbuser', 'eb#42195', 'eb_enterprises');
		$conn2 = mysqli_connect('database-1.cluster-ro-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'ebenterprises_dbuser', 'eb#42195', 'eb_enterprises');
		if (mysqli_connect_errno()) {
			echo "Failed to connect to MySQL: " . mysqli_connect_error();
		}
		break;
	...
	case "billing20.negohosting.com":
		$conn = mysqli_connect('database-1.cluster-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'mobicrown_dbuser', 'kms#46129', 'mobicrown');
		$conn2 = mysqli_connect('database-1.cluster-ro-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'mobicrown_dbuser', 'kms#46129', 'mobicrown');
		if (mysqli_connect_errno()) {
			echo "Failed to connect to MySQL: " . mysqli_connect_error();
		}
		break;
	...
	case "billing21.negohosting.com":
		$conn = mysqli_connect('database-1.cluster-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'mobiarcade_dbuser', 'cdJ@39107', 'mobile_arcade');
		$conn2 = mysqli_connect('database-1.cluster-ro-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'mobiarcade_dbuser', 'cdJ@39107', 'mobile_arcade');
		if (mysqli_connect_errno()) {
			echo "Failed to connect to MySQL: " . mysqli_connect_error();
		}
		break;
	...
	case "billing26.negohosting.com":
		$conn = mysqli_connect('database-1.cluster-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'nego_test', 'ggdjJs612#212', 'testbilling26');
		$conn2 = mysqli_connect('database-1.cluster-ro-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'nego_test', 'ggdjJs612#212', 'testbilling26');
		if (mysqli_connect_errno()) {
			echo "Failed to connect to MySQL: " . mysqli_connect_error();
		}
		break;
	...
	case "negoit.negohosting.com":
		$conn = mysqli_connect('database-1.cluster-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'nego_user', 'Hhksa@454187ca', 'negoit');
		$conn2 = mysqli_connect('database-1.cluster-ro-cvr3hgtayido.me-central-1.rds.amazonaws.com', 'nego_user', 'Hhksa@454187ca', 'negoit');
		if (mysqli_connect_errno()) {
			echo "Failed to connect to MySQL: " . mysqli_connect_error();
		}
		break;
