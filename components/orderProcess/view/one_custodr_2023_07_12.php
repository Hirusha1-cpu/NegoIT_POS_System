...
<form action="#" method="post" >
	...
	<tr><td colspan="6" align="center">
		<table align="center">
		<tr style="background-color:#C0C0C0"><th></th><th>Item Description</th><th style="padding-left:20px; padding-right:20px">Item Qty</th><th style="padding-left:20px; padding-right:20px">Drawer No</th><th></th></tr>
		<?php
		...
		<?php if($systemid==1 || $systemid==10 || $systemid==16){ ?>
