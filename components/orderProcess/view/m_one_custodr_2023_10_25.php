...
<div class="w3-row">
  ...
  <div class="w3-col">
	...
	<tr><td colspan="5" height="50px"><table align="center" style="font-size:10pt"><tr><td>
		<?php if($button=='Packed' && $bi_seen_by==$_COOKIE['user']){ ?><div id="orderprocess"><input type="button" value="<?php print $button; ?>" style="height:50px; width:80px; background-color:#CC5100; font-weight:bold; color:white" onclick="orderProcess()" /></div><?php } ?>
	...
	<tr><td colspan="5">
		...
		<table>
		<tr style="background-color:#467898; color:white;"><td colspan="4" style="padding-left:10px">Credit Balance for Cancel Retuns : </td><td align="right" style="padding-right:10px"><?php print number_format($return_cr_bal); ?> </td></tr>
		<tr style="background-color:#C0C0C0"><th></th><th>Item Description</th><th style="padding-left:10px; padding-right:10px">Item Qty</th><th style="padding-left:10px; padding-right:10px">Drawer No</th><th></th></tr>
		<?php
		for($i=0;$i<sizeof($odr_bill_id);$i++){
			if($odr_bi_order[$i]==1){
