...
<table align="center" style="font-family:Calibri; font-size:12pt">
	<tr style="background-color:#C0C0C0">
		<?php if($action=='list_custodr' || $action=='list_pending' || $action=='list_my' || $action=='list_packed' || $action=='list_shipped' || $action== 'list_delivered') print '<th width="60px;">#</th>'; ?>
		<?php if($action!='list_delivered')
		print '<th>
				<input type="button" value="TAG" onclick="generateTag()" style="height:40px" /></th>'; ?>
		<?php if($action=='list_shipped') print '<th style="padding: 0px 10px; padding-right:20px;">Deliver</th>'; ?>
