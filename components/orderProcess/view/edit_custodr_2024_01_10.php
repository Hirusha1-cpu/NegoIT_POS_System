...
<form action="index.php?components=order_process&action=apend_bill" onsubmit="return validateAppendCustOrder()" method="post" >
	...
	<tr><td align="center" style="font-size:16pt; color:#4678BB">Edit Customer Order</td></tr>
	<tr><td height="20px"></td></tr>
	<tr><td align="center">
			<table>
			<tr><th style="background-color:#C0C0C0; padding-left:10px" align="left">Item Description&nbsp;&nbsp;&nbsp;&nbsp;</th><td style="background-color:#F0F0F0"><input type="text" name="item" id="item" value="<?php print $bi_desc; ?>" onclick="this.value=''" /></td><td style="background-color:#F0F0F0"></td></tr>
			<tr><th style="background-color:#C0C0C0; padding-left:10px" align="left">Item Qty</th><td style="background-color:#F0F0F0"><input type="text" name="qty" id="qty" value="<?php print $bi_qty; ?>" onfocus="getPrice()" /></td><td style="background-color:#F0F0F0"><div style="font-size:10pt;" id="av_qty" align="right"></div><div style="font-size:10pt; color:#CC0000" id="tt_qty" align="right"></div></td></tr>
			<tr><th style="background-color:#C0C0C0; padding-left:10px" align="left">Unit Price</th><td style="background-color:#F0F0F0"><div id="priceshow"><input type="text" name="price" id="price" disabled="disabled" value="<?php print ($bi_price+$bi_discount); ?>" /></div></td><td style="background-color:#F0F0F0"></td></tr>
			<tr><th style="background-color:#C0C0C0; padding-left:10px" align="left"><table border="0"><tr><td>Unit Discount</td><td><div id="discount_div" onclick="changeDiscount()" style="color:blue; cursor:pointer;"><?php if($discount=='price') print 'Rs'; else print '%'; ?></div></td></tr></table></th><td style="background-color:#F0F0F0"><input type="text" name="discount" id="discount" value="<?php print $bi_discount; ?>" /></td><td style="background-color:#F0F0F0"></td></tr>
			<tr><th style="background-color:#C0C0C0; padding-left:10px" align="left">Selling Price</th><td style="background-color:#F0F0F0"><input type="text" id="sell_price" disabled="disabled" value="<?php print ($bi_qty*$bi_price); ?>" /></td><td style="background-color:#F0F0F0"><input type="button" value="Calculate" onclick="calSellPrice()" /></td></tr>
			<tr><th style="background-color:#C0C0C0; padding-left:10px" align="left">Total</th><td style="background-color:#F0F0F0"><input type="text" id="total_price" disabled="disabled" value="<?php print $bi_price; ?>" /></td><td style="background-color:#F0F0F0"></td></tr>
			<tr><th style="background-color:#C0C0C0; padding-left:10px" align="left"><div id="com" >Drawer No<input type="hidden" name="comment" id="comment" value="" /></div></th><td style="background-color:#F0F0F0"><div style="font-size:12pt" id="it_drawer"></div></td><td style="background-color:#F0F0F0"></td></tr>
	...
	<tr><td height="50px" align="center"><div id="div_submit"><input type="submit" value="Add to Order" style="width:100px; height:40px" /></div></td></tr>
	</table>
</form>
