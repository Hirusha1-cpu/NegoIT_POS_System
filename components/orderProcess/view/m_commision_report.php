...
<div class="w3-row">
  ...
  <div class="w3-col">
			<form id="report_form" method="get" action="index.php" >
				...
				<table style="font-family:Calibri; border-radius:5px" bgcolor="silver">
				<tr><td class="shipmentTB4">From Date </td><td><input type="date" id="from_date" name="from_date" value="<?php print $from_date; ?>" /></td></tr>
				<tr><td class="shipmentTB4">To Date </td><td><input type="date" id="to_date" name="to_date" value="<?php print $to_date; ?>" /></td></tr>
				<tr><td class="shipmentTB4">Store</td><td>
