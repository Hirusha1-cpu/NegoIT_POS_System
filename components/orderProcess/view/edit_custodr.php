	...
	<table align="center" style="font-size:12pt" width="600px">
			...
			<td align="center">
				<table>
					...
					<tr>
						...
						<td style="background-color:#F0F0F0">
							<div id="priceshow"><input type="text" name="price" id="price" disabled="disabled" value="<?php print ($bi_price+$bi_discount); ?>" /></div>
						</td>
						<td style="background-color:#F0F0F0"></td>
					</tr>
					<tr>
						...
						<td style="background-color:#F0F0F0"><input type="text" name="discount" id="discount" value="<?php print $bi_discount; ?>" /></td>
						<td style="background-color:#F0F0F0"></td>
					</tr>
					<tr>
		...
		<tr>
			<td height="50px" align="center">
				<div id="div_submit"><input type="submit" value="Add to Order" style="width:100px; height:40px" /></div>
			</td>
		</tr>
	</table>
</form>
