	...
	<table align="center" style="font-size:12pt" width="900px">
		<tr>
			<td style="background-color:#467898;color :white;">
				<strong><?php if($bm_status<3) print 'Order No'; else print 'Invoice No'; ?></strong>
			</td>
			...
			<td rowspan="2">
				...
				?>
					<div id="orderprocess">
						<input type="button" value="<?php print $button1; ?>" style="height:50px; width:70px; background-color:#CC5100; font-weight:bold; color:white" onclick="orderProcess()" />
					</div>
				<?php } ?>
		...
		<tr>
			...
			<td bgcolor="#EEEEEE"><?php print '<a href="index.php?components=billing&action=cust_details&id='.$cu_id.'&action2=list_one_custodr&id2='.$_REQUEST['id'].'" >'.ucfirst($bi_cust).'</a>'; ?></td>
		</tr>
		...
		<tr>
			<td colspan="6" align="center">
					...
					<?php
						for($i=0;$i<sizeof($odr_bill_id);$i++){
							if($odr_bi_order[$i]==0){
								...
								print '<tr style="background-color:#F0F0F0"><td><input type="checkbox" /></td><td style="padding-left:20px; padding-right:20px">'.$odr_bi_desc[$i].'</td><td style="padding-right:20px" align="right"><input type="text" id="qty_'.$odr_bill_id[$i].'" value="'.$odr_bi_qty[$i].'" style="width:50px; text-align:right;" /></td><td style="padding-right:20px" align="right">'.$odr_bi_drawer[$i].'</td><td><div id="button_'.$odr_bill_id[$i].'" >'.$update_button.' <input type="button" value="Remove" onmouseup="removeItemODR('.$odr_bill_id[$i].')" style="background-color:maroon; color:white" /></div></td></tr>';
							}
						}
				...
				<?php if($systemid==1 || $systemid==10 || $systemid==16 || $systemid==17){ ?>
					...
					<table align="center">
						<tr style="background-color:#467898; color:white;">
							<td colspan="4" style="padding-left:10px">Credit Balance for Cancel Retuns : </td>
							<td align="right" style="padding-right:10px"><?php print $currency; ?> <?php print number_format($return_cr_bal, $decimal); ?> </td>
						</tr>
						<tr style="background-color:#C0C0C0">
							<th></th>
							<th>Item Description</th>
					...
					<table align="center">
						...
						<tr>
							<th style="background-color:#787898;color :white;" colspan="7">Return Items | <?php if($systemid == 13) echo 'Started'; else print 'Packed';?></th>
						</tr>
						<tr style="background-color:#C0C0C0">
							<th></th>
