	...
	<table align="center" style="font-size:12pt" width="900px">
		<tr>
			...
			<td rowspan="2">
				...
				<?php } ?>
				<input type="button" value="Print" style="height:50px; width:70px; background-color:#007799; font-weight:bold; color:white" onclick="window.location = 'index.php?components=<?php print $bill_module; ?>&action=finish_bill&id=<?php print $_REQUEST['id']; ?>'" />
				<?php
			...
			<td colspan="6" align="center">
				...
				<?php if($systemid==1 || $systemid==10 || $systemid==16 || $systemid==17){ ?>
					...
					<table align="center">
						...
						<tr>
							<th style="background-color:#787898;color :white;" colspan="7">Return Items | <?php if($systemid == 13 && $sub_system == 1) echo 'Started'; else print 'Packed';?></th>
						</tr>
						<tr style="background-color:#C0C0C0">
							<th></th>
							<th style="padding-left:20px; padding-right:20px">RT Invoice</th>
			...
			<td colspan="5">
				<table width="100%">
					<tr style="background-color:#C0C0C0">
						...
						<td style="padding-left:20px;"><?php if($systemid == 13 && $sub_system == 1) echo 'Started'; else print 'Packed';?> By</td>
						<?php if($systemid != 13 || $sub_system != 1) { ?><td style="padding-left:20px;">Shipped By</td><?php } ?>
						<td style="padding-left:20px;"><?php if($systemid == 13 && $sub_system == 1) echo 'Finished'; else print 'Delivered';?> By</td>
					</tr>
