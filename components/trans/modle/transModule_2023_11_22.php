...
function generateGTN(){
	global $gtn_no,$gtn_item_id,$gtn_item_des,$gtn_item_qty,$gtn_item_draw,$gtn_item_from,$gtn_item_to,$gtn_date,$gtn_from_user,$gtn_to_user,$gtn_c_price,$gtn_cross_invoice,$total_cost,$gtn_status, $gtn_from_shop_name;
	$gtn_no=$_REQUEST['id'];
	$user_id=$_COOKIE['user_id'];
	$gtn_from=$gtn_to='';
	$total_cost=0;
