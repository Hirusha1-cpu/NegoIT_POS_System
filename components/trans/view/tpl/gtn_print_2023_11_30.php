		...
		<tr style="font-family:Arial; font-size:10pt">
			...
			<?php
				...
				for($i=0;$i<sizeof($gtn_item_id);$i++){
					if($paper_size=='A4'){
						$table_u_cost='<td style="border-bottom:0; border-top:0; padding-right:10px" align="right">
							'.number_format($gtn_c_price[$i],$decimal).'</td>';
						$table_total_cost='<td style="border-bottom:0; border-top:0; padding-right:10px" align="right">
							'.number_format($gtn_item_qty[$i]*$gtn_c_price[$i],$decimal).'</td>';
						$table_expand='<td style="border-bottom:0; border-top:0;"></td>
						<td style="border-bottom:0; border-top:0;"></td>';
						$colspan=4;
					}
					print '<tr style="font-size:10pt" height="20px">
						<td align="center" style="border-bottom:0; border-top:0;">'.$gtn_item_draw[$i].'</td>
						<td style="border-bottom:0; border-top:0; padding:0 10px">'.sprintf('%02d',($i+1)).'. '.$gtn_item_des[$i].'</td>'.$table_u_cost.'<td
							style="border-bottom:0; border-top:0; padding-right:10px" align="right">'.number_format($gtn_item_qty[$i]).'&nbsp;'.$gtn_item_unit[$i].'
				...
				if($paper_size=='A4') print '<tr style="font-size:10pt" height="20px">
					<td align="right" style="border-bottom:0; border-top:1; padding-right:20px" colspan="'.$colspan.'"><strong>Total
							Cost</strong></td>
					<td style="border-bottom:0; border-top:1; padding-right:10px" align="right"><strong>'.number_format($total_cost,
							$decimal).'</strong></td>
					</td>
				</tr>';
			?>
