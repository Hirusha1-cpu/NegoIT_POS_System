...
<table width="100%"><tr><td><h1 style="color:orange">Stores Transfer</h1></td><td align="right" style="font-weight:bold; font-size:12pt;">TR No: <?php print str_pad($id, 7, "0", STR_PAD_LEFT); ?></td></tr></table>
	...
	<tr><td colspan="2" align="right"><div id="addtogtn"><?php if(sizeof($gtn_itemid)<$apend_limit) print '<input type="submit" value="Add to GTN" style="width:100px; height:30px" />'; ?>&nbsp;</div> 
...
</td><td width="50px"></td><td valign="top"><br /><br />
<!-- ------------------Item List----------------------- -->
