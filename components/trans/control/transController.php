...
switch ($_REQUEST['action']) {
	...
	case "gtn_item_gpdate":
		...
		if (updateGTNitem()) {
			...
			header('Location: index.php?components=' . $components . '&action=home&id=' . $gtn_no . '&remotestore=' . $tostore . '&message=' . $message . '&re=success');
		} else {
			debugEnd($debug_id, 'fail');
			header('Location: index.php?components=' . $components . '&action=home&id=' . $gtn_no . '&remotestore=' . $tostore . '&message=' . $message . '&re=fail');
		}
		break;
