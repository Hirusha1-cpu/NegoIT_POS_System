...
function initMap() {
  ...
  var locations = [  <?php for($i=0;$i<sizeof($map_time);$i++){	print "['Salesman : $map_rep \\n$map_time[$i]',   $map_x[$i], $map_y[$i]],";	} ?>  ];
...
<?php 
	...
	print '<table align="center" style="font-size:11pt"><tr><td>
<span style="color:'.$color.'; font-weight:bold;">'.$_REQUEST['message'].'</span><br /><br /></td></tr></table>	'; 
	}
?>
<div id="map"></div>
<?php
