...
<td>System:<select id="sys_filter" name="sys" onchange="setFilter()" >
...
<td>Store:<select id="store_filter" name="store" onchange="setFilter()" >
...
<td>Group:<select id="group_filter" name="group" onchange="setFilter()" >
	<option value="all">-ALL-</option>
	<?php 
...
<p style="color:gray; text-align:center"><em>Monthly Credit Balance will be calculated for 28th of Every Month</em></p>

<table align="center">
<tr><td><div id="company_credit" style="width: 800px; height: 300px;"></div></td></tr>
<tr><td><div id="store_credit" style="width: 800px; height: 300px;"></div></td></tr>
</table>
</form>
<?php
