...
<tr><td valign="top">
	...
	for($i=0;$i<sizeof($com_sm_did);$i++){
		...
		if(($i%2)==0) $color='#EEEEEE'; else $color='#F9F9F9';
		print '<tr bgcolor="'.$color.'"><td class="shipmentTB3"><a href="index.php?components=report&action=hp_commission_one_user&id='.$hc_id.'&user='.$com_sm_id[$i].'" style="text-decoration:none;">'.ucfirst($com_sm_name[$i]).'</a></td><td class="shipmentTB3" align="right">'.number_format($com_sm_amo[$i]).'</td></tr>';
	}
	?>
	...
	for($i=0;$i<sizeof($com_rg_did);$i++){
		...
		if(($i%2)==0) $color='#EEEEEE'; else $color='#F9F9F9';
		print '<tr bgcolor="'.$color.'"><td class="shipmentTB3"><a href="index.php?components=report&action=hp_commission_one_user&id='.$hc_id.'&user='.$com_rg_id[$i].'" style="text-decoration:none;">'.ucfirst($com_rg_name[$i]).'</a></td><td class="shipmentTB3" align="right">'.number_format($com_rg_amo[$i]).'</td></tr>';
	}
	?>
	</table>
