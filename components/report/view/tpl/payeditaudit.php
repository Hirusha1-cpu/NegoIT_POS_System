...
<div id="printheader" style="display:none" >
	...
	<h2 align="center" style="color:#3333FF; text-decoration:underline">Pay Edit Audit</h2>
...
<div id="print">
	...
	<tr bgcolor="#CCCCCC"><th>Salesman</th><th>&nbsp;&nbsp;Action Date&nbsp;&nbsp;</th><th>Invoice No</th><th>&nbsp;&nbsp;Old Date&nbsp;&nbsp;</th><th>&nbsp;&nbsp;New Date&nbsp;&nbsp;</th><th>&nbsp;&nbsp;Old Salesman&nbsp;&nbsp;</th><th>&nbsp;&nbsp;New Salesman&nbsp;&nbsp;</th></tr>
	<?php
	for($i=0;$i<sizeof($ie_user);$i++){
		print '<tr bgcolor="#EEEEEE"><td>&nbsp;&nbsp;'.ucfirst($ie_user[$i]).'&nbsp;&nbsp;</td><td>&nbsp;&nbsp;'.$ie_act_date[$i].'&nbsp;&nbsp;</td><td align="center"><a href="index.php?components=billing&action=finish_payment&id='.$ie_invoice[$i].'">'.str_pad($ie_invoice[$i], 7, "0", STR_PAD_LEFT).'</a></td><td align="center">&nbsp;&nbsp;'.$ie_ori_date[$i].'&nbsp;&nbsp;</td><td align="center">&nbsp;&nbsp;'.$ie_new_date[$i].'&nbsp;&nbsp;</td><td>&nbsp;&nbsp;'.ucfirst($ie_ori_sm[$i]).'&nbsp;&nbsp;</td><td>&nbsp;&nbsp;'.ucfirst($ie_new_sm[$i]).'&nbsp;&nbsp;</td></tr>';
	}
	?>
	</table>
</div>
