                ...
                <table align="center" class="styled-table" style="margin-top:10px"  width="100%">
                    ...
                    <tbody>
                        ...
                        for($i=0;$i<sizeof($inv_no);$i++){
                            ...
                            print '<td class="shipmentTB3" align="left"><a target="_blank" href="index.php?components=report&action=salesman_commission_incomplete_one&user='.$salesman_id[$i].'">'.ucfirst($salesman[$i]).'</a></td>
