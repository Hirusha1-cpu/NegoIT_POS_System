		...
		<tr>
			<td style="vertical-align:top">
				<div style="border-radius:10px; background-color:#DDDDDD">
					<table align="center" height="100%" border="0" cellspacing="0"
						style="font-family:Calibri; font-size:12pt">
						<tr>
							<td width="150px">
								Date Range<input type="checkbox" id="date_range" onchange="setDateRange('<?php print $date1; ?>','<?php print $date2; ?>')"
									<?php if(($date1!='')&&($date2!='')) print 'checked="checked"'; ?> />
							</td>
							...
							<td width="50px"></td>
							<td><strong>Filter by Item </strong></td>
							<td>
								<input type="text" id="tags1" name="filter_item" value="<?php print $item_req; ?>" />
						...
						<tr>
							<td>
								...
								<select name="hp">
									...
									<option value="yes" <?php if($hp=='yes') print 'selected="selected"'; ?>>YES
									</option>
							...
							<td></td>
							<td><strong>Sub System</strong></td>
							<td>
				...
				<table align="center" cellspacing="0" border="1" style="font-size:12pt">
					<tr>
						<th>Total Sale</th>
						<th><?php print $profit_title; ?></th>
					</tr>
					<tr style="color:orange">
						<th width="200px" align="center">
							<?php print number_format(array_sum($invoice_total)+array_sum($rtn_pay)); ?></th>
						<th width="200px" align="center"><?php print number_format(array_sum($invoice_profit)); ?></th>
					</tr>
				</table>
				<br /><br />
				<div id="print" align="center">
					<table align="center" id="sales_tb" height="100%" style="font-family:Calibri; font-size:10pt">
						<tr bgcolor="#BBBBBB">
							...
							<th width="80px">Invoice Price</th>
							<th width="80px">Invoice Profit</th>
							<th width="60px">Discount</th>
							<th width="50px">Gross<br />Profit %</th>
						...
						<tr>
							...
							<td>
								<select name="filter_store" style="width:100%" onchange="this.form.submit()">
									<option value="">-ALL-</option>
									<?php
										$filter_store=array_unique($stores);
						...
						<?php
							...
							for($i=0;$i<sizeof($invoice_no);$i++){
								...
								if($invoice_total[$i]<0) $profit=-round((($invoice_profit[$i]/$invoice_total[$i])*100),1);
								print '<tr bgcolor="'.$color1.'" style="color:'.$color0.'">
								...
								<td width="50px" align="center">'.$time[$i].'</td>
								<td align="right">'.number_format($invoice_total[$i]).'&nbsp;&nbsp;</td>
								<td align="right">'.number_format($invoice_profit[$i]).'&nbsp;&nbsp;</td>
								<td align="right">'.number_format($total_discount[$i]).'</td>
								<td align="center">'.$profit.'%</td>
								<td>&nbsp;&nbsp;'.$invoice_type[$i].'&nbsp;&nbsp;</td>
								<td>&nbsp;&nbsp;'.ucfirst($invo_salesman[$i]).'</td>
								<td>&nbsp;&nbsp;'.$stores[$i].'</td>
						...
						<?php
							if(sizeof($rtn_no)>0)
								print '<tr bgcolor="#BBBBBB">
									<td colspan="10" style="padding-left:20px">Return Invoice Extra Pay Collection</td>
								</tr>';
			...
			<td style="vertical-align:top">
				<table style="font-family:Calibri; font-size:10pt;">
					<tr>
						<th style="background-color:#DDDDDD" colspan="2">Category Filter</th>
					</tr>
					<tr style="background-color:#DDDDDD">
						<th><input type="checkbox" onclick="setUnsetAll(this)" /></th>
						<th>Set/Unset All</th>
					</tr>
					<?php
...
<div id="printheader" style="display:none">
	...
	<table style="font-size:12pt" border="1" cellspacing="0">
		<tr>
			<td width="100px" style="background-color:#C0C0C0; padding-left:10px">From Date</td>
			<td width="250px" style="background-color:#EEEEEE; padding-left:10px"><?php print $date1; ?></td>
			<td width="100px" style="background-color:#C0C0C0; padding-left:10px">To Date</td>
			<td width="250px" style="background-color:#EEEEEE; padding-left:10px"><?php print $date2; ?></td>
		</tr>
		<tr>
			<td width="100px" style="background-color:#C0C0C0; padding-left:10px">Sub System</td>
			<td width="250px" style="background-color:#EEEEEE; padding-left:10px"><?php print $sub_system_print; ?></td>
			<td width="100px" style="background-color:#C0C0C0; padding-left:10px">Group</td>
			<td width="250px" style="background-color:#EEEEEE; padding-left:10px"><?php print $group_print; ?></td>
		</tr>
		<tr>
			<td width="100px" style="background-color:#C0C0C0; padding-left:10px">HP</td>
			<td width="250px" style="background-color:#EEEEEE; padding-left:10px"><?php print strtoupper($hp); ?></td>
			<td width="100px" style="background-color:#C0C0C0; padding-left:10px"></td>
			<td width="250px" style="background-color:#EEEEEE; padding-left:10px"></td>
		</tr>
	</table><br />
</div>
	...
	<tr>
		<td align="center">
			<div style="background-color:#6699FF; border:medium; border-color:black; width:80px;">
				<a class="shortcut-button" onclick="printdivBorderx('sales_tb','print','printheader')" href="#"><span
