					...
					<td style="vertical-align:top;">
						<form action="index.php?components=bill2&action=apend_return" onsubmit="return validateReturn()"
							...
							<?php if (isset($_REQUEST['id'])) { ?>
								<span style="font-weight:bold;">Return Invoice No:
									&nbsp;&nbsp;&nbsp;<?php print str_pad($_REQUEST['id'], 7, "0", STR_PAD_LEFT); ?></span>
							<?php } ?>
							<table align="center">
								<tr>
									<td>
										<table align="center" bgcolor="#E5E5E5"
												...
												<tr>
													...
													<td colspan="2">
														<input type="button" value="Submit"
															style="width:100px; height:50px;" onclick="selectCust()" />
														<br />
													</td>
													<td width="50px"></td>
												</tr>
											<?php } else { ?>
												<tr>
													...
													<td colspan="2">
														<input type="text" name="code" id="tags1"
															value="<?php if ($unic_item_code != '')
																print $unic_item_code; ?>" />
													</td>
													<td width="50px"></td>
												...
												<tr>
													...
													<td>Quantity</td>
													<td>
														<input type="number" name="qty1" id="qty1" onfocus="getReturn()"
															style="width:50px" <?php if ($unic_item_select) { ?> value="1"
																disabled="disabled" <?php } ?> />
													</td>
													<td>
														<div style="font-size:10pt;" id="av_qty" align="right"></div>
														<div style="font-size:10pt; color:#CC0000" id="tt_qty"
															align="right"></div>
													</td>
													<td></td>
												</tr>
												...
												<tr>
													...
													<td colspan="2">
														<input type="text" name="rplace_code" id="tags6"
															value="<?php if ($unic_item_code != '')
																print $unic_item_code; ?>" />
													</td>
													<td width="50px"></td>
												...
												<tr>
													...
													<td>Extra Payment</td>
													<td colspan="2">
														<input type="text" name="extra_pay" style="width:50px"
															onfocus="showCodeDesc()" />
														<input type="button" value="Get Cost Difference"
															onclick="getPriceDiff()" />
													</td>
													<td width="50px">
													...
													<td colspan="2" align="right">
														...
														<div id="addtoreturn">
															<?php if (sizeof($rt_id) < 16)
																print '<input type="submit" value="Add to Return" style="width:100px; height:30px" onclick="showCodeDesc()" />'; ?>
															<br /><br /><br /><br />
														</div>
														...
														<td colspan="3" align="left">
															<div id="finalize">
																<input type="Button" value="Finalize"
																	style="width:100px; height:70px" onclick="finalize()" />
															</div>
														<?php } ?>
														<br /><br />
													</td>
												...
												<tr>
													<td colspan="5" align="center" style="font-size:9pt; color:gray">
														<i>The Extra Payment Need to Be Collected As the Same Time of
															Issuewing this Invoice</i>
													</td>
												</tr>
											<?php } ?>
										</table>
				...
				<?php } else { ?>
					<form id="searchinv" action="index.php?components=bill2&action=search_return" method="post">
						<table align="center" height="100%">
							<tr>
								<td>
									<input type="text" style="width:100px" name="search1" id="search1"
