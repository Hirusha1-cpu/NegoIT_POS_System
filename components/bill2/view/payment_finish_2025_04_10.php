...
<?php
	...
	if(isset($_REQUEST['message'])){
		...
		print '<table align="center" style="font-family:Calibri;">
			<tr>
				<td><span style="color:'.$color.'; font-weight:bold;font-size:12pt;">'.$_REQUEST['message'].'</span></td>
			</tr>
		</table><br>';
	}
?>
...
<form action="#" method="post" >
	...
	<?php if(($main_sub_system_id==$sub_system )|| (($systemid==24 || $systemid==13) && (isset($_COOKIE['top_manager'])))){ ?>
	<table align="center">
		<tr>
			<td style="font-family:Calibri; font-size:10pt">
			...
			<td width="50px"></td>
			<td bgcolor="#467898" style="font-family:Calibri; color:white; padding-left:10px">Payment Invoice Status :
				<span <?php if($status_out=='Deleted') print 'class="blink"'; ?> style="color:<?php print $status_color; ?>;"><strong>
					<?php print $status_out; ?></strong>
				</span>
			</td>
			<td></td>
		</tr>
		<tr>
			<td valign="top">
				<div id="details_div" style="display:none">
					<table align="center" style="font-size:11pt; font-family:Calibri">
						...
						<tr>
							<td style="background-color:#467898; color:white;" class="shipmentTB4">Paid Date</td>
							<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4">
								<?php print substr($main_paid_date,0,16); ?></td>
						</tr>
						<tr>
							<td style="background-color:#467898; color:white;" class="shipmentTB4">Salesman</td>
							<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4">
								<?php print ucfirst($main_paid_by); ?></td>
						</tr>
						<tr>
							<td style="background-color:#467898; color:white;" class="shipmentTB4">System User</td>
							<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4">
								<?php print ucfirst($main_sys_user); ?></td>
						</tr>
						<tr>
							<td style="background-color:#467898; color:white;" class="shipmentTB4">Deleted Date</td>
							<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4">
								<?php print substr($main_deleted_date,0,16); ?></td>
						</tr>
						<tr>
							<td style="background-color:#467898; color:white;" class="shipmentTB4">Deleted By</td>
							<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4">
								<?php print ucfirst($main_deleted_by); ?></td>
						</tr>
					</table>
				</div>
			</td>
			...
			<td>
				<?php
				 if($tm_template==1) print '<iframe id="invoice_iframe" width="480px" height="710px" src="components/bill2/view/tpl/payment_print1.php?id='.$_GET['id'].'"></iframe>';
				 if($tm_template==2) print '<iframe id="invoice_iframe" width="250px" height="710px" src="components/bill2/view/tpl/payment_print2.php?id='.$_GET['id'].'"></iframe>';
				 if($tm_template==3) print '<iframe id="invoice_iframe" width="480px" height="710px" src="components/bill2/view/tpl/payment_print1.php?id='.$_GET['id'].'"></iframe>';
				 if($tm_template==5) print '<iframe id="invoice_iframe" width="480px" height="710px" src="components/bill2/view/tpl/payment_print5.php?id='.$_GET['id'].'"></iframe>';
				 if($tm_template==15) print '<iframe id="invoice_iframe" width="480px" height="710px" src="components/bill2/view/tpl/payment_print15.php?id='.$_GET['id'].'"></iframe>';
				 if($tm_template==18) print '<iframe id="invoice_iframe" width="480px" height="710px" src="components/bill2/view/tpl/payment_print18.php?id='.$_GET['id'].'"></iframe>';
				?>
			</td>
			<td valign="top" align="center">
				<div style="background-color:#6699FF; border:medium; border-color:black; width:80px;">
					<a class="shortcut-button" onclick="print_bill()" href="#">
				...
				<br />
				<?php if($py_status==0 || $py_status==2){
