...
<table align="center" style="font-size:10pt; font-family:Calibri" border="0">
	<tr>
						...
						<td>
							<table cellspacing="0">
								<tr>
									...
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_1" id="pre_1_2"
											value="Display Has an Issue" onchange="repairePreCheck()"></td>
									<td width="10px"></td>
							...
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_2" id="pre_2_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_2" id="pre_2_2"
											value="Mic Has an Issue" onchange="repairePreCheck()"></td>
									<td width="10px"></td>
									<td rowspan="2">Mic</td>
								</tr>
								<tr class="yesno">
							...
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_3" id="pre_3_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_3" id="pre_3_2"
											value="Vol/Down Has an Issue" onchange="repairePreCheck()"></td>
									<td width="10px"></td>
							...
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_4" id="pre_4_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_4" id="pre_4_2"
											value="Speaker Has an Issue" onchange="repairePreCheck()"></td>
									<td width="10px"></td>
							...
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_5" id="pre_5_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_5" id="pre_5_2"
											value="Ringer Has an Issue" onchange="repairePreCheck()"></td>
									<td width="10px"></td>
							...
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_6" id="pre_6_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_6" id="pre_6_2"
											value="Camera Switch Has an Issue" onchange="repairePreCheck()"></td>
									<td width="10px"></td>
							...
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_7" id="pre_7_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_7" id="pre_7_2"
											value="Signal Has an Issue" onchange="repairePreCheck()"></td>
									<td width="10px"></td>
							...
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_8" id="pre_8_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_8" id="pre_8_2"
											value="Touch Has an Issue" onchange="repairePreCheck()"></td>
									<td width="10px"></td>
							...
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_9" id="pre_9_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_9" id="pre_9_2"
							...
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_10" id="pre_10_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_10" id="pre_10_2"
											value="Camera Has an Issue" onchange="repairePreCheck()"></td>
									<td width="10px"></td>
							...
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_11" id="pre_11_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_11" id="pre_11_2"
											value="Charging Has an Issue" onchange="repairePreCheck()"></td>
									<td width="10px"></td>
							...
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_13" id="pre_13_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_13" id="pre_13_2"
											value="Memory Card Has an Issue" onchange="repairePreCheck()"></td>
									<td width="10px"></td>
		...
		<td valign="top">
			...
			<?php if ($current_district != '') { ?>
				<table align="center" bgcolor="<?php print $main_tale_color; ?>" style="border-radius: 15px;" border="0">
					...
					print '</td><td width="50px"></td></tr>';
					if (($systemid == 1) || ($systemid == 13) || ($systemid == 15)) {
							...
							<?php if (($systemid == 4) || ($systemid == 13) || ($systemid == 15) || ($systemid == 20) || ($systemid == 24)) { ?>
								<?php if ($bill_item_count == 0) { ?>
									<select name="salesman" id="salesman"
										onchange="changeSalesman(<?php print $_GET['bill_no']; ?>,this.value)">
					...
					<tr>
						...
						<td colspan="2">
							<div class="frmSearch">
								<input type="text" id="search-desc" value="" onclick="this.value=''"
					...
					<tr>
								...
								<tr>
									...
									<td>
										<div id="discount_div" onclick="changeDiscount()"
											...
											<?php if ($default_discount_type == 'price')
												print $currency;
											else
												print '%'; ?>
										</div>
						...
						<td colspan="2">
							<table width="100%">
								<tr>
									<td><input type="number" name="discount" id="discount" style="width:50px"
											onclick="this.value=''" /></td>
									<td>
										<div id="discount_btn"></div>
									</td>
									<td><input type="button" value="Check"
											onclick="loadDiscount('<?php print $cu_id; ?>')" /></td>
									<td>
					...
					<?php if (($systemid == 13) && ($components != 'to')) { ?>
						...
						<tr>
							<td width="50px"></td>
							<td style=" font-size:12pt">Invoice Discount (<?php print $currency; ?>)</td>
							<td colspan="2">
								<table width="100%" style=" font-size:12pt">
									<tr>
										<td>
											<input type="number" name="discount_for_invoice" id="discount_for_invoice"
												style="width:70px" value="<?php if (isset($invoice_discount))
													print $invoice_discount; ?>" />
										</td>
										<td>
					...
					<tr>
						...
						<td style="font-size:12pt" align="right"><br />
							<div id="div_add_to_bill">
								<input type="button" value="Add to Bill" onclick="addToBill()"
			...
			<table align="center" style="font-size:12pt" width="100%">
				...
				<tr>
					...
					<td bgcolor="#E5E5E5" align="right"><?php print number_format($remaining_cr_limit, $decimal); ?>
					</td>
				</tr>
			</table>
		</td>
		...
		<td valign="top">
			<div
				style="background-color:#D1D8F1; border-radius: 5px; padding-left:20px; padding-right:20px; height:600px;">
				<br />
				<table>
					<tr>
						<td>
						...
						<td width="20px"></td>
						<td><input type="button" value="Print Order"
								onclick="printdiv('printorder_c','printorder_h')" /></td>
