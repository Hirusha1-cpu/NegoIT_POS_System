		...
		<table align="center">
			<tr>
				<td style="font-family:Calibri; font-size:10pt">
					...
					<div id="details_link">
						<a style="cursor:pointer; color:blue" onclick="showHideDetails()"><strong>+ Show
								Details</strong></a>
					</div>
				</td>
				<td width="50px"></td>
				<td bgcolor="#467898" style="font-family:Calibri; color:white; padding-left:10px">Payment Invoice Status :
					<span <?php if ($status_out == 'Deleted')
						print 'class="blink"'; ?>
						style="color:<?php print $status_color; ?>;"><strong>
			...
			<tr>
						...
						<table align="center" style="font-size:11pt; font-family:Calibri">
							...
							<tr>
								...
								<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4">
									<?php
									if (isTimeShow()) {
										print substr($main_paid_date, 0, 16);
									} else {
										print substr($main_paid_date, 0, 10);
									}
									?>
								</td>
							</tr>
							<tr>
								...
								<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4">
									<?php print ucfirst($main_paid_by); ?>
								</td>
							</tr>
							<tr>
				...
				<td>
					<?php
					if ($tm_template == 1)
						print '<iframe id="invoice_iframe" width="480px" height="710px" src="components/bill2/view/tpl/payment_print1.php?id=' . $_GET['id'] . '"></iframe>';
					if ($tm_template == 2)
						print '<iframe id="invoice_iframe" width="250px" height="710px" src="components/bill2/view/tpl/payment_print2.php?id=' . $_GET['id'] . '"></iframe>';
					if ($tm_template == 3)
						print '<iframe id="invoice_iframe" width="480px" height="710px" src="components/bill2/view/tpl/payment_print1.php?id=' . $_GET['id'] . '"></iframe>';
					if ($tm_template == 5)
						print '<iframe id="invoice_iframe" width="480px" height="710px" src="components/bill2/view/tpl/payment_print5.php?id=' . $_GET['id'] . '"></iframe>';
					if ($tm_template == 15)
						print '<iframe id="invoice_iframe" width="480px" height="710px" src="components/bill2/view/tpl/payment_print15.php?id=' . $_GET['id'] . '"></iframe>';
					if ($tm_template == 18)
						print '<iframe id="invoice_iframe" width="480px" height="710px" src="components/bill2/view/tpl/payment_print18.php?id=' . $_GET['id'] . '"></iframe>';
					?>
				</td>
					...
					<?php if ($py_status == 0 || $py_status == 2) {
						if ($paymentpermission) { ?>
							<div style="background-color:#FF9191; border:medium; border-color:black; width:80px;">
								<a class="shortcut-button" onclick="deletePayment(<?php print $_GET['id']; ?>,'bill2')"
