					...
					<tr>
						<td>
							<?php
								...
								if($tm_template==2) print '<iframe id="invoice_iframe" width="260px" height="740px" src="components/bill2/view/tpl/invoice_print2.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
								if($tm_template==3) print '<iframe id="invoice_iframe" width="'.$page_width.'px" height="'.$page_height.'px" src="components/bill2/view/tpl/invoice_print3.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
								if($tm_template==4) print '<iframe id="invoice_iframe" width="260px" height="740px" src="components/bill2/view/tpl/invoice_print4.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
								if($tm_template==5) print '<iframe id="invoice_iframe" width="440px" height="550px" src="components/bill2/view/tpl/invoice_print5.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
								if($tm_template==6) print '<iframe id="invoice_iframe" width="300px" height="740px" src="components/bill2/view/tpl/invoice_print6.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
								if($tm_template==7) print '<iframe id="invoice_iframe" width="533px" height="775px" src="components/bill2/view/tpl/invoice_print7.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
								if($tm_template==15) print '<iframe id="invoice_iframe" width="'.$page_width.'px" height="'.$page_height.'px" src="components/bill2/view/tpl/invoice_print15.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
								if($tm_template==18) print '<iframe id="invoice_iframe" width="'.$page_width.'px" height="'.$page_height.'px" src="components/bill2/view/tpl/invoice_print18.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
							?>
						</td>
