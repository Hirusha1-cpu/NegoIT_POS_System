	...
	function validateBillPayment() {
		...
		if (($count == 0) && ($amount_chque > 0)) {
			...
			if ($count > 0) {
				...
				if (validateDate($chque_date) == false) { $count++; $msg = 'Date must be in yyyy-mm-dd Format'; }
			}
		}
...
<table align="center" border="0">
	<tr>
		<td>
			<input type="button" value="Back" style="width:100px; height:30px"
				onclick="window.location = 'index.php?components=bill2&action=bill_item&cust_odr=<?php print $cust_odr; ?>&bill_no=<?php print $_GET['bill_no']; ?>'" />
		</td>
		<td colspan="3" align="center">
			<h1 style="color:orange"><?php if ($cust_odr == 'no')
				print 'Bill Payment';
			else
	...
	<tr>
		<td style="vertical-align:top;">
				...
				<table align="center" bgcolor="<?php print $main_tale_color; ?>" height="100%">
					<tr>
						...
						<td colspan="2" width="230px"
							style="font-size:12pt; color:navy; font-weight:bold; height:40px;">Cash Payment</td>
						<td width="30px"></td>
					</tr>
					<tr>
						<td></td>
								...
								<tr>
									<td>
										<input type="text" name="amount_cash" id="amount_cash" value="0"
											style="width:60px; text-align:right" onclick="this.value=''" />
									</td>
									<td>
			...
			<!-- ------------------Bank Payment----------------------- -->
			<table align="center" bgcolor="<?php print $main_tale_color; ?>" height="100%" <?php if ($systemid == 1) {
				   echo 'style="display:none;"';
			   } ?>>
				<tr>
					<td width="30px"></td>
					<td colspan="2" width="230px" style="font-size:12pt; color:navy; font-weight:bold; height:40px;">
						Bank Payment</td>
					<td width="30px"></td>
				</tr>
				<tr>
			...
			<table align="center" bgcolor="#E2DDCC" height="100%">
				<tr>
					<td width="30px"></td>
					<td colspan="2" style="font-size:12pt; color:navy; font-weight:bold; height:40px; width:230px">
						Credit Payment</td>
					<td width="30px"></td>
				</tr>
				<tr>
			...
			<?php if ($systemid == 1) { ?>
				<div id="finalize">
					<input type="button" value="Create Invoice & Finalize"
						style="width:100%; height:60px; background-color:orange" onclick="finalyze()" />
				</div>
			<?php } ?>
		</td>
		<td width="10px"></td>
		<td style="vertical-align:top; <?php if ($systemid == 1) {
			echo 'display:none;';
		} ?>">
			<!-- ------------------Chque Payment----------------------- -->
			<table align="center" bgcolor="<?php print $main_tale_color; ?>" <?php if ($systemid == 1) {
				   echo 'style="display:none;"';
			   } ?>>
				<tr>
					<td width="30px"></td>
					<td colspan="4" style="font-size:12pt; color:navy; font-weight:bold;" colspan="2"><br />Chque
						Payment<br /><br /></td>
				</tr>
				<tr>
					<td></td>
					<td style="font-size:12pt">Amount</td>
					<td><input type="text" name="amount_chque" id="amount_chque" value="0" onclick="this.value=''" />
					</td>
					<td></td>
					<td width="30px"></td>
				</tr>
				...
				<tr>
					...
					<td><input type="number" name="chque_no" id="chque_no"
							style="width:60px" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="chque_bank"
							id="chque_bank" style="width:35px;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"
							name="chque_branch" id="chque_branch" style="width:35px" onfocus="validateBank()" /></td>
					<td></td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					<td></td>
					<td style="font-size:12pt">Chque Name</td>
					<td>
				...
				<tr>
					<td></td>
					<td></td>
					<td colspan="3" height="10px"><input type="button" value="Add Payment"
							style="width:100px; height:35px" onclick="setBillPayment()" /></td>
				</tr>
				<tr>
								...
								<tr>
									<td>
										<select name="card_bank" id="card_bank"
											style="display:block:float:left;width:137px;">
											<option value="">-SELECT BANK-</option>
											<?php for ($i = 0; $i < sizeof($ac_bank_id); $i++) {
												print '<option value="' . $ac_bank_id[$i] . '">' . $ac_bank_name[$i] . '</option>';
											} ?>
									...
									<td>
										<input type="text" name="amount_card" id="amount_card" value="0"
											style="width:60px; text-align:right; display:block; float:right;"
											onclick="this.value=''" />
									</td>
								</tr>
							</table>
					...
					<tr>
						...
						<td colspan="2" align="left">
							<input type="text" placeholder="4000-0566-5566-5556" name="card_no" id="card_no"
								style="width:132px; margin-left:3px;" />
						</td>
						<td></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2">
							<input type="text" name="fu_down_pay" id="fu_down_pay" value="0"
								style="width:80px; text-align:right" onclick="this.value=''" /> <input type="button"
								value="Add Payment" style="width:100px; height:40px" onclick="setBillPayment()" />
						</td>
						<td></td>
					</tr>
					<tr>
		...
		<td style="vertical-align:top">
			...
			<table>
				...
				<tr>
					...
					<td width="70px" align="right" class="sidetable2">
						T<?php print str_pad($_GET['bill_no'], 7, "0", STR_PAD_LEFT); ?><input type="hidden"
							name="invoice_no" value="<?php print $_GET['bill_no']; ?>" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="sidetable1">Cash Payment</td>
					<td align="right" class="sidetable2">
						<div id="payment_cash_div"></div>
					</td>
				</tr>
				<tr>
					<td class="sidetable1">Card Payment</td>
					<td align="right" class="sidetable2">
						<div id="payment_card_div"></div>
					</td>
				</tr>
				<tr>
					<td class="sidetable1">Bank Payment</td>
					<td align="right" class="sidetable2">
						<div id="payment_bank_div"></div>
					</td>
				</tr>
				<tr>
					<td class="sidetable1">Chque Payment</td>
					<td align="right" class="sidetable2">
			...
			<?php if ($bm_hire_purchase) { ?>
				...
				<table style="font-size:10pt">
					<tr>
						<td colspan="2" align="center" style="background-color:#467898; color:white;">Hire Purchase
							Instalment</td>
					</tr>
					<tr>
						<td class="sidetable1">Cal Start Date</td>
						<td class="sidetable2"><input type="date" id="cal_start_date" value="<?php print $today; ?>"
								style="width:125px" /></td>
					</tr>
					<tr>
						<td class="sidetable1">Schedule Type</td>
						<td class="sidetable2">
					...
					<tr>
						<td colspan="2">
							<table cellspacing="0">
								...
								<tr bgcolor="#EEEEEE">
									<td align="center">
										<input type="number" id="hp_amount" style="width:80px; text-align:right;"
											onclick="this.value=''" />
									</td>
									<td align="center" bgcolor="#EEEEEE">X</td>
									<td align="center">
										<input type="number" id="hp_count" style="width:80px; text-align:right;"
											onclick="this.value=''" />
									</td>
									<td align="center" bgcolor="#EEEEEE">=</td>
									<td align="center">
										<input type="number" id="hp_total" style="width:80px; text-align:right;"
											readonly="readonly" />
									</td>
									<td align="center">
