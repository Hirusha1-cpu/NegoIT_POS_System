...
<script type="text/javascript">
	...
	function validatePayment(){
	    ...
	    if(($count==0)&&(txt==2)){
	    	...
	    	if(validateDate(document.forms["payForm"]["chque_date"].value)==false){ $count++;	$msg='Date Must Be in 2021-11-28 Format'; 	}
...
<div class="w3-container" style="margin-top:75px">
	...
	<table align="center">
		<tr>
			...
			<form name="payForm" action="index.php?components=bill2&action=add_payment" onsubmit="return validatePayment()" method="post" >
				...
				<table align="center" bgcolor="#E5E5E5" style="border-radius: 15px;">
					...
					<tr>
						<td></td>
						<td>Invoice No</td>
						<td><input type="number" name="invoice_no" id="invoice_no" onchange="invoiceNumberChange()" /></td>
						<td><input type="button" value="check" onclick="validateInvoice()" /></td>
						<td><div id="invoice_div"></div></td>
					</tr>
					<!-- Payment Type -->
					<tr>
						<td width="20px;"></td>
					...
					<tr>
						...
						<td>Amount</td>
						<td>
							<input type="number" name="amount" id="amount_chque" step="0.01"/></td>
						<td></td>
						<td></td>
					</tr>
					<!-- Card -->
					<tr>
						...
						<td colspan="3">
							<div id="sw_card" style="display:none">
									...
									<tr><td width="100px">Card Terminal</td><td>
									...
									<tr id="card_tr" style="display:none">
										...
										<td style="padding-top:8px;">
											<input type="text" id="card_no" name="card_no" style="margin-left:10px" placeholder="1400-4400-0000-1000" />
										</td>
									</tr>
									</table>
							...
							<div id="sw_bank" style="display:none">
									...
									<tr id="auth_tr" style="display:none">
										...
										<td style="padding-top:8px;">
											...
											<td width="10px"></td><td><div id="div_bk_validate"></div></td>
										</td>
									</tr>
									<?php } ?>
									</table>
					...
					<tr>
						...
						<td colspan="3">
							<div id="sw_cheque" style="display:none">
										...
										<td>
											<table cellspacing="0">
												<tr>
													...
													<td>
														<input type="text" name="chque_branch" id="chque_branch" style="width:40px" onfocus="validateBank()" />
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td height="20px"></td><td><div id="bk_name" align="right"></div></td><td><div id="av_qty" align="center"></div></td>
									</tr>
									<tr>
										<td>Cheque Date</td><td><input type="date" name="chque_date" id="chque_date" /></td><td><div id="av_qty" align="right"></div></td>
									</tr>
									</table>
							</div>
						</td>
			...
			<div id="portrait">
				...
				<div style="background-color:#EEEEEF; border-radius: 15px; padding-left:10px; padding-right:10px">
                    ...
                    if(isset($_GET['cust'])){
                        ...
                        print '<tr><td colspan="3"><h4 class="style2" align="center">Latest Payments</h4></td></tr>';
					...
					<?php if(isset($_GET['cust'])){ ?>
						<table align="center" width="100%">
							...
							<tr>
								<td bgcolor="#E5E5E5" align="right" ><?php print number_format($balance30); ?></td>
								<td bgcolor="#E5E5E5" align="right" ><?php print number_format($balance14); ?></td>
								<td bgcolor="#E5E5E5" align="right" ><?php print number_format($balance7); ?></td>
								<td bgcolor="#E5E5E5" align="right" ><?php print number_format($balance0); ?></td>
							</tr>
