...
<script type="text/javascript">
	<?php if (isset($_COOKIE['district'])) { ?>
		$(function () {
			<?php if ($systemid == 1 || $systemid == 4 || $systemid == 10) { ?>
				var availableTags44 = [<?php for ($x = 0; $x < sizeof($sm_name); $x++) {
					print '"' . ucfirst($sm_name[$x]) . '",';
				} ?>];
				$("#sm").autocomplete({
					source: availableTags44
				});
			<?php } ?>
			var availableTags0 = [<?php for ($x = 0; $x < sizeof($cust_mobile); $x++) {
				print '"' . $cust_mobile[$x] . '",';
			} ?>];
			$("#mob").autocomplete({
			...
			var availableTags4 = [<?php for ($x = 0; $x < sizeof($unic_item_list); $x++) {
				print '"' . $unic_item_list[$x] . '",';
			} ?>];
			$("#tags4").autocomplete({
		...
		function selectCust() {
			...
			var mobile_arr = [<?php for ($x = 0; $x < sizeof($cust_mobile); $x++) {
				print '"' . $cust_mobile[$x] . '",';
			} ?>];
			...
			<?php if ($systemid == 1 || $systemid == 4 || $systemid == 10) { ?>
				var sm_id_arr = [<?php for ($x = 0; $x < sizeof($sm_id); $x++) {
					print '"' . $sm_id[$x] . '",';
				} ?>];
				var sm_name_arr = [<?php for ($x = 0; $x < sizeof($sm_name); $x++) {
					print '"' . $sm_name[$x] . '",';
				} ?>];
		...
		function getPrice() {
			...
			var wprice = [<?php for ($x = 0; $x < sizeof($w_price); $x++) {
				print '"' . $w_price[$x] . '",';
			} ?>];
			var rprice = [<?php for ($x = 0; $x < sizeof($r_price); $x++) {
				print '"' . $r_price[$x] . '",';
			} ?>];
			var qty = [<?php for ($x = 0; $x < sizeof($qty); $x++) {
				print '"' . $qty[$x] . '",';
			} ?>];
			var drawer = [<?php for ($x = 0; $x < sizeof($drawer); $x++) {
				print '"' . $drawer[$x] . '",';
			} ?>];
			...
			var pr_sr = [<?php for ($x = 0; $x < sizeof($pr_sr); $x++) {
				print '"' . $pr_sr[$x] . '",';
			} ?>];
	...
	function proceedToPayment() {
		...
		window.location = 'index.php?components=billing&action=pay_bill&cust_odr=<?php print $_GET["cust_odr"]; ?>&id=<?php if (isset($_GET['id']))
				 print $_GET['id']; ?>&s=' + salesman;
	}
		...
		<tr>
			<td>
				<table width="190px" align="center" style="font-family:Arial, Helvetica, sans-serif">
					<tr>
						<td><span style="font-family:'Arial'; font-size:20pt">INVOICE</span></td>
					</tr>
					<tr>
						<td style="font-size:8pt"><strong><?php print $tm_shopname; ?></strong>.<br />
				...
				<table align="center" width="210px" border="0" cellspacing="0"
					...
					<tr style="font-family:Arial; font-size:8pt; text-align:center">
						<td>DESCRIPTION</td>
						<td>UNIT<br />PRICE</td>
						<td>QTY</td>
						<td>TOTAL</td>
		...
		<td valign="top" align="center">
			<div id="div_rep" style="display:none">
				...
				<table width="100%" bgcolor="#EEEEEE">
					<tr>
						<td style="font-size:16pt; color:navy" align="center">Pre Check for Repairs</td>
					</tr>
				</table>
				<br />
				<table border="1" cellspacing="0">
					<tr>
						<td>
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_1" id="pre_1_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_1" id="pre_1_2" value="Display Has an Issue"
											onchange="repairePreCheck()"></td>
									<td width="10px"></td>
									<td rowspan="2">Display</td>
								</tr>
								<tr class="yesno">
									<td bgcolor="#E5E5E5" align="center">Yes</td>
									<td bgcolor="#E5E5E5" align="center">No</td>
									<td></td>
								</tr>
							</table>
						</td>
						<td>
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_2" id="pre_2_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_2" id="pre_2_2" value="Mic Has an Issue"
											onchange="repairePreCheck()"></td>
									<td width="10px"></td>
									<td rowspan="2">Mic</td>
								</tr>
						...
						<td>
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_3" id="pre_3_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_3" id="pre_3_2" value="Vol/Down Has an Issue"
											onchange="repairePreCheck()"></td>
									<td width="10px"></td>
									<td rowspan="2">Vol/Down<br />Switch</td>
								</tr>
								<tr class="yesno">
									<td bgcolor="#E5E5E5" align="center">Yes</td>
									<td bgcolor="#E5E5E5" align="center">No</td>
					...
					<tr>
						<td>
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_4" id="pre_4_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_4" id="pre_4_2" value="Speaker Has an Issue"
											onchange="repairePreCheck()"></td>
									<td width="10px"></td>
						...
						<td>
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_5" id="pre_5_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_5" id="pre_5_2" value="Ringer Has an Issue"
											onchange="repairePreCheck()"></td>
									<td width="10px"></td>
						...
						<td>
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_6" id="pre_6_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_6" id="pre_6_2" value="Camera Switch Has an Issue"
											onchange="repairePreCheck()"></td>
									<td width="10px"></td>
									<td rowspan="2">Camera<br />Switch</td>
								</tr>
								<tr class="yesno">
									<td bgcolor="#E5E5E5" align="center">Yes</td>
									<td bgcolor="#E5E5E5" align="center">No</td>
					...
					<tr>
						<td>
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_7" id="pre_7_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_7" id="pre_7_2" value="Signal Has an Issue"
											onchange="repairePreCheck()"></td>
									<td width="10px"></td>
						...
						<td>
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_8" id="pre_8_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_8" id="pre_8_2" value="Touch Has an Issue"
											onchange="repairePreCheck()"></td>
									<td width="10px"></td>
						...
						<td>
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_9" id="pre_9_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_9" id="pre_9_2" value="Keypad Lights Has an Issue"
											onchange="repairePreCheck()"></td>
									<td width="10px"></td>
									<td rowspan="2">Light<br />(Keypad)</td>
								</tr>
								<tr class="yesno">
									<td bgcolor="#E5E5E5" align="center">Yes</td>
									<td bgcolor="#E5E5E5" align="center">No</td>
					...
					<tr>
						<td>
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_10" id="pre_10_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_10" id="pre_10_2" value="Camera Has an Issue"
											onchange="repairePreCheck()"></td>
									<td width="10px"></td>
						...
						<td>
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_11" id="pre_11_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_11" id="pre_11_2" value="Charging Has an Issue"
											onchange="repairePreCheck()"></td>
									<td width="10px"></td>
									<td rowspan="2">Charging</td>
								</tr>
								<tr class="yesno">
									<td bgcolor="#E5E5E5" align="center">Yes</td>
									<td bgcolor="#E5E5E5" align="center">No</td>
						...
						<td>
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_12" id="pre_12_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_12" id="pre_12_2"
											value="Display Light Has an Issue" onchange="repairePreCheck()"></td>
									<td width="10px"></td>
									<td rowspan="2">Light<br />(Display)</td>
								</tr>
								<tr class="yesno">
									<td bgcolor="#E5E5E5" align="center">Yes</td>
									<td bgcolor="#E5E5E5" align="center">No</td>
					...
					<tr>
						<td>
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_13" id="pre_13_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_13" id="pre_13_2" value="Memory Card Has an Issue"
											onchange="repairePreCheck()"></td>
									<td width="10px"></td>
									<td rowspan="2">Memory<br />Card</td>
								</tr>
								<tr class="yesno">
									<td bgcolor="#E5E5E5" align="center">Yes</td>
									<td bgcolor="#E5E5E5" align="center">No</td>
						...
						<td>
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_14" id="pre_14_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_14" id="pre_14_2"
											value="Call Transmitting Has an Issue" onchange="repairePreCheck()"></td>
									<td width="10px"></td>
									<td rowspan="2">Call<br />Transmitting</td>
								</tr>
								<tr class="yesno">
									<td bgcolor="#E5E5E5" align="center">Yes</td>
									<td bgcolor="#E5E5E5" align="center">No</td>
						...
						<td>
							<table cellspacing="0">
								<tr>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_15" id="pre_15_1" value="yes"
											onchange="repairePreCheck()"></td>
									<td bgcolor="#E5E5E5"><input type="radio" name="pre_15" id="pre_15_2"
											value="Keypad Buttons Has an Issue" onchange="repairePreCheck()"></td>
									<td width="10px"></td>
									<td rowspan="2">Keypad<br />Button</td>
								</tr>
								<tr class="yesno">
									<td bgcolor="#E5E5E5" align="center">Yes</td>
									<td bgcolor="#E5E5E5" align="center">No</td>
		...
		<td valign="top">
			<div style="background-color:#EEEEEF; border-radius: 15px; padding-left:10px; padding-right:10px">
				<table width="100%">
					<tr>
						<td>
							<h1 style="color:#2277DD"><?php if ($cust_odr == 'no')
								print 'Sales Billing';
							else
								print 'Cust Order'; ?>
							</h1>
						...
						?>
						<td align="right">
							<select name="district" id="district" onchange="setDistrict('billing')" <?php if ($static_district != 0)
			...
			<?php if ($current_district != '') {
				if (isset($_REQUEST['id']))
					print '<form id="billingForm" action="index.php?components=billing&action=apend_bill&cust_odr=' . $cust_odr . '" onsubmit="return validateBill()" method="post" >';
				else
					print '<form id="billingForm" action="index.php?components=billing&action=new_bill&cust_odr=' . $cust_odr . '" method="post" >';

				if (!isset($_REQUEST['quotation']))
					print '<input type="hidden" name="quotation" value="0" />';
				?>
				...
				<?php if (isset($_GET['cust']))
					print '<input type="hidden" id="cust" value="' . $_GET['cust'] . '" />'; ?>
				...
				<input type="hidden" id="cachback_tmp" value="<?php if (isset($_GET['cashback']))
					print $_GET['cashback'];
				else
					print '0'; ?>" />
				...
				<table align="center" bgcolor="<?php print $main_tale_color; ?>" style="border-radius: 15px;">
					...
					if (isset($_GET['cust'])) {
						...
						if ($cust_mtype == 'primary')
							print '<span style="color:red">Primary<br />Customer</span>';
						elseif ($cust_mtype == 'secondary')
							print '<span style="color:red">Secondary<br />Customer</span>';
						else
							print 'Customer';
					...
					<tr>
						...
						<td colspan="2" style="font-size:12pt; color:maroon">
							...
							if (isset($_GET['cust'])) {
								...
								if ($systemid == 1)
									print 'Ref &nbsp;: ' . ucfirst($cust_asso_sman[$cid]);
							} ?>
						</td>
						<td width="50px"></td>
					</tr>
							...
							<td colspan="2">
								...
								<?php if (!isset($_GET['cust'])) {
									if ($_COOKIE['retail'] == 0) { ?><input type="button" value="Create Cust"
											onclick="window.location = 'index.php?components=billing&action=wholesale_cust&s=<?php print $_GET['s']; ?>&cust_odr=<?php print $cust_odr; ?>'"
											style="width:100px; height:50px;" /> <?php }
									if ($_COOKIE['retail'] == 1) { ?><input type="button" value="Create Cust"
											onclick="window.location = 'index.php?components=billing&action=onetime_cust&s=<?php print $_GET['s']; ?>&cust_odr=<?php print $cust_odr; ?>'"
											style="width:100px; height:50px;" /> <?php }
								} ?>
								<br /><br />
							</td>
					...
					<?php } else { ?>
						...
						<tr>
							...
							<td colspan="2"><input id="cashback" type="checkbox" <?php if (isset($_GET['cashback'])) {
								if ($_GET['cashback'] == 1)
						...
						<tr>
							...
							<td colspan="2"><input type="text" name="code" id="tags1" value="<?php if ($unic_item_code != '')
								print $unic_item_code; ?>" onclick="this.value=''" /></td>
							<td width="50px"></td>
						</tr>
						<tr>
							<td width="50px"></td>
							...
							<td colspan="2"><input type="text" name="description" id="tags2"
									onchange="document.getElementById('tags1').value=''" /></td>
							<td width="50px"></td>
						</tr>
						<tr>
							<td></td>
							<td style="font-size:12pt">Quantity</td>
							<td><?php if ($is_unic_item == 0) { ?><input type="number" name="qty1" id="qty1" onfocus="getPrice()" /><?php } else {
							...
							<td>
								...
								<div style="font-size:10pt; color:#CC0000" id="tt_qty" align="right"></div><input type="hidden"
									id="av_qty_val" />
							</td>
							<td></td>
						</tr>
						...
						<tr>
							...
							<td style="font-size:12pt">
								<table border="0">
									<tr>
										<td>Unit Discount</td>
										<td>
											<div id="discount_div" onclick="changeDiscount()" style="color:blue; cursor:pointer;">
							...
							<td colspan="2">
								<table width="100%">
									<tr>
										<td><input type="number" name="discount" id="discount" value="0" style="width:50px"
												onclick="this.value=''" /><input type="button" value="Check"
												onclick="loadDiscount('<?php print $_GET['cust']; ?>')" /></td>
										<td>
						...
						<tr>
							<td width="50px"></td>
							<td style="font-size:12pt">
								<div id="tech_n" style="display:none">Technicient</div>
							</td>
							<td colspan="2">
								<div style="font-size:12pt; display:none" id="tech_d">
						...
						<tr>
							<td colspan="2" align="right"><br />
								<div id="addtobill">
									<?php if (((sizeof($bill_id) < $apend_limit) || ($tm_template == 2)) && ($bill_user == $bm_sys_user0))
										print '<input type="submit" value="Add to Bill" style="width:100px; height:30px" onclick="cashBack()" />'; ?>
								</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<?php if ((sizeof($bill_id) > 0) && ($bill_user == $bm_sys_user0)) { ?>
								</td>
								<td colspan="3" align="left">
									<div id="payment"><input type="Button" value="Payment" style="width:100px; height:70px"
											onclick="proceedToPayment()" /></div>
								<?php } ?>
								<!--	<input type="Button" value="Finalyze" style="width:100px; height:70px" onclick="window.location = 'index.php?components=billing&action=finish_bill&id=<?php if (isset($_GET['id']))
									print $_GET['id']; ?>'" /> -->
								<br /><br />
							</td>
						</tr>
			...
			<table align="center" style="font-size:12pt" width="100%">
				<tr style="height:35px">
					...
					<th bgcolor="#C5C5C5"
						title="Calculation of 'Up to Now'&#13;Invoice Total - Cash Payments - All Chque Payments">Up to Now</th>
				</tr>
				<tr>
					<td bgcolor="#E5E5E5" align="right"><?php echo number_format($return_array['balance_30'], $decimal); ?></td>
					<td bgcolor="#E5E5E5" align="right"><?php echo number_format($return_array['balance_14'], $decimal); ?></td>
					<td bgcolor="#E5E5E5" align="right"><?php echo number_format($return_array['balance_7'], $decimal); ?></td>
				...
				<tr>
					...
					<td bgcolor="#E5E5E5" align="right"><?php print number_format($pending_chque); ?></td>
				</tr>
				<tr>
					...
					<td bgcolor="#E5E5E5" align="right"><?php print number_format($remaining_cr_limit); ?></td>
				</tr>
			</table>
		</td>
		<td width="50px"></td>
			...
			<?php if (isset($_REQUEST['id'])) { ?>
				...
				<div style="background-color:#D1D8F1; border-radius: 5px; padding-left:20px; padding-right:20px; height:600px;">
					...
					<table>
						<tr>
							<td>
								<div id="printorder_h"><span style="font-weight:bold; font-size:12pt;">Invoice No:
										&nbsp;&nbsp;&nbsp;<?php print str_pad($_REQUEST['id'], 7, "0", STR_PAD_LEFT); ?></span></div>
							</td>
							<td width="20px"></td>
					...
					<table align="center" bgcolor="#E5E5EA" style="border-radius:5px;">
						...
						for ($i = 0; $i < sizeof($bill_id); $i++) {
							...
							if ($bill_cross_tr[$i] > 0)
								...
								$color1 = "auto";
							if ($bi_no_update[$i] == 0)
								$update_button = '<input type="Button" value="Update"  onclick="updateBill(' . $bill_id[$i] . ')" />';
							else
								$update_button = '<input type="Button" value="Update" onclick="alert(' . "'Update is Restricted for this item'" . ')" />';
							if ($allow_remove)
								$remove_button = '<input type="Button" value="Remove"  onclick="removeBill(' . $bill_id[$i] . ')" style="background-color:maroon; color:white"/>';
							else
								$remove_button = '';
					...
					if ($total == 0) {
						...
						<table width="100%" style="font-size:10pt">
							<tr bgcolor="#F5F5FF">
								<td>Returned Chques</td>
								<td align="right" style="padding-left:10px; padding-right:10px; color:red"><?php print $chq2_retuned; ?>
								</td>
							</tr>
							<tr bgcolor="#F5F5FF">
								<td>Postponed Chques</td>
								<td align="right" style="padding-left:10px; padding-right:10px; color:red"><?php print $chq2_postpone; ?>
								</td>
							</tr>
							<tr bgcolor="#F5F5FF">
								<td>Deposited Chques</td>
								<td align="right" style="padding-left:10px; padding-right:10px; color:blue"><?php print $chq2_banked; ?>
								</td>
							</tr>
						</table>
						<?php
				...
				<div style="background-color:#EEEEEF; border-radius: 5px; padding-left:10px; padding-right:10px; width:250px">
					...
					<table align="center" height="100%">
						<tr>
							<td style="font-size:12pt;">
								<form id="searchinv"
									action="index.php?components=billing&action=search_bill&s=<?php print $_GET['s']; ?>&cust_odr=<?php print $_GET['cust_odr']; ?>"
									method="post"><input type="text" style="width:100px" name="search1" id="search1"
										placeholder="Invoice Number" /><input type="Submit" value="Search" /></form>
							</td>
						</tr>
						<tr>
							<td style="font-size:12pt;">
								<form action="index.php"><input type="hidden" name="components" value="billing" /><input type="hidden"
										name="action" value="home" /><input type="hidden" name="s" value="<?php print $_GET['s']; ?>" /><input
										type="hidden" name="cust_odr" value="<?php print $_GET['cust_odr']; ?>" /><input type="text"
										style="width:100px" name="searchcust" placeholder="Customer Name" /><input type="Submit"
										value="Search" /></form>
							</td>
						</tr>
						<tr>
							<td style="font-size:12pt;">
								<form action="index.php"><input type="hidden" name="components" value="billing" /><input type="hidden"
										name="action" value="home" /><input type="hidden" name="s" value="<?php print $_GET['s']; ?>" /><input
										type="hidden" name="cust_odr" value="<?php print $_GET['cust_odr']; ?>" /><input type="text"
										style="width:100px" name="searchunic" placeholder="Unique ID" /><input type="Submit" value="Search" />
								</form>
							</td>
						</tr>
					</table>
...
if ($current_district == '') {
	if ($static_district != 0)
		print '<script type="text/javascript"> document.getElementById("district").value=' . $static_district . '; setDistrict("billing"); </script>';
}
