	...
	function addToBill() {
		...
		if ($itm_unic == '1') {
			...
			for ($i = 0; $i < $items.length; $i++) {
				...
				if ($discount_type == 'percentage') {
					$discount = ((($price.slice(2)) / 100) * ($discount_val)).toFixed(2);
				} else {
			...
			$discount = 0;
			if ($discount_type == 'percentage') {
				$discount = ((($uprice.slice(2)) / 100) * ($discount_val)).toFixed(2);
			} else {
				$discount = $discount_val;
			}
						...
						<?php if ($current_district != '') { ?>
							<table align="center" bgcolor="<?php print $main_tale_color; ?>" border="0" class="bill-table">
								...
								<tr>
									...
									<td colspan="2">
										<div class="frmSearch">
											<input type="text" id="search-code" value="" onclick="this.value=''"
								...
								<tr>
									...
									<td>
										<div id="sn_div" style="display:none">
											<input type="text" id="search-sn" value="" onclick="this.value=''"
												autocomplete="off" />
											<div id="suggesstion-sn"></div>
										</div>
										<div id="qty_div">
											<input type="number" name="qty" id="qty" style="width:65px"
												onclick="this.value=''" />
										</div>
									</td>
									<td>
								...
								<tr>
									...
									<td colspan="2">
										<table width="100%">
											<tr>
												<td>
													<input type="number" name="discount" id="discount" style="width:50px"
														onclick="this.value=''" />
													<input type="button" value="Cal" onclick="getSNList()" />
													<input type="button" value="Check"
														onclick="loadDiscount('<?php print $cu_id; ?>')" />
												</td>
												<td>
									...
									<tr>
										...
										<td colspan="2">
											<table width="100%" style=" font-size:12pt">
												<tr>
													<td>
														<input type="number" name="discount_for_invoice"
															id="discount_for_invoice" style="width:70px" value="<?php if (isset($invoice_discount))
																print $invoice_discount; ?>" />
													</td>
													<td>
									...
									<tr>
										...
										<td colspan="2">
											<table width="100%" style=" font-size:12pt">
												<tr>
													<td>
														<input type="date" name="due_date" id="due_date" style="width:120px"
															value="<?php if (isset($due_date))
																print $due_date; ?>" />
													</td>
													<td>
								...
								<tr id="tr_rp_model" style="display:none;">
									...
									<td colspan="2">
										<div id="rp_mod_div">
											<input type="text" id="repair_model" name="repair_model"
												placeholder="Repair Model" />
										</div>
									</td>
									<td width="20px;"></td>
								</tr>
								...
								<tr>
									<td colspan="5" align="center">
										...
										<div id="div_submit" style="display:none; margin:20px;">
											<input type="button" value="To Payment" onclick="proceedToPayment()"
												style="width:100px; height:50px;" />
										</div>
									</td>
								</tr>
			...
			<div id="portrait">
				<div class="div-temp-bill">
					...
					<table width="100%">
						<tr>
							<td>
								<div id="printorder_h">
									<span style="font-weight:bold; font-size:12pt;">Temp Bill No:
										&nbsp;&nbsp;&nbsp;T<?php print str_pad($_GET['bill_no'], 7, "0", STR_PAD_LEFT); ?></span>
								</div>
							</td>
							<td width="20px"></td>
							<td>
								<input type="button" value="Delete Bill" onclick="deleteTMPBill()"
				...
				<table width="100%" align="center" class="table-cheques">
					<tr bgcolor="#F5F5FF">
						...
						<td align="right" style="padding-left:20px;; padding-right:20px;; color:red">
					...
					<tr bgcolor="#F5F5FF">
						...
						<td align="right" style="padding-left:20px;; padding-right:20px;; color:blue">
				...
				<table align="center" width="100%" class="table-balance">
					<tr style="height:35px">
						...
						<th bgcolor="#C5C5C5"
							title="Calculation of 'Up to Now'&#13;Invoice Total - Cash Payments - All Chque Payments">Up
							to Now</th>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="3" bgcolor="#E5E5E5" align="right" style="padding-right:20px;">Cheque to be
							Credited</td>
						<td bgcolor="#E5E5E5" align="right"><?php print number_format($pending_chque, $decimal); ?></td>
					</tr>
					<tr>
						<td colspan="3" bgcolor="#E5E5E5" align="right" style="padding-right:20px;"
	...
	<div class="w3-row">
		...
		<div class="w3-col">
			...
			<div id="div_repair" style="display:none">
				<table width="100%" bgcolor="#EEEEEE" align="center">
					<tr>
						<td style="font-size:10pt; color:navy;">Pre Check for Repairs</td>
					</tr>
				</table>
				<br />
