									...
									<tr>
										...
										<td colspan="2">
											<table width="100%" style=" font-size:12pt">
												<tr>
													<td>
														<input type="number" name="discount_for_invoice" id="discount_for_invoice" style="width:70px"
															value="<?php if (isset($invoice_discount))
																print $invoice_discount; ?>" />
													</td>
													<td>
