	...
	<table align="center" style="font-family:Calibri; font-size:10pt">
		<tr>
			<td valign="top">
					...
					<form action="index.php?components=bill2&action=add_payment" onsubmit="return jobPayment()" method="post">
						...
						<table align="center" bgcolor="#EEEEEE" style="font-family:Calibri; font-size:10pt">
							...
							<tr>
								...
								<td>
									<input type="number" name="chque_no" id="chque_no"
										style="width:60px" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="text" name="chque_bank" id="tags4"
										style="width:35px" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="text" name="chque_branch" id="chque_branch" style="width:35px"
				...
				if ($bm_type == 3) { ?>
					<form method="post"
						action="index.php?components=bill2&action=add_repair_comment&id=<?php print $_GET['id']; ?>">
