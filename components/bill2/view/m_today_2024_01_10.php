		...
		<div class="w3-col">
			...
			<div class="wrap">
				...
				<div class="table-responsive">
					<table align="center" width="100%" style="background:dddddd">
						<tr>
					...
					<table align="center" class="styled-table" style="margin-top:0px" width="100%">
						<thead>
							<tr>
							...
							<tr>
								<th width="20px">#</th>
								<th width="140px" align="center">Invoice No</th>
				...
				<div class="table-responsive">
					<table align="center" border="0"  class="styled-table" width="100%">
						<thead>	
							<tr>
								<td colspan="5" style="color: black; background: #dddddd;" class="td-style"><strong style="padding-left: 10px">Temporary Invoices</strong></td>
							</tr>
							<tr>
								<th width="20px">#</th>
								<th width="140px" align="center">Temp Bill No</th>
								<th width="120px" align="center">Date</th>
								<th width="100px" align="center">Amount</th>
								<th align="center">Customer</th>
							</tr>
						...
						$inv=0;
							for($i=0;$i<sizeof($tmp_bm_no);$i++){
								if($tmp_bm_type[$i]==4 || $tmp_bm_type[$i]==5) $cust_odr='yes'; else $cust_odr='no';
				...
				<!-- Payment Invoices -->
				<div class="table-responsive">
					<table align="center" class="styled-table" width="100%">
						<thead>
							<tr>
						...
						<tbody>
							...
							$inv=0;
								for($i=0;$i<sizeof($rt_invno);$i++){
									if($rt_status[$i]==1) $edit='<input type="Button" value="Edit"  onclick="window.location = '."'".'index.php?components=bill2&action=item_return&id='.$rt_invno[$i].'&cust=15&cust='.$rt_cust_id[$i]."'".'" />'; else $edit='';
