					...
					<table width="100%" style="font-size:12pt" cellspacing="0">
						...
						<tr>
							...
							<td>
								<table cellspacing="0">
									<tr>
										<td><input type="number" name="chque_no" id="chque_no" style="width:60px" />&nbsp;&nbsp;&nbsp;&nbsp;
										</td>
										<td><input type="text" name="chque_bank" id="tags4" style="width:35px" />&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
<?php if (isset($_GET['cust'])) { ?>
	<table align="center" style="font-size:12pt" width="100%">
		...
		<tr>
			<?php if ($systemid == 17) { ?>
				<td bgcolor="#E5E5E5" align="right"><?php echo number_format($return_array['balance_90'], $decimal); ?></td>
				<td bgcolor="#E5E5E5" align="right"><?php echo number_format($return_array['balance_60'], $decimal); ?></td>
			...
			<?php } else { ?>
				...
				<td bgcolor="#E5E5E5" align="right"><?php echo number_format($return_array['current_balance_0'], $decimal); ?></td>
			<?php } ?>
		</tr>
		<tr>
