...
<div class="w3-container" style="margin-top:75px">
	...
	<div class="w3-row">
		...
		<div class="w3-col">
			<?php
			if ($_GET['action'] == 'wholesale_cust'){
				if($systemid ==13){
					include_once  'components/bill2/view/tpl/cust_create_13.php';
				}else{
					include_once  'components/bill2/view/tpl/cust_create.php';
				}
			}
			if ($_GET['action'] == 'onetime_cust')	include_once  'components/bill2/view/tpl/cust_create.php';
			if ($_GET['action'] == 'cust_details')	include_once  'components/bill2/view/tpl/cust_details.php';
			?>
		</div>
	</div>
</div>
