			...
			xhttp.onreadystatechange = function() {
				if(this.readyState == 4 && this.status == 200) {
					...
					if(returntext=='Done'){
						...
						// if(document.getElementById('hidden_code').value != ''){
						// 	getItemData('code', decodeURIComponent(document.getElementById('hidden_code').value));
						// }
						// if(document.getElementById('hidden_description').value != ''){
						// 	getItemData('desc', decodeURIComponent(document.getElementById('hidden_description').value));
						// }
					}else{
						document.getElementById('notifications').innerHTML='<span style="color:red; font-weight:bold; font-size:12pt;">'+returntext+'</span>';
					}
