									...
									<td colspan="2">
										<table>
											<tr>
												<td>
													<div id="div_submit">
														<input type="button" value="Submit" onclick="showBillTypeAlertAndProceed()"
						...
						<tr>
							<td>
								<form action="index.php">
									...
									<input type="text" style="width:148px" name="searchcustid" placeholder="Customer ID" value="<?php if (isset($_GET['searchcustid']))
										print $_GET['searchcustid']; ?>" onclick="this.value=''" />
									<input type="Submit" value="Search" />
								</form>
							</td>
						</tr>
						...
						<tr>
							<td>
								<form action="index.php">
									...
									<input type="hidden" name="s" value="<?php print $bill_salesman; ?>" />
									<input type="hidden" name="cust_odr" value="<?php print $_GET['cust_odr']; ?>" />
									<input type="text" style="width:148px" name="searchcustname" placeholder="Customer Name" value="<?php if (isset($_GET['searchcustname']))
										print $_GET['searchcustname']; ?>" onclick="this.value=''" />
									<input type="Submit" value="Search" />
								</form>
							</td>
						</tr>
						...
						<tr>
							<td>
								<form action="index.php">
									...
									<input type="hidden" name="s" value="<?php print $bill_salesman; ?>" />
									<input type="hidden" name="cust_odr" value="<?php print $_GET['cust_odr']; ?>" />
									<input type="text" style="width:148px" name="searchmob" placeholder="Mobile Number" value="<?php if (isset($_GET['searchmob']))
										print $_GET['searchmob']; ?>" onclick="this.value=''" />
									<input type="Submit" value="Search" />
								</form>
							</td>
						</tr>
						...
						<tr>
							<td>
								<form action="index.php">
									...
									<input type="hidden" name="s" value="<?php print $bill_salesman; ?>" />
									<input type="hidden" name="cust_odr" value="<?php print $_GET['cust_odr']; ?>" />
									<input type="text" style="width:148px" name="searchunic" placeholder="Unique ID" value="<?php if (isset($_GET['searchunic']))
										print $_GET['searchunic']; ?>" onclick="this.value=''" />
									<input type="Submit" value="Search" />
								</form>
							</td>
						</tr>
