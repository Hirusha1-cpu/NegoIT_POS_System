...
<script type="text/javascript">
	...
	function setBillPayment(){
		...
		if(document.getElementById('amount_cash').value!=''){
			var amount_cash=document.getElementById('amount_cash').value;
		}else{
			var amount_cash=0;
			document.getElementById('amount_cash').value=0;
		}

		<?php if($systemid == 10 || $systemid == 15){ ?>
			if(document.getElementById('amount_card').value!=''){
				var amount_card=document.getElementById('amount_card').value;
			}else{
				var amount_card=0; document.getElementById('amount_card').value=0;
			}
		<?php } ?>

		if(document.getElementById('amount_bank').value!=''){
			var amount_bank=document.getElementById('amount_bank').value;
		}
		else{
			var amount_bank=0; document.getElementById('amount_bank').value=0;
		}

		if(document.getElementById('amount_chque').value!=''){
			var amount_chque=document.getElementById('amount_chque').value;
		}else{
			var amount_chque=0; document.getElementById('amount_chque').value=0;
		}

		if(document.getElementById('amount_credit').value!=''){
			var amount_credit=document.getElementById('amount_credit').value;
		}else{
			var amount_credit=0; document.getElementById('amount_credit').value=0;
		}

		if(document.getElementById('fu_down_pay').value!='')
			var fu_down_pay=document.getElementById('fu_down_pay').value;
		else{
			var fu_down_pay=0; document.getElementById('fu_down_pay').value=0;
		}
	...
	function addPayment($invoice_no){
		...
		xmlhttp.onreadystatechange = function() {
			if(xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				if(returntext!=''){
					if(returntext=='Done'){
						progressBar(100);
						document.getElementById('notifications').innerHTML='<span style="color:green; font-weight:bold; font-size:12pt;">Payment was Addedd to the Invoice</span>';
						setFinal($invoice_no);
					}else{
						document.getElementById('notifications').innerHTML='<span style="color:red; font-weight:bold; font-size:12pt;">'+returntext+'</span>';
						document.getElementById('div_process').innerHTML='';
		...
		xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		<?php if($systemid == 10 || $systemid == 15){ ?>
			xmlhttp.send('invoice_no='+$invoice_no+'&amount_cash='+$amount_cash+'&amount_card='+$amount_card+'&card_bank='+$card_bank+'&card_no='+$card_no+'&amount_bank='+$amount_bank+'&tr_bank='+$tr_bank+'&amount_chque='+$amount_chque+'&chque_no='+$chque_no+'&chque_bank='+$chque_bank+'&chque_branch='+$chque_branch+'&chque_date='+$chque_date+'&comment='+$comment);
		<?php } else { ?>
			xmlhttp.send('invoice_no='+$invoice_no+'&amount_cash='+$amount_cash+'&amount_bank='+$amount_bank+'&tr_bank='+$tr_bank+'&amount_chque='+$amount_chque+'&chque_no='+$chque_no+'&chque_bank='+$chque_bank+'&chque_branch='+$chque_branch+'&chque_date='+$chque_date+'&comment='+$comment);
		<?php } ?>
		// console.log('invoice_no='+$invoice_no+'&amount_cash='+$amount_cash+'&amount_card='+$amount_card+'&card_bank='+$card_bank+'&card_no='+$card_no+'&amount_bank='+$amount_bank+'&tr_bank='+$tr_bank+'&amount_chque='+$amount_chque+'&chque_no='+$chque_no+'&chque_bank='+$chque_bank+'&chque_branch='+$chque_branch+'&chque_date='+$chque_date+'&comment='+$comment);
	}
...
<input type="hidden" id="hire_purchase" value="<?php if($bm_hire_purchase) print '1'; else print '0'; ?>" />
...
<table align="center" border="0">
	<tr>
		<td>
			<input type="button" value="Back" style="width:100px; height:30px" onclick="window.location = 'index.php?components=bill2&action=bill_item&cust_odr=<?php print $cust_odr; ?>&bill_no=<?php print $_GET['bill_no']; ?>'" />
		</td>
	...
	<tr>
		<td style="vertical-align:top;">
			...
			<div id="cash_bank_div1">
				<table align="center" bgcolor="<?php print $main_tale_color; ?>" height="100%">
					<tr>
						<td width="30px" ></td>
						<td colspan="2" width="230px" style="font-size:12pt; color:navy; font-weight:bold; height:40px;">Cash Payment</td>
						<td width="30px"></td>
					</tr>
					<tr>
						<td></td>
						<td colspan="2">
							<table>
								<tr>
									<td>
										<input type="text" name="amount_cash" id="amount_cash" value="0" style="width:60px; text-align:right" onclick="this.value=''" />
									</td>
									<td>
										<input type="button" value="Add Payment" style="width:100px; height:40px" onclick="setBillPayment()" />
									</td>
								</tr>
							</table>
						</td>
			...
			<table align="center" bgcolor="<?php print $main_tale_color; ?>" height="100%">
				<tr>
					<td width="30px" ></td>
					<td colspan="2" width="230px" style="font-size:12pt; color:navy; font-weight:bold; height:40px;">Bank Payment</td>
					<td width="30px"></td>
				</tr>
				<tr>
					<td></td>
					<td colspan="2">
						<table width="100%">
							<tr>
								...
								<td>
									<input type="text" name="amount_bank" id="amount_bank" value="0" style="width:60px; text-align:right" onclick="this.value=''" />
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					...
					<td colspan="2" align="center">
						<input type="text" name="comment" id="comment" style="width:100%" placeholder="References" />
					</td>
					<td></td>
				</tr>
				<?php if($systemid==15){ ?>
			...
			<table align="center" bgcolor="#E2DDCC" height="100%" >
				<tr>
					<td width="30px" ></td>
					<td colspan="2" style="font-size:12pt; color:navy; font-weight:bold; height:40px; width:230px">Credit Payment</td>
					<td width="30px"></td>
				</tr>
				<tr>
					<td></td>
					<td colspan="2">
						<input type="text" name="amount_credit" id="amount_credit" value="0" style="width:80px; text-align:right" onclick="this.value=''" />
						<input type="button" value="Add Payment" style="width:100px; height:40px" onclick="setBillPayment()" />
					</td>
					<td></td>
				</tr>
		...
		<td style="vertical-align:top;">
			...
			<tr><td></td><td style="font-size:12pt">Chque </td><td><input type="number" name="chque_no" id="chque_no" style="width:60px" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="chque_bank" id="chque_bank" style="width:35px;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="chque_branch" id="chque_branch" style="width:35px" onfocus="validateBank()" /></td><td></td><td></td></tr>
			...
			<tr><td></td><td></td><td colspan="3" height="10px"><input type="button" value="Add Payment" style="width:100px; height:35px" onclick="setBillPayment()" /></td></tr>
			...
			<table align="center" bgcolor="<?php print $main_tale_color; ?>" height="100%">
				<tr>
					...
					<td colspan="2" width="230px">
						<table width="100%">
							<tr>
								<td style="font-size:12pt; color:navy; font-weight:bold; height:40px;">Card Payment</td>
							</tr>
						</table>
					</td>
					<td width="60px">
				...
				<tr>
					...
					<td colspan="2">
						<table width="100%">
							<tr>
								<td>
									<select name="card_bank" id="card_bank" style="display:block:float:left;width:137px;">
									<option value="">-SELECT BANK-</option>
									<?php for($i=0;$i<sizeof($ac_bank_id);$i++){
										print '<option value="'.$ac_bank_id[$i].'">'.$ac_bank_name[$i].'</option>';
									}	?>
								...
								<td>
									<input type="text" name="amount_card" id="amount_card" value="0" style="width:60px; text-align:right; display:block; float:right;" onclick="this.value=''" />
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					...
					<td colspan="2" align="left">
						<input type="text" placeholder="4000-0566-5566-5556"  name="card_no" id="card_no" style="width:132px; margin-left:3px;"/>
					</td>
					<td></td>
				</tr>
				<tr>
					<td height="10px" colspan="4" align="center" style="padding-top:7px;">
						<input type="button" value="Add Payment" style="width:100px; height:40px" onclick="setBillPayment();" />
					</td>
				</tr>
				<tr>
			...
			<!-- ------------------Future Down Payment----------------------- -->
			 <?php if($bm_hire_purchase){ ?>
				<table align="center" bgcolor="#DDDDEE" width="100%" >
					<tr>
						<td width="30px" ></td>
						<td colspan="2" style="font-size:12pt; color:navy; font-weight:bold; height:40px; width:230px">Future Down Payment</td>
						<td width="30px"></td>
					</tr>
					<tr>
						<td></td>
						<td colspan="2">
							<input type="text" name="fu_down_pay" id="fu_down_pay" value="0" style="width:80px; text-align:right" onclick="this.value=''" /> <input type="button" value="Add Payment" style="width:100px; height:40px" onclick="setBillPayment()" />
						</td>
						<td></td>
					</tr>
					<tr><td height="10px" colspan="4"></td></tr>
			...
			<div id="finalize">
				<input type="button" value="Create Invoice & Finalize" style="width:100%; height:60px; background-color:orange" onclick="finalyze()" />
			</div>
		</td>
		<td width="10px"></td>
		<td style="vertical-align:top">
 			...
 			<table>
				<tr>
					<td class="sidetable1" >Customer</td>
				...
				<tr>
					...
					<td width="70px" align="right" class="sidetable2">T<?php print str_pad($_GET['bill_no'], 7, "0", STR_PAD_LEFT); ?><input type="hidden" name="invoice_no" value="<?php print $_GET['bill_no']; ?>" />
					</td>
				</tr>
				<tr><td colspan="2" height="30px" ></td></tr>
				<tr>
					<td class="sidetable1">Bill Amount</td>
					<td width="70px" align="right" class="sidetable2"><?php print number_format($bill_total,$decimal); ?><input type="hidden" id="invoicetotal" value="<?php print $bill_total; ?>" />
					</td>
				</tr>
				<tr><td class="sidetable1">Cash Payment</td><td align="right" class="sidetable2"><div id="payment_cash_div"></div></td></tr>
				<tr><td class="sidetable1">Card Payment</td><td align="right" class="sidetable2"><div id="payment_card_div"></div></td></tr>
				<tr><td class="sidetable1">Bank Payment</td><td align="right" class="sidetable2"><div id="payment_bank_div"></div></td></tr>
				<tr><td class="sidetable1">Chque Payment</td><td align="right" class="sidetable2"><div id="payment_chque_div"></div></td></tr>
				<tr>
					...
					<td align="right" class="sidetable2" style="background-color:#DDDDEE">
						<div id="payment_fu_down_pay_div" style="display:none"></div></td>
					</tr>
				<tr>
				...
				<tr>
					<td class="sidetable1" title="Calculation of Remaining Credit Limit&#13;Customer Credit Limit - Invoice Total + Cash Payments + Bank Payments + Deposited Cheque Payments" >Remaining of<br />Credit Limit
					</td>
					<td align="right" class="sidetable2">
						<div id="cr_balance_div" ><?php print number_format($remaining_cr_limit, $decimal); ?></div>
						<input type="hidden" id="crlimitbalance" value="<?php print $remaining_cr_limit; ?>" />
					</td>
				</tr>
			</table>
			...
			<table style="font-size:10pt">
				...
				<tr><td class="sidetable1">Cal Start Date</td><td class="sidetable2"><input type="date" id="cal_start_date" value="<?php print $today; ?>" style="width:125px" /></td></tr>
				<tr>
					<td class="sidetable1">Schedule Type</td><td class="sidetable2">
						<select id="hp_type" onchange="setHPType(this.value)">
				...
				<tr>
					<td class="sidetable1">Date</td><td class="sidetable2">
				...
				<tr>
					<td colspan="2">
						<table cellspacing="0">
							...
							<tr bgcolor="#EEEEEE">
								<td align="center">
									<input type="number" id="hp_amount" style="width:80px; text-align:right;" onclick="this.value=''" />
								</td>
								<td align="center" bgcolor="#EEEEEE">X</td>
								<td align="center">
									<input type="number" id="hp_count" style="width:80px; text-align:right;" onclick="this.value=''" />
								</td>
								<td align="center" bgcolor="#EEEEEE">=</td>
								<td align="center">
									<input type="number" id="hp_total" style="width:80px; text-align:right;" readonly="readonly" />
								</td>
								<td align="center">
									<input type="button" value="Cal" onclick="HPcal()" />
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td class="sidetable1">Status</td>
					<td align="center" class="sidetable2">
						<div id="hp_status"></div>
					</td>
				</tr>
			</table>
		 	<?php } ?>
