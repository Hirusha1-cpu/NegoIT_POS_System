					...
					<tr>
						<td>
							<?php
								...
								else if($tm_template==3) print '<iframe id="invoice_iframe" width="'.$page_width.'px" height="'.$page_height.'px" src="components/bill2/view/tpl/invoice_print3.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
