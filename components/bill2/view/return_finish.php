			...
			<div id="details_div" style="display:none">
				<table align="center" style="font-size:11pt; font-family:Calibri" >
					...
					<tr>
						...
						<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print ucfirst($main_returned_by); ?></td>
					</tr>
					<tr>
						<td style="background-color:#467898; color:white;" class="shipmentTB4">Processing Status</td>
						<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print ucfirst($main_process); ?></td>
					</tr>
					<tr>
			...
			<table align="center">
				<tr>
					<td bgcolor="#467898" style="font-family:Calibri; color:white; padding-left:10px">
						Return Invoice Status : <span <?php if($status_out=='Deleted') print 'class="blink"'; ?> style="color:<?php print $status_color; ?>;"><strong><?php print $status_out; ?></strong></span>
					</td>
					<td></td>
				</tr>
				<tr>
					<td>
						<?php
							if($tm_template==1 || $tm_template==3) print '<iframe id="invoice_iframe" width="'.$page_width.'px" height="'.$page_height.'px" src="components/bill2/view/tpl/return_print1.php?id='.$_GET['id'].'"></iframe>';
							if($tm_template==2 || $tm_template==4) print '<iframe id="invoice_iframe" width="250px" height="740px" src="components/bill2/view/tpl/return_print2.php?id='.$_GET['id'].'"></iframe>';
							if($tm_template==5) print '<iframe id="invoice_iframe" width="440px" height="550px" src="components/bill2/view/tpl/return_print5.php?id='.$_GET['id'].'"></iframe>';
							if($tm_template==15) print '<iframe id="invoice_iframe" width="480px" height="740px" src="components/bill2/view/tpl/return_print1.php?id='.$_GET['id'].'"></iframe>';
							if($tm_template==18) print '<iframe id="invoice_iframe" width="480px" height="740px" src="components/bill2/view/tpl/return_print18.php?id='.$_GET['id'].'"></iframe>';
						?>
					</td>
					<td valign="top" align="center">
						<div style="background-color:#6699FF; border:medium; border-color:black; width:80px;">
							<a class="shortcut-button" onclick="print_bill3()" href="#">
								<span style="text-decoration:none; font-family:Arial; color:navy;">
									<img src="images/print.png" alt="icon" /><br />Print Bill
								</span>
							</a>
						</div>
						<br />
						<?php if(returnPermission($_GET['id'])){ ?>
							<div style="background-color:#FF9191; border:medium; border-color:black; width:80px;">
								<a class="shortcut-button" onclick="(<?php print $_GET['id']; ?>,'bill2')" href="#">
									<span style="text-decoration:none; font-family:Arial; color:navy;">
										<img src="images/cancel.png" alt="icon" /><br />Cancel Bill
									</span></a>
							</div>
						<?php } ?>
