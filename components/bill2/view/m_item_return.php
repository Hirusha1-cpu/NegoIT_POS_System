										...
										<table align="center" bgcolor="#E5E5E5" style="border-radius: 15px; padding:25px;">
											...
											<?php } else { ?>
												<tr>
													...
													<td colspan="2">
														<input type="text" name="code" id="tags1" value="<?php if ($unic_item_code != '')
															print $unic_item_code; ?>" />
													</td>
													<td width="50px"></td>
												</tr>
												...
												<tr>
													...
													<td colspan="2">
														<input type="text" name="rplace_code" id="tags6" value="<?php if ($unic_item_code != '')
															print $unic_item_code; ?>" />
													</td>
													<td width="50px"></td>
												</tr>
												...
												<tr>
													<td colspan="2" align="right">
														...
														<td colspan="3" align="left">
															<div id="finalize">
																<input type="Button" value="Finalize" style="width:100px; height:70px"
																	onclick="finalize()" />
															</div>
														<?php } ?>
														<br /><br />
