...
<table class="report-container">
    <tbody class="report-content">
		...
		<table width="100%" border="0" style="font-family:Calibri; font-size:11pt;">
			...
			<tr>
				<td>
					<?php print '<a href="../../../../index.php?components=bill2&action=cust_details&id='.$cu_id.'&action2=finish_bill&id2='.$_GET['id'].'" target="_parent" title="Customer: '.$cu_details.'" style="text-decoration:none; color:black" >Customer: '.ucfirst($bi_cust0).'</a>,<br />Address: '.wordwrap($bi_cust0_address, 50, "<br>").'<br />TRN No: '.$cust_tax_no; ?>
				</td>
