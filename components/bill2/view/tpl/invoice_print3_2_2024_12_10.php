	...
	<tr>
		<td>
			<table style="font-family:Calibri; font-size:12pt;" cellspacing="0">
				<tr>
					<td colspan="2"><span style="font-family:'Arial Black'; font-size:20pt"><?php print $bill_title; ?></span><span
							style="font-size:12pt; font-family:Calibri"><?php if($bi_type==2 || $bi_type==5) print '<br /><strong>Service Invoice</strong>'; else if($bi_type==3) print '<br /><strong>Repair Invoice</strong>'; ?></span>
					</td>
				</tr>
				<tr>
					<td>Tel </td>
...
<table align="center" height="<?php print $page_height; ?>px" width="100%" border="1" cellspacing="0">
	<tr
		...
		<th>DESCRIPTION</th><?php if($dn=='no'){ if($sub_system==0){?><th width="80px">TAG<br />PRICE</th>
	...
	<?php
		for($i=0;$i<sizeof($bill_id);$i++){
			if($bi_return_odr[$i]==0){
				print '<tr style="font-size:10pt" height="20px">
					...
					if($dn=='no'){
					if($sub_system==0) print '<td style="border-bottom:0; border-top:0;" align="right">
		...
		print '<tr style="font-size:10pt">
			...
			<td style="border-bottom:0; border-top:0;"></td>';
			if($dn=='no'){
			if($sub_system==0) print '<td style="border-bottom:0; border-top:0;"></td>
