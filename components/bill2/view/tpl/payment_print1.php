	...
	<tr height="350px">
		<td style="vertical-align:top">
			...
			<?php if(isCustomerTotalOutstandingShowInBill(2)){ ?>
				<table align="center" width="350px" border="1" cellspacing="0">
					<tr style="font-family:Arial; font-size:10pt;" id="total_outstanding_row">
						<td height="30px" style="padding-left:15px">Due Payment :</td>
						<td align="left" style="padding-left:15px">
							<strong><?php print $currency; ?> <span id="credit_balance_span"><?php print number_format($credit_balance, $decimal); ?></span></strong>
						</td>
					</tr>
				</table>
			<?php } ?>
