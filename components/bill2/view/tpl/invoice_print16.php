...
&nbsp;Tel: <?php print $tm_tel; ?>
	...
	<?php
	print '<a style="color:navy; text-decoration:none;" href="../../../../index.php?components=bill2&action=cust_details&id='.$cu_id.'&action2=finish_bill&id2='.$_GET['id'].'" target="_parent" title="'.$cu_details.'" style="text-decoration:none" >'.ucwords($bi_cust0).'</a>';
	print '<br />';
...
?>
	...
	<tr style="font-size:8pt;"><td>
		...
		<?php }else{ ?>
		<table align="center" width="100%"  style="font-size:9pt">
			<tr><td width="65px">Order Packed By : </td><td>  <?php print ucfirst($bm_packed_by).'&nbsp;&nbsp;&nbsp;&nbsp;: '.$up_mobile; ?></td><td></td><td width="80px">Customer : </td><td width="130px"><?php print '<a href="../../../../index.php?components=bill2&action=cust_details&id='.$cu_id.'&action2=finish_bill&id2='.$_GET['id'].'" target="_parent" title="'.$cu_details.'" >'.ucfirst($bi_cust0).'</a>'; ?><td></tr>
