		...
		<tr>
			...
			<td width="454px" >
				<table border="1" cellspacing="0" style="font-size:8pt; font-family:Verdana;" height="395px" width="100%">
					<tr height="11px" style="font-weight:bold">
						<td width="23px" align="center">LINE</td>
						<td width="188px" align="center">DESCRIPTION</td>
						<td width="22px" align="center">QTY</td>
						<td width="30px" align="center">TAG PRICE</td>
						<td width="32px" align="center">DIS<br />(Rs)</td>
						<td width="20px" align="center">DIS<br />(%)</td>
						<td width="30px" align="center">Dis. PRICE</td>
						<td width="48px" align="center">TOTAL</td>
					</tr>
						<?php
					...
					<tr height="40px">
						<td colspan="7" valign="top">
							<table cellspacing="0" style="font-size:9pt; font-weight:bold;" width="100%" border="0" >
								...
								<tr><td></td><td align="right">Payment: Card</td></tr>
								<tr><td></td><td align="right">Payment Processing Fee</td></tr>
								<tr><td></td><td align="right">Payment: Bank</td></tr>
								<tr><td><?php print $chequedate.'<span style="padding-right:10px">'.$chq0_fullNo.'</span>'; ?></td><td align="right">Payment: Cheque</td></tr>
						...
						<td valign="top">
							...
							<?php 
								...
								?>
								<tr><td align="right"><?php print number_format($total1); ?></td></tr>
								<tr><td align="right"><?php print number_format($cash_amount); ?></td></tr>
								<tr><td align="right"><?php print number_format($card_amount); ?></td></tr>
								<tr><td align="right"><?php print $pay_pro_fee; ?>%</td></tr>
								<tr><td align="right"><?php print number_format($bank_amount); ?></td></tr>
								<tr><td align="right"><?php print number_format($chque_amount); ?></td></tr>
								<tr><td align="right"><?php print number_format($total-$cash_amount-$card_amount-$chque_amount-$bank_amount); ?></td></tr>
							</table>
						</td>
					</tr>
				</table>
				...
				<table border="0" style="font-size:9pt; font-family:Verdana">
					<tr>
						<td width="10px"></td>
						<td>
							<strong>CUSTOMER:</strong> <?php print substr(ucfirst($bi_cust0),0,20).'<br />'.str_replace('Mobile',"<br />Mobile",$cu_details); ?>
						</td>
						<td width="80px"></td>
						<td align="right">
