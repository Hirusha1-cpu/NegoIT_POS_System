...
<div id="print_top"></div>
		  ...
		  <tr><td><span style="font-family:'Arial'; font-size:20pt">PAYMENT</span></td></tr>
		  <tr><td style="font-size:8pt"><?php
		  	if($tm_company!='OMS'){
...
<hr />
			...
			?>
			<tr><td height="30px">AMOUNT</td><td width="5px">:</td><td align="right" style="padding-right:15px"><strong><?php print 'Rs. '.number_format($amount); ?></strong></td></tr>
			<tr><td height="30px">Payment Type</td><td width="5px">:</td><td align="right" style="padding-right:15px"><?php print $payment_type_n; ?></td></tr>
			<?php if($payment_type==2){ ?>
			<tr><td colspan="3"><br></td></tr>
			<tr><td colspan="3"><strong>Chque Details</strong></td></tr>
			...
			<tr><td height="30px">Chque No</td><td width="5px">:</td><td align="right" style="padding-right:15px"><?php print $chque_no; ?></td></tr>
			<tr><td height="30px">Chque Date</td><td width="5px">:</td><td align="right" style="padding-right:15px"><?php print $chque_date; ?></td></tr>
			<?php }else if($payment_type==3){ ?>
			<tr><td height="30px">Bank</td><td width="5px">:</td><td align="right" style="padding-right:15px"><?php print $bank_trans; ?></td></tr>
			<?php } ?>
			</table>
