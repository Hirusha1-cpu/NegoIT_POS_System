	...
	<tr><td colspan="4" align="center"><table width="100%" >
		...
		<input type="button" value="Back" style="width:100px; height:30px" onclick="window.location = 'index.php?components=bill2&action=<?php print $_GET['action2']; ?>&id=<?php print $_GET['id2']; ?>'" />
