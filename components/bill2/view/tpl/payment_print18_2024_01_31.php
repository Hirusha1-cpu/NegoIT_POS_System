			...
			<table align="center" width="350px" border="1" cellspacing="0" >
				...
				<tr style="font-family:Arial; font-size:10pt">
					...
					<td align="left" style="padding-left:15px">
						<strong><?php print $currency.'. '.number_format($amount, $decimal); ?></strong>
					</td>
				</tr>
				<?php if(isCustomerTotalOutstandingShowInBill(2)){ ?>
					<tr style="font-family:Arial; font-size:10pt;" id="total_outstanding_row">
						<td height="30px" style="padding-left:15px">Total Outstanding Amount</td>
						<td align="left" style="padding-left:15px">
...
<table align="center" width="100%" border="1" cellspacing="0" >
	<tr style="font-size:8pt;">
		<td>
			...
			<br/>
			<table align="center">
				<tr><td style="font-family:Arial; font-size:9pt">Issued By</td><td>  : <?php print ucfirst($salesman); ?></td><td width="45px"></td><td style="font-family:Arial; font-size:9pt">Paid By</td><td>  : <?php print ucfirst($cust_name); ?><td></tr>
