	...
	if ($dn == 'no') {
		...
		if (($tax != '') && ($tax != 0)) {
			print '<tr style="font-family:Calibri; font-size:11pt; font-weight:900; color:white; background-color:black; -webkit-print-color-adjust: exact;">
				...
				<td align="right" style="padding: 0 5px;">' . number_format($tax_added_value, $decimal) . '</td>
			</tr>';
		}

		// total
		$total = $sub_total - $tax_added_value;
		print '<tr style="font-family:Calibri; font-size:11pt; font-weight:900; color:white; background-color:black; -webkit-print-color-adjust: exact;">
			<td colspan="' . $colspan . '" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:1; border-top:0; color:white;">
				Total Excluding VAT
			</td>
		...
		print '<tr
				...
				<td align="right" style="padding: 0 5px;">' . number_format(($sub_total - $cash_amount - $bank_amount - $chque_amount - $quotation_advance_payment), $decimal) . '</td>
			</tr>';
	}
	?>
</table>
