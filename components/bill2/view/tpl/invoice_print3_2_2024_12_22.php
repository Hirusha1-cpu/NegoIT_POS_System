...
<table width="100%" border="0" style="font-family:Calibri; font-size:12pt;">
	<tr>
		<td>
			<table style="font-family:Calibri; font-size:12pt;" cellspacing="0">
				<tr>
					<td colspan="2">
						<?php if($systemid == 13){ ?>
							<span style="font-family:'Arial Black'; font-size:12pt; text-transform: uppercase;"><?php print $tm_company; ?></span>
							<br>
							<span style="font-family:'Arial'; font-size:11pt; font-weight:900;"><?php print $bill_title; ?></span>
						<?php }else{ ?>
							<span style="font-family:'Arial Black'; font-size:20pt"><?php print $bill_title; ?></span>
						<?php } ?>
						<span style="font-size:12pt; font-family:Calibri"><?php if($bi_type==2 || $bi_type==5) print '<br /><strong>Service Invoice</strong>'; else if($bi_type==3) print '<br /><strong>Repair Invoice</strong>'; ?></span>
					</td>
				</tr>
				<tr>
					<td>Tel </td>
		...
		<td></td>
		<td align="right">
			<img src="../../../../images/cplogo<?php print $logo; ?>.png" height="<?php if($logo === '13_3') echo "150px;"; else if($systemid == 13) echo "30px;"; else echo "33px;"; ?>" />
		</td>
	</tr>
	<tr>
		<td>
			...
			<?php print '<br> VAT Reg. No. ' . $cust_tax_no; ?>
		</td>
...
<table align="center" height="<?php print $page_height; ?>px" width="100%" border="1" cellspacing="0">
	<tr
		...
		<th>DESCRIPTION</th><?php if($dn=='no'){ if($sub_system==0 && $systemid != 13){?><th width="80px">TAG<br />PRICE</th>
		<th width="80px">DISCOUNT%</th>
		<th width="80px">Dis.<br />PRICE</th><?php }else{ ?><th width="80px">UNIT PRICE</th><?php } ?><th width="60px">
			TOTAL</th><?php }else{ ?><th width="200px">REMARKS</th><?php } ?>
	</tr>
	<?php
		for($i=0;$i<sizeof($bill_id);$i++){
			if($bi_return_odr[$i]==0){
				print '<tr style="font-size:10pt" height="20px">
					...
					if($dn=='no'){
					if($sub_system==0 && $systemid != 13) print '<td style="border-bottom:0; border-top:0;" align="right">
						'.number_format(($bi_price[$i]+$bi_discount[$i]),$decimal).'&nbsp;&nbsp;</td>
					<td style="border-bottom:0; border-top:0;" align="right">
						'.number_format(($bi_discount[$i]/($bi_price[$i]+$bi_discount[$i])*100),$decimal).'%&nbsp;&nbsp;</td>';
					print '<td style="border-bottom:0; border-top:0;" align="right">'.number_format($bi_price[$i],$decimal).'&nbsp;&nbsp;
					</td>
		...
		print '<tr style="font-size:10pt">
			...
			<td style="border-bottom:0; border-top:0;"></td>';
			if($dn=='no'){
			if($sub_system==0 && $systemid != 13) print '<td style="border-bottom:0; border-top:0;"></td>
		...
		if($dn=='no'){
			if($sub_system==0 && $systemid != 13) $colspan=5; else $colspan=3;
			// subtotal
			print '<tr style="font-family:Calibri; font-size:11pt; font-weight:900; color:white; background-color:black; -webkit-print-color-adjust: exact;"><td colspan="'.$colspan.'" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:1; border-top:0; color:white;">Subtotal Amount</td><td align="right" style="padding: 0 5px;">'.number_format($sub_total,$decimal).'</td></tr>';

			if(($tax != '') && ($tax != 0)) {
				// vat
				print '<tr style="font-family:Calibri; font-size:11pt; font-weight:900; color:white; background-color:black; -webkit-print-color-adjust: exact;"><td colspan="'.$colspan.'" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:1; border-top:0; color:white;">Value Added Tax '.$tax.'%</td><td align="right">'.number_format($tax_added_value,$decimal).'&nbsp;&nbsp;</td></tr>';
			}
			// total
			print '<tr style="font-family:Calibri; font-size:11pt; font-weight:900; color:white; background-color:black; -webkit-print-color-adjust: exact;"><td colspan="'.$colspan.'" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:1; border-top:0; color:white;">Total Amount</td><td align="right" style="padding: 0 5px;">'.number_format($total,$decimal).'</td></tr>';
			// print '<tr
			...
			// 	<td align="right">'.number_format($total,$decimal).'&nbsp;&nbsp;</td>
			// </tr>';
			print '<tr
				style="font-family:Calibri; font-size:11pt; font-weight:900; color:white; background-color:black; -webkit-print-color-adjust: exact;">
				<td colspan="'.$colspan.'" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:1; border-top:0; color:white;">'.$advance.' Payment:
					Cash</td>
				<td align="right" style="padding: 0 5px;">'.number_format($cash_amount,$decimal).'</td>
			</tr>';
			print '<tr
				style="font-family:Calibri; font-size:11pt; font-weight:900; color:white; background-color:black; -webkit-print-color-adjust: exact;">
				<td colspan="'.$colspan.'" align="right" height="20px"
					...
					Transfer</td>
				<td align="right" style="padding: 0 5px;">'.number_format($bank_amount,$decimal).'</td>
			</tr>';
			print '<tr
				style="font-family:Calibri; font-size:11pt; font-weight:900; color:white; background-color:black; -webkit-print-color-adjust: exact;">
				<td colspan="'.$colspan.'" align="right" height="20px"
				...
				<td align="right" style="padding: 0 5px;">'.number_format($chque_amount,$decimal).'</td>
			</tr>';
			print '<tr
				style="font-family:Calibri; font-size:11pt; font-weight:900; color:white; background-color:black; -webkit-print-color-adjust: exact;">
				<td colspan="'.$colspan.'" align="right" height="20px"
				...
				<td align="right" style="padding: 0 5px;">'.number_format(($total-$cash_amount-$chque_amount),$decimal).'</td>
			</tr>';
		}
	?>
</table>
