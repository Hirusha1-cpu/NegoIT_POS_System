	...
	if ($dn == 'no') {
		...
		if ($systemid != 13) {
			...
			if ($bm_discount > 0) {
				...
				style="font-family:Calibri; font-size:11pt; font-weight:900; color:white; background-color:black; -webkit-print-color-adjust: exact;">
				<td colspan="' . $colspan . '" align="right" height="20px"
					style="padding-right:5px; border-right:1; border-bottom:1;">Payable Amount</td>
			...
			print '<tr
				...
				<td align="right">' . number_format(($cash_amount + $chque_amount + $bank_amount + $quotation_advance_payment), 2) . '&nbsp;&nbsp;</td>
			</tr>';
			...
			print '<tr
				...
				<td align="right">' . number_format(($sub_total - $cash_amount - $bank_amount - $chque_amount - $quotation_advance_payment), 2) . '&nbsp;&nbsp;</td>
			</tr>';
		}
	}
	?>
