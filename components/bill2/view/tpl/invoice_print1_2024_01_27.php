...
<?php
	...
	if($dn=='no'){
		...
		print '<tr style="font-size:10pt; font-weight:900;"><td colspan="4" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:0; border-top:0;">Total Outstanding Amount</td><td align="right">'.number_format(($credit_balance),$decimal).'&nbsp;&nbsp;</td></tr>';
	}
?>
	</table>
