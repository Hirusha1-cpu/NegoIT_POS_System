...
<table width="100%">
	<tr>
		...
		<td></td>
		<td align="right">
			<span style="font-family:'Arial Black'; font-size:20pt">PAYMENT</span><br />
		...
		<td style="vertical-align:top">
			...
			<table align="center" width="350px" border="1" cellspacing="0" >
				...
				<tr style="font-family:Arial; font-size:10pt">
					...
					<td align="left" style="padding-left:15px"><strong><?php print 'Rs. '.number_format($amount); ?></strong></td>
				</tr>
				<tr style="font-family:Arial; font-size:10pt">
					<td height="30px" style="padding-left:15px">Payment : <?php print $payment_type_n; ?></td>
					<td align="left" style="padding-left:15px"><strong><?php print 'Rs. '.number_format($credit_balance); ?></strong></td>
				</tr>
			</table>
			<br />
