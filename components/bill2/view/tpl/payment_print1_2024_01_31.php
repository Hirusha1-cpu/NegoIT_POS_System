...
<table width="100%">
	<tr>
		...
		<td></td>
		<td align="right">
			<span style="font-family:'Arial Black'; font-size:20pt"><?php print $title; ?></span><br />
	...
	<tr>
		...
		<td align="right">
			...
			<span  style="font-family:Arial; font-size:11pt">DATE: <?php print $payment_date; ?><br /><br /></span>
		</td>
	</tr>
</table>
...
<table align="center" width="450px" cellspacing="0" border="0">
	<tr height="350px">
		<td style="vertical-align:top">
			...
			<table align="center" width="350px" border="1" cellspacing="0">
				...
				<tr style="font-family:Arial; font-size:10pt">
					...
					<td align="left" style="padding-left:15px">
						<strong><?php print $currency.' '.number_format($amount, $decimal); ?></strong></td>
				</tr>
				<!-- <tr style="font-family:Arial; font-size:10pt">
					<td height="30px" style="padding-left:15px">Payment : <?php print $payment_type_n; ?></td>
					<td align="left" style="padding-left:15px">
						<strong><?php print 'Rs. '.number_format($credit_balance); ?></strong>
					</td>
				</tr> -->
				<?php if(($systemid != 13) && (isCustomerTotalOutstandingShowInBill(2))){ ?>
					<tr style="font-family:Arial; font-size:10pt">
						<td height="30px" style="padding-left:15px">Due Payment :</td>
						<td align="left" style="padding-left:15px">
							<strong><?php print $currency.' '.number_format($credit_balance, $decimal); ?></strong>
						</td>
					</tr>
				<?php } ?>
			</table>
			...
			<table align="center" width="350px" border="1" cellspacing="0">
				<tr style="font-family:Arial; font-size:10pt">
					<td colspan="2"><strong>Cheque Details</strong></td>
				</tr>
				<tr style="font-family:Arial; font-size:10pt">
					<td width="150px" height="30px" style="padding-left:15px">Bank</td>
					<td align="right" style="padding-right:15px"><?php print $chque_bank; ?></td>
				</tr>
				<tr style="font-family:Arial; font-size:10pt">
					<td height="30px" style="padding-left:15px">Branch</td>
					<td align="right" style="padding-right:15px"><?php print $chque_branch; ?></td>
				</tr>
				<tr style="font-family:Arial; font-size:10pt">
					<td height="30px" style="padding-left:15px">Cheque No</td>
					<td align="right" style="padding-right:15px"><strong><?php print $chque_no; ?></strong></td>
				</tr>
				<tr style="font-family:Arial; font-size:10pt">
					<td height="30px" style="padding-left:15px">Cheque Date</td>
					<td align="right" style="padding-right:15px"><?php print $chque_date; ?></td>
				</tr>
			</table>
		...
		<td>
			...
			<table align="center">
				<tr>
					...
					<td> : <?php print ucfirst($salesman); ?></td>
					<td width="45px"></td>
					<td style="font-family:Arial; font-size:9pt">Paid By</td>
					<td> : <?php print ucfirst($cust_name); ?>
					<td>
				</tr>
				<tr>
