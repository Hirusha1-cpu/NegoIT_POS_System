...
<tr><td>Shop Action</td><td>: <?php print $shop_action; ?></td></tr>
	...
	<tr style="font-size:10pt" height="400px"><td valign="top" style="padding-left:30px"><br /><br />
	<table>
	<?php
	print '<tr><td><strong>Issue</strong></td><td> : &nbsp;<strong><i>'.$war_issue.'</i></strong></td></tr>';
