		...
		<td>
			...
			<table align="center" width="180px" border="0" cellspacing="0" style="font-size:8pt; font-family:Arial, Helvetica, sans-serif" >
				...
				<tr>
					...
					<td width="5px">:</td>
					<td align="right" style="padding-right:15px"><strong><?php print $currency.' '.number_format($amount); ?></strong></td>
				</tr>
				<tr>
				...
				<?php if(isCustomerTotalOutstandingShowInBill(2)){ ?>
					<tr style="" id="total_outstanding_row">
						...
						<td width="5px">:</td>
						<td align="right" style="padding-right:15px"><?php print $currency; ?> <span id="credit_balance_span"><?php print number_format($credit_balance); ?></span></td>
					</tr>
				<?php } ?>
