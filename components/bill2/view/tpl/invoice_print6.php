	...
	<table border="0" cellspacing="0" ><tr><td>
		...
		<?php
			 ...
			 if($dn=='no'){
				...
				print '<tr style="font-size:10pt;"><td colspan="3" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:0; border-top:0;">'.$advance.' Payment: Bank Transfer</td><td align="right">'.number_format($bank_amount).'&nbsp;&nbsp;</td></tr>';	
		...
		<?php  if($dn=='no'){ ?>
			...
			<tr><td colspan="2"><?php print '<a href="../../../../index.php?components=bill2&action=cust_details&id='.$cu_id.'&action2=finish_bill&id2='.$_GET['id'].'" target="_parent" title="'.$cu_details.'" >'.ucfirst($bi_cust).'</a>'; ?></td></tr>
