...
<tr><td valign="top" align="center">
	...
	<tr><td style="font-size:12pt;"><form id="searchinv" action="index.php?components=bill2&action=search_bill&s=<?php print $bill_salesman; ?>&cust_odr=<?php print $_GET['cust_odr']; ?>" method="post"><input type="text" style="width:100px" name="search1" id="search1" placeholder="Invoice Number" /><input type="Submit" value="Search" /></form></td></tr>
	<tr><td style="font-size:12pt;"><form action="index.php"><input type="hidden" name="components" value="bill2" /><input type="hidden" name="action" value="home" /><input type="hidden" name="s" value="<?php print $bill_salesman; ?>" /><input type="hidden" name="cust_odr" value="<?php print $_GET['cust_odr']; ?>" /><input type="text" style="width:100px" name="searchcustid" placeholder="Customer ID" value="<?php if(isset($_GET['searchcustid']))print $_GET['searchcustid']; ?>" onclick="this.value=''" /><input type="Submit" value="Search" /></form></td></tr>
	<tr><td style="font-size:12pt;"><form action="index.php"><input type="hidden" name="components" value="bill2" /><input type="hidden" name="action" value="home" /><input type="hidden" name="s" value="<?php print $bill_salesman; ?>" /><input type="hidden" name="cust_odr" value="<?php print $_GET['cust_odr']; ?>" /><input type="text" style="width:100px" name="searchcustname" placeholder="Customer Name" value="<?php if(isset($_GET['searchcustname']))print $_GET['searchcustname']; ?>" onclick="this.value=''" /><input type="Submit" value="Search" /></form></td></tr>
	<tr><td style="font-size:12pt;"><form action="index.php"><input type="hidden" name="components" value="bill2" /><input type="hidden" name="action" value="home" /><input type="hidden" name="s" value="<?php print $bill_salesman; ?>" /><input type="hidden" name="cust_odr" value="<?php print $_GET['cust_odr']; ?>" /><input type="text" style="width:100px" name="searchmob" placeholder="Mobile Number" value="<?php if(isset($_GET['searchmob']))print $_GET['searchmob']; ?>" onclick="this.value=''" /><input type="Submit" value="Search" /></form></td></tr>
	<tr><td style="font-size:12pt;"><form action="index.php"><input type="hidden" name="components" value="bill2" /><input type="hidden" name="action" value="home" /><input type="hidden" name="s" value="<?php print $bill_salesman; ?>" /><input type="hidden" name="cust_odr" value="<?php print $_GET['cust_odr']; ?>" /><input type="text" style="width:100px" name="searchunic" placeholder="Unique ID" value="<?php if(isset($_GET['searchunic']))print $_GET['searchunic']; ?>" onclick="this.value=''" /><input type="Submit" value="Search" /></form></td></tr>
	</table>
	<br />
	</div>
	<?php
