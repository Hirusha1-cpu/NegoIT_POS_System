	...
	function addToBill(){
		...
		if($itm_unic=='1'){
			...
			for($i=0;$i<$items.length;$i++){
				...
				if(($last_price!='NA')&&($last_price>$fprice)){ $out=false; $msg='<span style="color:red; font-weight:bold; font-size:12pt;">Price Under Value</span>'; }
			}
		}else{
						...
						<?php if($current_district!=''){ ?>
							<table align="center" bgcolor="<?php print $main_tale_color; ?>" border="0" class="bill-table">
								...
								<tr>
									...
									<td>Salesman</td>
									<td colspan="2">
										<?php if(($systemid==4)||($systemid==13)||($systemid==15)||($systemid==20)){ ?>
									...
									<td>
										<table border="0">
											<tr>
												<td>Unit Discount</td>
												<td>
													<div id="discount_div" onclick="changeDiscount()" style="color:blue; cursor:pointer;"><?php if($discount=='price') print 'Rs'; else print '%'; ?></div>
												</td>
											</tr>
										</table>
									</td>
		...
		<div class="w3-col">
			<div id="portrait">
				...
				<table align="center" width="100%" class="table-balance">
					...
					<tr>
						<td colspan="3" bgcolor="#E5E5E5" align="right" style="padding-right:20px;" >Chque to be Credited</td>
