...
<div id="tmp_backbtn" style="display:none">
	<input type="button" value="Back" style="width:100px; font-size:medium" onclick="window.location = 'index.php?components=bill2&action=bill_item&cust_odr=<?php print $_GET['cust_odr']; ?>&bill_no=<?php print $_GET['bill_no']; ?>'" />
</div>
					...
					<td style="vertical-align:top;">
						<table align="center" width="100%" class="table-balance">
							...
							<tr>
								...
								<td align="right" class="sidetable2">T<?php print str_pad($_GET['bill_no'], 7, "0", STR_PAD_LEFT); ?>
  		...
  		<div id="portrait">
	 	 	<table align="center" bgcolor="<?php print $main_tale_color; ?>" width="100%" class="table-bill">
				...
				<tr>
					...
					<td width="20px"></td>
					<td>
						<input type="text" name="amount_cash" id="amount_cash" value="0" style="width:100px; text-align:right; padding-right:10px" onclick="this.value=''" />
						<input type="button" value="Add" style="width:47px; height:33px; color:navy" onclick="setBillPayment()" /></td>
					</tr>
				<tr>
				...
				<tr>
					...
					<td>
						...
						<br />
						<input type="text" placeholder="4000-0566-5566-5556"  name="card_no" id="card_no" style="margin-bottom: 2px;"/><br />
						<input type="text" name="amount_card" id="amount_card" value="0" style="width:100px; text-align:right; display:block; float:left; padding-right:10px; margin: 3px 3px 0 0;" onclick="this.value=''" />
						<input type="button" value="Add" style="width:47px; height:33px; color:navy" onclick="setBillPayment()" />
	  				</td>
				</tr>
				<tr>
					<td height="5px" colspan="3"></td>
				...
				<tr>
					...
					<td>
						...
						<br />
						<input type="text" name="comment" id="comment" style="width:100px;" placeholder="References" /><br />
						<?php if($systemid==15){ ?>
							<table><tr><td><input type="password" id="auth_code" style="width:80px" placeholder="Auth Code" /><input type="button" onclick="bankPayValidate()" value="validate" /></td><td><div id="div_bk_validate"></div></td></tr></table>
						<?php } ?>
						<input type="text" name="amount_bank" id="amount_bank" value="0" style="width:100px; text-align:right; padding-right:10px" onclick="this.value=''" />
						<input type="button" value="Add" style="width:47px; height:33px; color:navy" onclick="setBillPayment()" />
	  				</td>
				</tr>
				<tr><td height="5px" colspan="3"></td></tr>
				<tr><td height="2px" colspan="3" bgcolor="#FAFAFA"></td></tr>
				<tr><td height="5px" colspan="3"></td></tr>
				<!-- Cheque -->
				<tr>
					<td>&nbsp;&nbsp;Cheque</td>
					<td width="20px"></td>
					<td>
						<input type="text" name="amount_chque" id="amount_chque" value="0" style="width:100px; text-align:right; padding-right:10px" onclick="this.value=''" />  Rs
						<br>
						<input type="number" name="chque_no" id="chque_no" value="" style=" width:80px" placeholder="Code" />
						<input type="number" name="chque_bank" id="chque_bank" value="" style=" width:55px" placeholder="Bank" />
						<input type="number" name="chque_branch" id="chque_branch" value="" onfocus="validateBank()" style=" width:45px" placeholder="Brn" />
						<div id="bk_name" align="center"></div>
						<input type="date" name="chque_date" id="chque_date" value=""  width:120px" placeholder="Cheque Date" />
						<input type="button" value="Add" style="width:47px; height:33px; color:navy" onclick="setBillPayment()" />
	  				</td>
				</tr>
				<tr><td height="5px" colspan="3"></td></tr>
				...
				<tr bgcolor="#E2DDCC">
					...
					<td></td>
					<td>
						<input type="text" name="amount_credit" id="amount_credit" value="0" style="width:100px; text-align:right; padding-right:10px" onclick="this.value=''" />
						<input type="button" value="Add" style="width:47px; height:33px; color:navy" onclick="setBillPayment()" />
					</td>
				</tr>
				<!-- Down Payment -->
					...
					<td height="8px" colspan="3">
						...
						<?php if($bm_hire_purchase){ ?>
							<table align="center" bgcolor="#DDDDEE" width="100%" >
								<tr>
									<td width="30px"></td>
									<td colspan="2" style="color:navy; font-weight:bold; height:40px; width:230px">Future Down Payment</td>
									<td width="30px"></td>
								</tr>
								<tr>
									<td></td>
									<td colspan="2">
										<input type="text" name="fu_down_pay" id="fu_down_pay" value="0" style="width:80px; text-align:right" onclick="this.value=''" />
				...
				<tr>
					<td align="center" colspan="3">
						<div id="finalize">
							<input type="button" value="Create Invoice & Finalize" style="width:95%; height:60px; background-color:maroon; color:white" onclick="finalyze()" />
						</div>
					</td>
				</tr>
