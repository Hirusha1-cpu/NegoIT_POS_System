        ...
        <div class="w3-col">
            ...
            <div class="wrap">
                <table align="center">
                    <tr>
                        <td valign="top">
                            <form name="payForm" enctype="multipart/form-data" action="index.php?components=bill2&action=add_cash_payment_deposit"
                                onsubmit="return validateAndConfirmPayment()" method="post">
                                <table align="center" bgcolor="#E5E5E5"
                                    style="border-radius: 15px; padding: 20px; border-spacing: 0 10px;">
                                    <tr>
                                        <td colspan="5">
                                            <?php
                                            if (isset($_REQUEST['message'])) {
                                                $color = ($_REQUEST['re'] == 'success') ? 'green' : '#DD3333';
                                                echo '<script type="text/javascript">document.getElementById("notifications").innerHTML=' .
                                                    "'" . '<span style="color:' . $color . '; font-weight:bold;font-size:12pt;">' .
                                                    $_REQUEST['message'] . '</span>' . "'" . ';</script>';
                                            }
                                            ?>
                                            <br />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <div class="radio-group">
                                                <input type="radio" id="cash_radio" name="payment_type" value="cash">
                                                <label for="cash_radio">Cash</label>
                                                <input type="radio" id="cheque_radio" name="payment_type"
                                                    value="cheque">
                                                <label for="cheque_radio">Cheque</label>
                                            </div>
                                        </td>
                                        <td width="50px"></td>
                                    </tr>
                ...
                <div style="width: 100%; margin: 5px auto; font-size: 14px; text-align: center;">
                    <p><i>Note: The total amount to be settled is calculated by subtracting the total amount deposited
                            or handed over to the company (excluding rejected or canceled payments) from the total
                            payment you have collected.</i></p>
                </div>
            </div>
        </div>
    </div>
