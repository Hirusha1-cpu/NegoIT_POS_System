		...
		<tr>
			<td valign="top">
				<?php if($bm_type==3 && $bm_status==4){ ?>
					<table width="100%" bgcolor="#EEEEEE">
						<tr>
							...
							<td>
								...
								<input type="text" id="job_total" style="width:60px; text-align:right; padding-right:10px" value="<?php print $main_total; ?>"/>
					...
					<form action="index.php?components=bill2&action=add_payment" onsubmit="return jobPayment()" method="post" >
						...
						<table align="center" bgcolor="#EEEEEE" style="font-family:Calibri; font-size:10pt">
							...
							<tr>
								<td></td><td style="font-size:12pt">Chque Date</td><td><input type="date" name="chque_date" id="chque_date" /></td><td><div style="font-size:12pt" id="av_qty" align="right"></div></td><td></td>
							</tr>
							<tr>
								<td></td><td style="font-size:12pt" height="20px"></td><td><div style="font-size:12pt" id="bk_name" align="right"></div></td><td><div style="font-size:12pt" id="av_qty" align="right"></div></td><td></td>
							</tr>
							<tr>
								<td></td>
							...
							<tr>
								...
								<td colspan="3" height="10px">
									<div id="addpayment">
										<input type="submit" value="Add Payment" style="width:100px; height:40px" /></div>
									</td>
								</tr>
							<tr>
				...
				<?php }else if($bm_type==3 && ($bm_status==3 || $bm_status==6)){ ?>
					<form action="index.php?components=bill2&action=set_delivered" method="post" >
						...
						<table align="center" bgcolor="#EEEEEE" style="font-family:Calibri; font-size:10pt">
							<tr>
								<td>
									<input type="submit" value="Mark as Delivered" style="width:150px; height:60px; background-color:maroon; color:white; font-weight:bold"/>
								</td>
							</tr>
						</table>
					</form>
				...
				<div id="details_div" style="display:none">
					<table align="center" style="font-size:11pt; font-family:Calibri" >
						...
						<tr>
							<td style="background-color:#467898; color:white;" class="shipmentTB4">Referred Inventory</td><td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print $main_refinv; ?>
							</td>
						</tr>
						<tr>
							<td style="background-color:#467898; color:white;" class="shipmentTB4">Billed District</td><td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print $main_district; ?>
							</td>
						</tr>
						...
						<?php if($hire_purchase){ ?>
							<tr>
								<td style="background-color:#467898; color:white;" class="shipmentTB4">Sub Type</td><td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4">Hire Purchase
								</td>
							</tr>
						<?php } ?>
						<tr>
								...
								<div id="div_smsresend">
									<table border="0" cellspacing="0">
										<tr>
											...
											<td align="right">
												<?php if($sms_resend!=0) print '<input type="button" value="Resend" style="height:20px; font-size:10pt" onclick="smsResend('."'$sms_resend'".')" />'; ?>
											</td>
										</tr>
									</table>
								</div>
						...
						<tr>
							...
							<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4">
								<?php print substr($main_billed_date,0,16); ?>
							</td>
						</tr>
						<?php if($hire_purchase){ ?>
							<tr>
								<td style="background-color:#467898; color:white;" class="shipmentTB4">HP Cal Start Date</td><td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print $hp_cal_start_date; ?>
								</td>
							</tr>
						<?php } ?>
						<tr>
							<td style="background-color:#467898; color:white;" class="shipmentTB4">Invoiced By</td>
							<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print ucfirst($main_billed_by); ?></td>
						</tr>
						<tr>
							<td style="background-color:#467898; color:white;" class="shipmentTB4">System User</td>
							<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print ucfirst($main_sys_user); ?></td>
						</tr>
						<tr>
							<td style="background-color:#467898; color:white;" class="shipmentTB4">Recovery Agent</td>
							<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print ucfirst($main_recovery_agent); ?></td>
						</tr>
						<tr>
							<td style="background-color:#467898; color:white;" class="shipmentTB4">Tracking ID</td>
							<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print $main_tracking_id; ?></td>
						</tr>
						<tr>
							<td style="background-color:#467898; color:white;" class="shipmentTB4">Bill Comment 1</td>
							<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print ucfirst($main_comment1); ?></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print ucfirst($main_comment_pay); ?></td>
						</tr>
						<tr>
							<td style="background-color:#467898; color:white;" class="shipmentTB4">Pay History</td>
							<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4">
								<input type="button" style="width:150px;" value="Invoice Pay Statement" onclick="window.open('index.php?components=bill2&action=show_invoice_pay&invoice_no=<?php print $_GET['id']; ?>')" />
							</td>
						</tr>
			...
			<td>
				<table align="center" style="font-size:11pt" >
					<tr>
						<td bgcolor="#467898" style="font-family:Calibri; color:white; padding-left:10px">Invoice Status : <span <?php if($status_out=='Deleted') print 'class="blink"'; ?> style="color:<?php print $status_color; ?>;"><strong><?php print $status_out; ?></strong></span>
						</td>
						<td></td>
					</tr>
					<tr>
						<td>
							<?php
								if($tm_template==1) print '<iframe id="invoice_iframe" width="'.$page_width.'px" height="'.$page_height.'px" src="components/bill2/view/tpl/invoice_print1.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
								else if($tm_template==2) print '<iframe id="invoice_iframe" width="260px" height="740px" src="components/bill2/view/tpl/invoice_print2.php?id='.$_GET['id'].'&dn='.$dn.'&bill_store='.$bill_store.'"></iframe>';
								else if($tm_template==3){
									print '<iframe id="invoice_iframe" width="'.$page_width.'px" height="'.$page_height.'px" src="components/bill2/view/tpl/invoice_print3.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
									if($systemid == 13){ // techneeds tax invoice
										print '<iframe id="invoice_iframe_3" width="'.$page_width.'px" height="'.$page_height.'px" src="components/bill2/view/tpl/invoice_print3_2.php?id='.$_GET['id'].'&dn='.$dn.'" style="display:none;"></iframe>';
									}
								}
								else if($tm_template==4) print '<iframe id="invoice_iframe" width="260px" height="740px" src="components/bill2/view/tpl/invoice_print4.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
								else if($tm_template==5) print '<iframe id="invoice_iframe" width="440px" height="550px" src="components/bill2/view/tpl/invoice_print5.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
								else if($tm_template==6) print '<iframe id="invoice_iframe" width="300px" height="740px" src="components/bill2/view/tpl/invoice_print6.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
								else if($tm_template==7) print '<iframe id="invoice_iframe" width="533px" height="775px" src="components/bill2/view/tpl/invoice_print7.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
								else if($tm_template==15) print '<iframe id="invoice_iframe" width="'.$page_width.'px" height="'.$page_height.'px" src="components/bill2/view/tpl/invoice_print15.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
								else if($tm_template==18) print '<iframe id="invoice_iframe" width="'.$page_width.'px" height="'.$page_height.'px" src="components/bill2/view/tpl/invoice_print18.php?id='.$_GET['id'].'&dn='.$dn.'"></iframe>';
							?>
						</td>
						<td valign="top" align="center">
							<?php if($systemid == 13){ ?>
								...
								<div class="checkbox-container prtbutton3">
									<input type="checkbox" id="show_tax_invoice">
							...
							<?php if(($bm_status!=0)&&($components=='bill2')){
								if($billpermission){ ?>
									<div class="prtbutton2">
										<a class="shortcut-button" style="text-decoration:none; font-family:Arial; color:navy;" onclick="deleteInvoice('<?php print $_GET['id']; ?>')" href="#" >
