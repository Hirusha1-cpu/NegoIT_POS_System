		...
		<div class="w3-col">
			...
			<table align="center" style="font-family:Calibri">
				<tr style="background-color:#467898;color :white;">
					<?php if(($systemid != 13 || ($systemid == 13 && $sub_system != 1))){ ?> <th width="30px" align="center"></th> <?php } ?>
					<th width="60px" align="center">#</th>
					<?php if(($systemid == 13 && $sub_system != 0)){ ?>
					...
					<?php if(($systemid == 13 && $sub_system != 0)){ ?> <th width="30px" align="center"></th> <?php } ?>
				</tr>
				<?php
					$row_number = 1;
