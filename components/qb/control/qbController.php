...
if (isQuickBooksActive(1)) {
      switch ($_REQUEST['action']) {
            ...
            case "employees":
                  include_once 'components/qb/modle/qbModule.php';
                  getEmployees();
                  include_once 'components/qb/view/employees.php';
                  break;
            ...
            case "dashboard":
                  include_once 'components/qb/modle/qbModule.php';
                  getDashboard();
                  getCustomerCounts(); // Get customer counts
                  getEmployeeCounts(); // Get employee counts
      ...
      print '<p><strong>QuickBooks is not active. Please activate it to use this feature.</strong></p>';
}
