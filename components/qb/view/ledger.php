...
<div>
    ...
    function displayReportHeader(
        ...
        global $sub_system_id, $sub_system_qb_id, $sub_system_name;
        ...
        // Sub System filter row
        echo '<tr>';
        echo '<th style="text-align: left; padding: 5px; background-color: #f2f2f2;">Sub System</th>';
        echo '<td style="padding: 5px;" colspan="3">';

        echo ' <select id="department" name="department" onchange="this.form.submit();">';
        echo '<option value="">--Select Sub System--</option>';
        if (isset($_COOKIE['top_manager']) && !empty($_COOKIE['top_manager'])) {
            ...
            if (isset($sub_system_id, $sub_system_qb_id, $sub_system_name)) {
            ...
            if (isset($sub_system_id, $sub_system_qb_id, $sub_system_name, $_COOKIE['sub_system'])) {
                foreach ($sub_system_id as $index => $id) {
                    if ($sub_system_id[$index] == $_COOKIE['sub_system']) {
                        $qbId = $sub_system_qb_id[$index];
                        echo '<option value="' . htmlspecialchars($qbId, ENT_QUOTES, 'UTF-8') . '" selected>' .
                            htmlspecialchars($sub_system_name[$index], ENT_QUOTES, 'UTF-8') .
                            '</option>';
