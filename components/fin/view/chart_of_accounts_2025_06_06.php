				...
				<tr>
					...
					<td valign="top">
						<table align="center" border="0" width="450px" style="font-family:Calibri">
							<tr bgcolor="#7e9099">
								<th align="left" style="padding-left:20px; color:white">#</th>
							...
							for ($i = 0; $i < sizeof($ac_id); $i++) {
								...
								if ($category_L1_tmp != $category_L1[$i]) {
									print '<tr bgcolor="#DDDDDD">
													<td></td>
													<td style="padding-left:20px; font-weight:bold">' . $category_L1[$i] . '</td>
													<td></td>
												</tr>';
								}
								...
								if (isQuickBooksActive(1)) {
									print '<span style="color:' . $color . '; text-decoration:none;">' . $ac_name[$i] . '</span>';
								} else {
									print '<a href="index.php?components=' . $components . '&action=acount_history&id=' . $ac_id[$i] . '" style="color:' . $color . '; text-decoration:none;">' . $ac_name[$i] . '</a>';
								}
								print '</td>
								<td align="center">' . $delete_ac . '</td>
								</tr>';
