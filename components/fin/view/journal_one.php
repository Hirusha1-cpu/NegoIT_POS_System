	...
	<table align="center" width="95%" style="font-family:Calibri">
		<tr>
			<td width="60%">
				<table>
					<tr>
						<td width="130px"><strong>Journal No</strong></td>
						<td style="color:navy"><strong><?php print str_pad($id, 7, "0", STR_PAD_LEFT); ?></strong></td>
					</tr>
					<tr>
						<td><strong>Date</strong></td>
						<td><?php print $journal_date; ?></td>
					</tr>
					<tr>
						<td><strong>Store</strong></td>
						<td><?php print ucfirst($store); ?></td>
					</tr>
					<tr>
						<td><strong>Ref No</strong></td>
						<td><?php print $ref_no; ?></td>
					</tr>
				</table>
			</td>
		</tr>
...
<div id="print" style="display:none;">
	<table align="center" style="font-family:Calibri; font-size:10pt;">
			...
			<td colspan="7">
				<table width="100%" border="1" cellspacing="0">
					...
					<?php for ($i = 0; $i < sizeof($ji_account); $i++) {
						if ($ji_cr_dr[$i] == 'cr') {
							$cr_amount = number_format(-$ji_amount[$i]);
							$dr_amount = '';
						} else {
							$cr_amount = '';
							$dr_amount = number_format($ji_amount[$i]);
						}
						if (($i % 2) == 0)
							$color = '#DDDDDD';
						else
		...
		<tr bgcolor="#EEEEEE">
			<td colspan="7" align="center"><br /><textarea placeholder="Memo" name="memo"
					style="width:90%; background-color:#FAFAFA;" readonly="readonly"><?php print $memo; ?></textarea>
			</td>
		</tr>
		<tr bgcolor="#EEEEEE" style="font-size:10pt">
			<td colspan="7" align="center">
				<table width="100%">
					<tr>
						<td><strong>Placed By: </strong><span
								style="color:navy"><?php print ucfirst($placed_by); ?></span></td>
						<td></td>
						<td align="right"><strong>Placed Date: </strong><span
								style="color:navy"><?php print $placed_date; ?></span></td>
					</tr>
				</table>
			</td>
		</tr>
...
<form action="#" method="post">
	<table align="center" border="0" cellspacing="0" style="font-size:12pt" bgcolor="#EEEEEE">
		<tr bgcolor="#DDDDDD">
			...
			<td align="center" style="color:navy"><strong><?php print str_pad($id, 7, "0", STR_PAD_LEFT); ?></strong>
			</td>
			<td colspan="7"></td>
			<td rowspan="2" bgcolor="#EEEEEE">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button"
					value="List Of Journals" style="width:150px; height:50px"
					onclick="window.location = 'index.php?components=fin&action=list_journal&year=<?php print date("Y", time()); ?>'" />
			</td>
		</tr>
		<tr>
			<td width="30px"></td>
			<td><strong>Date </strong></td>
			<td><input type="date" name="date" id="date" style="width:140px; background-color:#FAFAFA;"
					readonly="readonly" value="<?php print $journal_date; ?>" />
			</td>
			<td width="50px"></td>
			<td> <strong>Store </strong></td>
			<td><input type="text" style="width:140px; background-color:#FAFAFA;" readonly="readonly"
					value="<?php print ucfirst($store); ?>" /></td>
			<td width="50px"></td>
			<td>
				<strong>Ref No </strong>
			</td>
			<td><input type="text" name="ref" id="ref" style="width:140px; background-color:#FAFAFA;"
					readonly="readonly" value="<?php print $ref_no; ?>" /></td>
			<td width="30px"></td>
		</tr>
	</table>
	<br /><br />
				...
				<table>
					<tr>
						<td align="center">
							...
							<?php if ((!isQuickBooksActive(1)) || ($no_delete == 0)) { ?>
							</td>
							<td>
								<input type="Button" value="Delete" onclick="deleteJournal(<?php print $_GET['id']; ?>)"
									style="width:60px; height:50px; background-color:#CC0000; color:white" />
							<?php } ?>
						</td>
					</tr>
				</table>
