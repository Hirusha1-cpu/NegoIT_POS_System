...
switch ($_REQUEST['action']) {
   ...
   case "get_parent_accounts":
      include_once 'components/fin/modle/finModule.php';
      print getParentAccountsAjax();
      break;
   ...
   case "quotation":
      ...
      if (isset($_COOKIE['district'])) {
         ...
         if (isset($_GET['cust'])) {
            if (validateQuotNo())
               header('Location: index.php?components=fin&action=new_quot&cust_id=' . $_GET['cust'] . '&att=');
         }
      }
   ...
   case "quotation_sent_with_tax":
      ...
      if (qoUpdateSentWithTax())
         header('Location: index.php?components=' . $components . '&action=qo_finish&id=' . $quot_no . '&message=' . $message . '&re=success');
      else
         header('Location: index.php?components=' . $components . '&action=qo_finish&id=' . $quot_no . '&message=' . $message . '&re=fail');
      break;
