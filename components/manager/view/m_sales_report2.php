	...
	<div class="w3-row">
		...
		<div class="w3-col">
			...
			<form action="index.php" method="get" onsubmit="return validateDateRange()">
				...
				<input type="hidden" id="group_by" name="group_by" value="<?php echo isset($_GET['group_by']) ? $_GET['group_by'] : ''; ?>" />
				<table align="center" height="100%" style="font-size:10pt">
					...
					<tr bgcolor="#EEEEEE">
						<td width="70px"><strong>Category </strong></td>
						<td colspan="3">
					...
					<tr>
						<td width="70px"><strong>Salesman </strong></td>
						<td>
					...
					<tr>
						<td width="70px"><strong>Group By </strong></td>
						<td>
