		...
		for ($i = 0; $i < sizeof($chq0_id); $i++) {
			...
			if (($sm == '-all-') || ($sm == $chq0_salesman[$i])) {
				print '<tr height="25px">
					...
					<td style="padding-left:10px; padding-right:10px"><a style="text-decoration: none;" href="index.php?components=' . $menu_components . '&action=chque_postpone&chque_no=(' . $chq0_id[$i] . ')-' . $chq0_code[$i] . '&sm=' . $sm . '">' . $chq0_code[$i] . '</a></td>
