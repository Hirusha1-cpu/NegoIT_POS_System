...
<tr><td valign="top" align="center">
	<div style="background-color:#EEEEEF; border-radius: 15px; padding-left:10px; padding-right:10px">
		<table width="100%" cellspacing="0" border="0">
			...
			<td width="50px"></td><td style="font-size:12pt; padding-left:10px;" bgcolor="#DDDDFF"><strong>Item Description</strong></td><td style="padding-right:10px;" bgcolor="#DDDDFF">
				<div class="frmSearch">
			...
			<td><strong>OR</strong></td><td width="50px" bgcolor="#FFDDDD"></td><td style="font-size:12pt; padding-left:10px;" bgcolor="#FFDDDD"><strong>S/N</strong></td><td style="padding-right:10px;" bgcolor="#FFDDDD">
				<div class="frmSearch">
				<input type="text" id="search-sn" value="" onclick="this.value=''" autocomplete="off" />
				<div id="suggesstion-sn"></div>
				</div>
			</td><td width="50px"><div id="div_isn"></div></td>
