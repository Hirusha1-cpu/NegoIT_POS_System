...
<div class="w3-container" style="margin-top:75px">
	...
	<div class="w3-row">
	 	<div class="w3-col s3">
	  	...
	  	<div class="w3-col">
	 		<table align="center" style="overflow-x: auto; display: block;"><tr><td><div id="chart_div" style="width: 900px; height: 300px;"></div></td></tr></table>
	  		<br />
			<?php if($type_req!=3 && $type_req!=5){ ?>
				<table align="center" bgcolor="#E5E5E5" height="100%" border="1" cellspacing="0" style="font-family:Calibri;overflow-x: auto; display: block;">
					<tr>
					...
					$inv=0;
					$store0='';
					$total_cash=$total_bank=$total_chque=$total_credit=0;
					...
					for($i=0;$i<sizeof($invoice_no);$i++){
						...
						if($store0!=$billed_store[$i]){
							...
							print '<tr '.$color.'>
									...
									<td align="right" style="padding-right:10px;">'.number_format($payment_bank[$invoice_no[$i]]).'</td>
									<td  align="right" style="padding-right:10px;">
										<a href="#" style="text-decoration:none" title="'.$chq_details[$invoice_no[$i]].'">'.number_format($payment_chque[$invoice_no[$i]]).'</a>
									</td>
									<td  align="right" style="padding-right:10px;">'.number_format($bill_credit).'</td>
						...
						if(sizeof($invoice_no)==($i+1)){
							print '<tr style="font-weight:bold; background-color:gray; color:white">
									...
									<td align="right" style="padding-right:10px;">'.number_format(array_sum($invoice_Total)).'</td>
			...
			<?php if($type_req!=3 && $type_req!=5){ ?>
				<table align="center" bgcolor="#E5E5E5" height="100%" border="1" cellspacing="0" style="font-family:Calibri;overflow-x: auto; display: block;">
					<tr>
						<td colspan="8" style="border:0; background-color:black; color:white; font-weight:bold">Payment Collection</td>
					</tr>
					<tr>
