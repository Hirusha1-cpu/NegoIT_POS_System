...
<div class="w3-row">
  ...
  <div class="w3-col">
	<div style="background-color:#EEEEEF; border-radius: 5px; padding-left:10px; padding-right:10px">
		...
		<tr><td width="10px"></td><td><strong>From </strong>&nbsp;</td><td> : <input type="date" name="datefrom" style="width:130px" value="<?php print $fromdate; ?>" /></td>
			<td rowspan="3"><input type="submit" value="Get" style="width:50px; height:60px;" /></td>
		</tr>
		<tr><td width="10px"></td><td><strong>To  </strong>&nbsp;</td><td> : <input type="date" name="dateto" style="width:130px" value="<?php print $todate; ?>" /></td></tr>
		<tr><td width="10px"></td><td><strong>Category </strong>&nbsp;</td><td> : 
		...
		<tr><td width="10px"></td><td><strong>Store </strong>&nbsp;</td><td> : 
...
<div id="imageframe0"></div>
	<table align="center" height="100%" border="1" cellspacing="0" style="font-family:Calibri">
		...
		?>
		<th class="tb2">Total</th><th class="tb2">Available Stock</th></tr>
		<?php
		$total_sub_qty=0;
		for($i=0;$i<sizeof($itm_id);$i++){
			$total_qty=0;
			print '<tr><td class="tb2" style="background-color:#DDDDFE">'.$itm_desc[$i].'</td>';
			for($j=0;$j<sizeof($rep_id);$j++){
