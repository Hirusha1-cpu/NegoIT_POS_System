...
<!-- ------------------Item List----------------------- -->
	...
	<tr><td width="50px"></td><td>
		<form id="search_form" action="index.php" method="get" >
			...
			<table>
			<tr><td colspan="4" align="center" style="color:#467898;"><strong>Repair Income Summary Report</strong><br /><span style="font-size:10pt;"><i>Report by Delivered Date</i></span><hr /></td></tr>
			<tr><td>From Date <input type="date" id="datefrom" name="datefrom" value="<?php print $fromdate; ?>" /></td><td width="100px"></td>
			    <td>To Date <input type="date" id="dateto" name="dateto" value="<?php print $todate; ?>" /></td><td>
...
<div id="printheader" style="display:none" >
	...
	<h2 align="center" style="color:#3333FF; text-decoration:underline; font-family:Calibri">Repair Income Summary Report</h2>
	<table><tr><td>
