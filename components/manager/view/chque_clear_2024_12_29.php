...
<table align="center" height="100%" style="font-size:10pt; font-family:Calibri">
	...
	print '<tr bgcolor="#EEEEEE">
			...
			<td align="center"  class="shipmentTB3"><a href="#" title="Collected By : '.ucfirst($salesman[$i]).'" style="text-decoration:none">'.$chque_no[$i].' | '.$chque_bnk_code[$i].' | '.$chque_bnk_brn[$i].'</a></td>
