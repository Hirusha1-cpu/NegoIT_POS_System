...
<div id="print">
	...
	<?php if($type_req!=3 && $type_req!=5){ ?>
		<table align="center" bgcolor="#E5E5E5" height="100%" border="1" cellspacing="0" style="font-family:Calibri">
			<tr>
				<td colspan="9" style="border:0; background-color:black; color:white; font-weight:bold">Payment Collection</td>
			</tr>
			<tr>
				<th width="60px">#</th>
			...
			<?php
				...
				for($i=0;$i<sizeof($payment_id);$i++){
					...
					if($store0!=$payment_store[$i]){
						print '<tr><td colspan="9" style="padding-left:20px; font-weight:bold; background-color:#0066AA; color:white">'.$payment_store[$i].'</td></tr>';
					}
					print '<tr>
						<td align="center">
							'.($i+1).'
						...
						<td align="right" style="padding-right:10px;"><a '.$payment_details[$i].' >'.$pay_cash.'</a></td>
						<td align="right" style="padding-right:10px;"><a '.$payment_details[$i].' >'.$pay_card.'</a></td>
						<td align="right" style="padding-right:10px;"><a '.$payment_details[$i].' >'.$pay_bank.'</a></td>
						<td align="right" style="padding-right:10px;"><a '.$payment_details[$i].' >'.$pay_cheque.'</a></td>
					...
					if(sizeof($payment_id)==($i+1)){
						...
						print '<tr style="font-weight:bold; background-color:#BBBBBB; color:white">
								<td colspan="8" align="right"  style="padding-right:10px;" >Total Payments</td><td align="right" style="padding-right:10px;">'.number_format(($pay_total_cash+$pay_total_card+$pay_total_bank+$pay_total_cheque),$decimal).'</td>';
						print '</table><br /><table align="center" bgcolor="#E5E5E5" height="100%" border="1" cellspacing="0">';
					}
	...
	<?php if($type_req==5 || $type_req==''){ ?>
		<table align="center" bgcolor="#E5E5E5" height="100%" border="1" cellspacing="0" style="font-family:Calibri">
			<tr>
				<td colspan="8" style="border:0; background-color:black; color:white; font-weight:bold">Warranty Pay Collection</td>
			</tr>
			<tr>
				<th width="60px">#</th>
			...
			<?php
				...
				for($i=0;$i<sizeof($wa_no);$i++){
					...
					if(sizeof($wa_no)==($i+1)){
						print '<tr style="font-weight:bold; background-color:gray; color:white">
								<td colspan="3" align="right"  style="padding-right:10px;" >Total</td>
								<td align="right" style="padding-right:10px;">'.number_format($total_payment,$decimal).'</td><td colspan="2"></td>
							</tr>';
						print '</table><br /><table align="center" bgcolor="#E5E5E5" height="100%" border="1" cellspacing="0">';
					}
						$store0=$wa_store[$i];
