		...
		<table align="center" height="100%" cellspacing="0" style="font-family:Calibri" bgcolor="#F0F0F0">
			<tr>
				...
				<td colspan="8">
					<table>
						<tr>
							<td><strong>From </strong>: &nbsp;<input type="date" name="datefrom" style="width:130px"
									value="<?php print $fromdate; ?>" />
								&nbsp;&nbsp;&nbsp;<strong>To </strong>: &nbsp;<input type="date" name="dateto" style="width:130px"
									value="<?php print $todate; ?>" />
							</td>
						</tr>
					</table>
				</td>
				...
				<?php if (isset($components) && ($components == 'manager' || $components == 'topmanager')) { ?>
					<td width="50px"></td>
				...
				<?php } ?>
				<td width="50"></td>
				<td><a onclick="document.getElementById('search_form').submit();" style="cursor:pointer"><img
							src="images/search.png" style="width:30px; vertical-align:middle" /></a></td>
				<td width="50"></td>
			</tr>
		</table>
	</form>
...
<hr />
<p style="text-align:center; color:teal; font-family:Calibri; font-size:10pt">All the Packed, Shipped and Delivered
	Invoices are counted for this report</p>
				...
				<table style="font-size:12pt" border="1" cellspacing="0">
					<tr>
						...
						<td style="background-color:#EEEEEE; padding-left:10px">
							<?php print 'From :' . $fromdate . ' To :' . $todate; ?>
						</td>
					</tr>
					<tr>
						<td style="background-color:#C0C0C0; padding-left:10px">Category</td>
						<td style="background-color:#EEEEEE; padding-left:10px"><?php print $cname; ?></td>
					</tr>
					<tr>
						<td style="background-color:#C0C0C0; padding-left:10px">Store</td>
						<td style="background-color:#EEEEEE; padding-left:10px"><?php print $sname; ?></td>
					</tr>
				</table>
			</td>
		</tr>
