	...
	if(isset($_REQUEST['chque_no'])){
		if($_REQUEST['chque_no']!=''){ ?>
			<table align="center" bgcolor="#E5E5E5" style="font-size:10pt" cellspacing="0" border="0">
				...
				<?php if(($chq_return==0) && ($chq_clear != 1) && (isSalesmanPaymentDepositActive())){ ?>
					<tr height="50">
						<td colspan="7" height="10px" style="background-color:white" align="center">
				...
				<?php if($chq_return==0){ ?>
				<tr>
					<td colspan="7" style="background-color:white" align="center">
