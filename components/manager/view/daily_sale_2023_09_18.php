	...
	<table align="center" height="100%" cellspacing="0" style="font-family:Calibri" bgcolor="#F0F0F0" border="0" >
		<tr>
			...
			<td width="50px" rowspan="2" valign="middle">
				<?php if($gps!='') print '<form id="map_form" method="post" action="index.php?components=manager&action=show_map" target="_blank" style="cursor:pointer"><input type="hidden" name="gps" value="'.$gps.'" /><a onclick="document.getElementById('."'map_form'".').submit();"><img src="images/map.png" width="90%" /></a></form>'; ?>
			</td>
		</tr>
		<tr>
			<td width="50px"></td>
