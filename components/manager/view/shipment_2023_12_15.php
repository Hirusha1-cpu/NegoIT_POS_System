						...
						<?php
							...
							for($i=0;$i<sizeof($ms2_des);$i++){
								print '<tr bgcolor="#EEEEEE">
											...
											else print '<td class="shipmentTB2"></td>
							...
							for($i=0;$i<sizeof($sp_id);$i++){
								...
								print
									'<tr bgcolor="' .$color1.'">
										...
										<td class="shipmentTB2" align="right" colspan="2"><a style="color:white; text-decoration:none"
		...
		<td width="50%" style="vertical-align:top">
			<form method="post" action="index.php?components=<?php print $components; ?>&action=shipment">
				<table align="center">
					...
					<tr bgcolor="#CCCCCC">
						<th></th>
						<th><input type="text" name="ship_no" placeholder="Search.." class="shipmentTB3" style="width:80px"
								value="<?php print $filter_shipno; ?>" /></th>
						<th><input type="text" name="inv_date" placeholder="Search.." class="shipmentTB3" style="width:80px"
								value="<?php print $filter_invdate; ?>" /></th>
						<th><input type="text" name="inv_no" placeholder="Search.." class="shipmentTB3" style="width:80px"
								value="<?php print $filter_invno; ?>" /></th>
						<th><input type="text" name="inv_sup" placeholder="Search.." class="shipmentTB3" style="width:80px"
								value="<?php print $filter_invsup; ?>" /></th>
					</tr>
