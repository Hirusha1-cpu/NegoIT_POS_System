...
<tr><td colspan="2" style="color:navy; font-size:14pt; font-weight:bold" align="center">List Of Unlocked Bills [All Stores]</td></tr>
<tr><td width="20px" bgcolor="blue"></td><td style="color:gray; font-size:11pt;"> Partially Locked Bills by "Customer Order"</td></tr>
</table>
<br />
	...
	<br />
		<div id="print">
			<table align="center" bgcolor="#E5E5E5" height="100%" border="1" cellspacing="0" style="font-size:10pt; font-family:Calibri">
				<tr><th width="100px">Invoice No</th><th width="100px">Date</th><th width="100px">Time</th><th>&nbsp;&nbsp;Salesman&nbsp;&nbsp;</th><th>&nbsp;&nbsp;Customer&nbsp;&nbsp;</th><th>&nbsp;&nbsp;Store&nbsp;&nbsp;</th></tr>
			<?php for($i=0;$i<sizeof($invoice_no);$i++){
				if($lock[$i]==2){ $color='blue'; $comment='Un-Packed Cust Order'; }else{ $color='black'; $comment=''; }
				print '<tr style="color:'.$color.'"><td align="center"><a title="'.$comment.'" href="index.php?components=billing&action=finish_bill&id='.$invoice_no[$i].'" >'.str_pad($invoice_no[$i], 7, "0", STR_PAD_LEFT).'</a></td><td align="center">'.$date[$i].'</td><td align="center">'.$time[$i].'</td><td>&nbsp;&nbsp;'.ucfirst($billed_by[$i]).'&nbsp;&nbsp;</td><td>&nbsp;&nbsp;'.$billed_cust[$i].'&nbsp;&nbsp;</td><td>&nbsp;&nbsp;'.$store[$i].'&nbsp;&nbsp;</td></tr>';
			}	?>
			</table>
		</div>	
	<br />
