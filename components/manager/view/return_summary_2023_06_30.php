...
<script type="text/javascript">
	...
	function changeSM(){
		...
		window.location = 'index.php?components=<?php print $_GET['components']; ?>&action=show_return_summary&from_date='+from_date+'&to_date='+to_date+'&sm='+salesman+'&cu=<?php print $_GET['cu']; ?>';
	}
...
<div id="printheader" style="display:none" >
	...
	<h3 align="center" style="color:#333399; text-decoration:underline">Return Invoice List</h3>
...
<h2 align="center" style="color:#0158C2">List Of Return Invoices</h2>
...
<input type="hidden" name="action" value="show_return_summary" />
...
<div id="print">
	...
	<tr style="font-weight:bold; background-color:#0066AA; color:white"><th>Return Invoice</th><th>Return Date</th><th>Customer</th><th>Salesman</th></tr>
	<?php for($i=0;$i<sizeof($rtn_inv);$i++){
			if((strlen($rtn_cust[$i]))>20) $cust=substr($rtn_cust[$i],0,19).'...'; else $cust=$rtn_cust[$i];
			print '<tr><td align="center"><a href="index.php?components=billing&action=finish_return&id='.$rtn_inv[$i].'">'.str_pad($rtn_inv[$i], 7, "0", STR_PAD_LEFT).'</a></td><td align="center">'.$rtn_date[$i].'</td><td style="padding-left:10px; padding-right:10px"><a href="" style="text-decoration:none" title="'.$rtn_cust[$i].'">'.$cust.'</a></td><td>&nbsp;&nbsp;'.ucfirst($rtn_by[$i]).'&nbsp;&nbsp;</td></tr>';
	} ?>
	</table>
</div>
