...
<div id="printheader" style="display:none">
	...
	<h3 align="center" style="color:#333399; text-decoration:underline">Return Items Report</h3>
...
<form action="index.php" method="get" onsubmit="return validateRTForm()" >
	...
	<table align="center" style="font-family:Calibri; font-size:12pt" bgcolor="#EEEEEE">
		<tr>
			...
			<td>From Date</td>
			<td>
				<input type="date" name="from_date" id="from_date" value="<?php print $from_date; ?>" style="width:130px" />
			</td>
			<td width="80px"></td><td>Salesman</td><td>
			...
			<td width="50px"></td>
			<td rowspan="2">
				<input type="submit" value="Get" style="height:60px; width:70px" />
			</td>
		</tr>
