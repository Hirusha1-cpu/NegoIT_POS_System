...
<form action="index.php?components=<?php print $components; ?>&action=cash_transfer_deposits_report" method="post">
    <table border="0" width="1200px" align="center" height="100%" cellspacing="0"
        ...
        <tr>
            <td colspan="7">
                <br> &nbsp;&nbsp;&nbsp;Note: This report shows cash payments collected by salesmen, either transfer to user or bank.
                <hr />
            </td>
        </tr>
    </table>
...
<div id="printheader" style="display:none">
    ...
    <br />
    <p>Note: This report shows cash payments collected by salesmen, either transfer to user or bank which need to be sent for review to confirm payment</p>
    <br>
</div>
