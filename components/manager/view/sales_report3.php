...
<div id="printheader" style="display:none" >
	...
	<table style="font-size:12pt" border="1" cellspacing="0">
		<tr>
			<td width="100px" style="background-color:#C0C0C0; padding-left:10px">Customer</td><td width="250px" style="background-color:#EEEEEE; padding-left:10px"><?php print ucfirst($customer); ?></td>
		</tr>
		<tr>
			<td style="background-color:#C0C0C0; padding-left:10px">From</td><td style="background-color:#EEEEEE; padding-left:10px"><?php print $fromdate; ?></td>
		</tr>
		<tr>
			<td style="background-color:#C0C0C0; padding-left:10px">To</td><td style="background-color:#EEEEEE; padding-left:10px"><?php print $todate; ?></td>
		</tr>
	</table><br />
</div>
...
<div id="print">
	<table align="center" height="100%" style="font-size:10pt">
		...
		<tr bgcolor="#CCCCCC">
			...
			<th width="100px">Status of Selling<br />to the Customer</th>
			<th width="50px">Avialble QTY</th>
		</tr>
		<?php
			if(($customer_id!='')||($store1!='')){
				for($i=0;$i<sizeof($itm2_id);$i++){
					if($itm2_sold[$i]){
						$img='<img src="images/action_check.gif" />'; $color1='green'; $color2='white';
					}else{
						$img=''; $color1='#EEEEEE'; $color2='';
					}
					print '<tr bgcolor="'.$color1.'">
							<td align="center">'.($i+1).'</td>
							<td style="padding-left:30px; color:'.$color2.';">'.$itm2_name[$i].'</td>
							<td align="center">'.$img.'</td>
							<td align="right" style="padding-right:10px;">'.$itm2_qty[$i].'</td>
						</tr>';
				}
			}
		?>
