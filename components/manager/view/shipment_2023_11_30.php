...
<div id="print" style="display:none">
	<table border="1" cellspacing="0">
		...
		<tr bgcolor="#EEEEEE">
			<td width="170px">&nbsp;&nbsp;&nbsp;Invoice Amount</td>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php print number_format($sm1_amount); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		</tr>
	</table>
	<br />
	<br />
		...
		<?php
			...
			for($i=0;$i<sizeof($ms2_des);$i++){
				print '<tr bgcolor="#EEEEEE">
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$ms2_des[$i].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td align="right">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.number_format($ms2_qty[$i]*$ms2_c_price[$i]).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</td>';
					if($ms2_unic[$i]==1){
						print '<td align="right">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.number_format($sm3_soldprice[$i]).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			...
			print '<tr bgcolor="#CCCCCC">
				...
				<td align="right">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>'.number_format($total_cost).'</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</td>
				<td align="right">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>'.number_format($total_earnings).'</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</td>
				<td></td>
			</tr>';
		?>
	...
	<tr>
			...
			<div
				...
				<div
					...
					<table align="center">
						...
						<tr bgcolor="#EEEEEE">
							<td class="shipmentTB1">Invoice Amount</td>
							<td class="shipmentTB2"><?php print number_format($sm1_amount); ?></td>
						</tr>
					</table>
					<br />
					<br />
						...
						<?php
							...
							for($i=0;$i<sizeof($ms2_des);$i++){
								print '<tr bgcolor="#EEEEEE">
											...
											<td class="shipmentTB2" align="right">'.number_format($ms2_qty[$i]*$ms2_c_price[$i]).'</td>';
											if($ms2_unic[$i]==1){
												print '<td class="shipmentTB2" align="right">'.number_format($sm3_soldprice[$i]).'</td>
							...
							print '<tr bgcolor="#CCCCCC">
								<td class="shipmentTB2"><strong>Total</strong></td>
								<td class="shipmentTB2" align="right"><strong>'.number_format($total_cost).'</strong></td>
								<td class="shipmentTB2" align="right"><strong>'.number_format($total_earnings).'</strong></td>
								<td></td>
							</tr>';
							print '<tr>
								<td colspan="4"><br /></td>
							...
							for($i=0;$i<sizeof($sp_id);$i++){
								...
								print
									'<tr bgcolor="' .$color1.'">
									<td class="shipmentTB2"><a style="color:white; text-decoration:none"
											href="index.php?components=fin&action=one_journal&id='.$sp_journal[$i].'"
											title="Click Here to see the Journal Entry">'.$type.'</a></td>
									<td class="shipmentTB2" align="right"><a style="color:white; text-decoration:none"
											href="index.php?components=fin&action=one_journal&id='.$sp_journal[$i].'"
											title="Ref: '.$sp_ref[$i].'">'.number_format((-1*$sp_amount[$i])).'</a></td>
									<td class="shipmentTB2" align="right"><a style="color:white; text-decoration:none"
											href="index.php?components=fin&action=one_journal&id='.$sp_journal[$i].'"
											title="Record Added Date: '.$sp_sys_date[$i].'">'.$sp_pay_date[$i].'</a></td>
									<td class="shipmentTB2" style="color:white; text-decoration:none"><input type="text" placeholder="Password"
											id="pass_'.$sp_id[$i].'" style="width:60px" /> <a style="cursor:pointer"
											onclick="deleteShipPay('.$sp_id[$i].')"><img src="images/action_delete.gif" /></a></td>
									</tr>';
									$total_cost-=$sp_amount[$i];
							}
							print '<tr bgcolor="#CCCCCC">
								<td class="shipmentTB2"><strong>Total Balance</strong></td>
								<td class="shipmentTB2" align="right"><strong>'.number_format($total_cost).'</strong></td>
								<td class="shipmentTB2" align="right"></td>
								<td></td>
							</tr>';
						?>
					</table>
		...
		<td style="vertical-align:top">
			<form method="post" action="index.php?components=<?php print $components; ?>&action=shipment">
				<table align="center">
					<tr>
						<td align="center" colspan="4">List of Last 50 Shipments</td>
					</tr>
					<tr bgcolor="#CCCCCC">
						<th>Shipment No</th>
						<th>Invoice Date</th>
					...
					<?php for($i=0;$i<sizeof($sm_id);$i++){
						...
						print '<tr bgcolor="'.$color1.'">
							<td style="padding-left:10px; padding-right:10px" align="center"><a
									href="index.php?components='.$components.'&action=shipment&id='.$sm_id[$i].'">'.str_pad($sm_id[$i], 7,
									"0", STR_PAD_LEFT).'</a></td>
