...
switch ($_REQUEST['action']) {
   ...
   case "add_cust_image":
      include_once 'components/manager/modle/managerModule.php';
      error_log("Controller: add_cust_image called, REQUEST_METHOD: " . $_SERVER['REQUEST_METHOD'], 3, "/Users/hirushafernando/Documents/NEGOIT/march_5/code/billing/logfile.log");
      error_log("Controller: add_cust_image called, POST data: " . print_r($_POST, true), 3, "/Users/hirushafernando/Documents/NEGOIT/march_5/code/billing/logfile.log");
      error_log("Controller: add_cust_image called, FILES data: " . print_r($_FILES, true), 3, "/Users/hirushafernando/Documents/NEGOIT/march_5/code/billing/logfile.log");
   ...
   //added by nirmal 29_12_2025
   case "item_monthly_sales_report":
      include_once 'components/manager/modle/managerModule.php';
      getFilter($sub_system);
      getCustGroups($sub_system);
      getItemListMGR($sub_system);
      itemMonthlySales($sub_system);
      getTown();
      if (isMobile())
         include_once 'components/manager/view/m_item_monthly_sales_report.php';
      else
         include_once 'components/manager/view/item_monthly_sales_report.php';
      break;
