	...
	*/
	...
	if ($out) {
		if($dob != ''){  // added by nirmal 29_04_2022
			$query = "INSERT INTO `cust` (`associated_store`,`associated_salesman`,`associated_group`,`associated_town`,`name`,`nic`,`mobile`,`credit_limit`,`cust_name`,`nickname`,`shop_address`,`shop_tel`,`home_address`,`home_tel`,`tax_no`,`email`,`email_enable`,`sms`,`gps_x`,`gps_y`,`created_by`,`created_timestamp`,`sub_system`,`master_cust`,`dob`,`status` $approve_qry1) VALUES ('$cu_store','$sm_id','$cu_group','$cu_town','$shop_name','$nic','$mobile','$cr_limit','$custname','$nickname','$shop_address','$shop_tel','$home_address','$home_tel','$cu_tax_no','$email_add','$email_alert','$sms','$gps_x','$gps_y','$created_by','$created_timestamp','$sub_system','$master_cust','$dob','$status' $approve_qry2)";
		}else{
			$query = "INSERT INTO `cust` (`associated_store`,`associated_salesman`,`associated_group`,`associated_town`,`name`,`nic`,`mobile`,`credit_limit`,`cust_name`,`nickname`,`shop_address`,`shop_tel`,`home_address`,`home_tel`,`tax_no`,`email`,`email_enable`,`sms`,`gps_x`,`gps_y`,`created_by`,`created_timestamp`,`sub_system`,`master_cust`,`status` $approve_qry1) VALUES ('$cu_store','$sm_id','$cu_group','$cu_town','$shop_name','$nic','$mobile','$cr_limit','$custname','$nickname','$shop_address','$shop_tel','$home_address','$home_tel','$cu_tax_no','$email_add','$email_alert','$sms','$gps_x','$gps_y','$created_by','$created_timestamp','$sub_system','$master_cust','$status' $approve_qry2)";
		}
		$result = mysqli_query($conn, $query);
