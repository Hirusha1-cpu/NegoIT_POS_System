			...
			if ($result) {
				...
				if(isQuickBooksActive(1)){
					try{
						...
						$custArray = array('DisplayName'=>$shop_name, 'CompanyName'=>$shop_name, 'FullyQualifiedName'=>$shop_name, 'GivenName'=>$custname, 'City'=>$town,
						'Line1'=>$shop_address,
						'PrimaryEmailAddr'=>$email_add, 'PrimaryPhone'=>$mobile, 'Country'=>$country);
