	...
	function setTown($tw_name){
 	...
 	function getCustMore($id){
	    ...
	    if (this.readyState == 4 && this.status == 200) {
			...
			<?php if($_REQUEST['components'] == 'marketing'){ ?>
 	  		document.getElementById('c_custreport').innerHTML='<input type="button" value="Customer Report" onclick="window.open(\'index.php?components=<?php echo  $_REQUEST['components'] ?>&action=cust_sale&customer_id='+$id+'&datefrom='+$values[23]+'&dateto='+$values[24]+'\',\'_blank\')" />';
...
<table align="center" style="font-family:Calibri; font-size:12pt"><tr><td>
	<div style="background-color:#EEEEEE; border-radius:10px">
		...
		<td width="20px"></td><td>Sub-System</td><td>
...
<tr><td valign="top">
	<table>
	<tr style="background-color:#467898; color:white;" class="shipmentTB3"><th>Town</th><th class="shipmentTB3">Customer<br />Count</th></tr>
	<?php
	...
	<table>
	<tr style="background-color:#467898; color:white; padding-left:20px; padding-right:20px;"><th colspan="2">Customer</th><th>Mobile</th><th>Shop Tel</th><th>More Details</th></tr>
	<?php
