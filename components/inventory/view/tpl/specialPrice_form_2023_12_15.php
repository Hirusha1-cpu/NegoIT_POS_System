...
?>
	<form action="index.php?components=inventory&action=<?php print $action; ?>" onsubmit="return validateSpecial()" method="post" >
	...
	<tr><td width="30px" height="30px"></td><td><strong>Item</strong></td><td><input type="text" name="item" id="tags1" style="width:200px" value="<?php print $item_t; ?>" /></td><td width="30px"></td></tr>
	<tr><td width="30px" height="30px"></td><td><strong>District</strong></td><td>
