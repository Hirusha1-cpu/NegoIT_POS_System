...
<form action="index.php?components=inventory&action=add_item" onsubmit="return validateAddItem()" method="post" >
	...
	<table align="center" bgcolor="#E5E5E5" style="font-family:Calibri">
		...
		<tr>
			...
			<td>
				<select id="pr_sr" name="pr_sr" onchange="window.location = 'index.php?components=inventory&action=show_add_item&type='+this.value" style="width:100%" >
		...
		<?php if($_GET['type']==1){ ?>
			...
			<tr>
				...
				<td>
					<input type="number" name="min_w_rate" id="min_w_rate" value="<?php print $default_min_w_rate; ?>" step="0.01"/>
				</td>
				<td>
					<div id="id8"></div>
				</td>
			...
			<tr>
				...
				<td>
					<input type="number" name="max_w_rate" id="max_w_rate" value="<?php print $default_max_w_rate; ?>" step="0.01"/>
				</td>
				<td>
					<div id="id9"></div>
				</td>
			...
			<tr>
				...
				<td>
					<input type="number" name="max_r_rate" id="max_r_rate" value="<?php print $default_max_r_rate; ?>" step="0.01"/>
				</td>
				<td>
					<div id="id10"></div>
				</td>
			...
			<tr>
				...
				<td>
					<select name="unic" id="unic" onchange="setUnic()" >
						...
						<option value="0" <?php print $unic_no; ?>>No</option>
					</select>
				</td>
				<td>
					<div id="id11"></div>
