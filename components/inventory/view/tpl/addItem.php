...
<form action="index.php?components=<?php print $components; ?>&action=add_item" onsubmit="return validateAddItem()" method="post">
	...
	<table align="center" bgcolor="#E5E5E5" style="font-family:Calibri">
		...
		<tr>
			...
			<td style="font-size:12pt"><strong><?php echo ucfirst($currentstore ?? ''); ?></strong></td>
		...
		<tr>
			...
			<td>
				<select id="pr_sr" name="pr_sr"
					onchange="window.location = 'index.php?components=<?php print $components; ?>&action=show_add_item&type='+this.value"
					style="width:100%">
