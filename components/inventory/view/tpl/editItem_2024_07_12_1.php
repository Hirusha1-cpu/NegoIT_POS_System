...
<script type="text/javascript">
	...
	function updatePriceOfUnic($i,$inv_ship_id,$itq_id,$item_id,$store_id){
		var $master_pw=document.getElementById('master_pw').value;
		var $w_price=document.getElementById('w_price'+$i).value;
		var $r_price=document.getElementById('r_price'+$i).value;
		var $c_price=document.getElementById('c_price'+$i).value;
		...
		if($master_pw != ''){
			...
			// xhttp.open("GET", 'index.php?components=inventory&action=edit_unics_price&master_pw='+$master_pw+'&inv_ship_id='+$inv_ship_id+'&itq_id='+$itq_id+'&w_price='+$w_price+'&r_price='+$r_price+'&c_price='+$c_price+'&drawer='+$drawer, true);
			// xhttp.send();
			console.log('index.php?components=inventory&action=edit_unics_price&master_pw='+$master_pw+'&inv_ship_id='+$inv_ship_id+'&itq_id='+$itq_id+'&item_id='+$item_id+'&store_id='+$store_id+'&w_price='+$w_price+'&r_price='+$r_price+'&c_price='+$c_price+'&drawer='+$drawer, true);
		}else{
			alert('Please enter Master Password 01');
		}
	}
						...
						<?php
							...
							if((!($unic_cal)) && (!($itm_unic==1))){
								...
								for($i=0;$i<sizeof($inv_ship_id);$i++){
									...
									<td align="center" class="'.$rowClass[$i].' text"><input type="number" id="w_price'.$i.'" style="text-align: right; width:100px" value="'.$w_price[$i].'" '.$style2.'/></td>
									<td align="center" class="'.$rowClass[$i].' text"><input type="number" id="r_price'.$i.'" style="text-align: right; width:100px" value="'.$r_price[$i].'" '.$style2.'/></td>
									<td align="center" class="'.$rowClass[$i].' text"><input type="number" id="c_price'.$i.'" style="text-align: right; width:100px" value="'.$c_price[$i].'" '.$style2.'/></td>
									<td align="center" class="'.$rowClass[$i].' text"><input type="number" id="qty'.$i.'" value="'.$qty[$i].'" '.$style1.' /></td>
									<td align="center" class="'.$rowClass[$i].' text"><input type="text" id="drawer'.$i.'" style="text-align: left; width:50px;" value="'.$drawer[$i].'" '.$style2.'/></td>
									<td align="center" class="'.$rowClass[$i].' text"></td>
									</tr>';
								}
							}
						?>
