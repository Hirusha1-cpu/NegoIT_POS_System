...
<script type="text/javascript">
	...
	function generateExelReport(){
		window.location = 'index.php?components=inventory&action=reorder_repairparts';
	}
</script>
<?php if($type==4) { ?>
	...
	<tr>
		...
		<td align="center">
			<div style="background-color:#6699FF; border:medium; border-color:black; width:90px;">
				...
				<?php
				// print '<a class="shortcut-button" style="cursor:pointer" onclick="setFilter(\'export_unic_list\')" ><span style="text-decoration:none; font-family:Arial; color:navy;">';
				?>
