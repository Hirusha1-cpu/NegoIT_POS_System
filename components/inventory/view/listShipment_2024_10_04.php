...
<script type="text/javascript">
	function filterStore(){
		...
		window.location = 'index.php?components=inventory&action=shipmentlist&month='+month+'&store='+store;
	}
</script>
...
<div
	...
	<span>Month Filter : </span><input type="month" name="month" id="month" value="<?php print $_GET['month']; ?>"
		onchange="window.location = 'index.php?components=inventory&action=shipmentlist&month='+this.value"
