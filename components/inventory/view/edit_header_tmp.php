...
<script>
    function editShipment(){
		...
		window.location = 'index.php?components=<?php print $components; ?>&action='+sub+'&shipment_no='+shipment_no;
	}

</script>
<form action="index.php?components=<?php print $components; ?>&action=update_shipment_header_tmp" method="post" onsubmit="return validateShipment()"  >
