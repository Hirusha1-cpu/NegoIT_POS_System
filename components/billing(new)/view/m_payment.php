	...
	function validatePayment(){
	    ...
	    if(txt==1){
			if(document.getElementById('amount_chque').value==''){ 
					$count++; $msg="Amount Shuldn't be Empty"; 
			}
	    }
	    if(txt==3){
			if(document.getElementById('amount_chque').value==''){ 
		    ...
		    if(document.forms["payForm"]["tr_bank"].value==''){ 
				$count++; $msg="Please Select the Money Transferred Bank"; 
			}
	    }
		if(txt==4){
			if(document.getElementById('amount_chque').value==''){ 
		    ...
		    if(document.forms["payForm"]["card_bank"].value==''){ 
				$count++; $msg="Please Select the Console's Card Bank"; 
			}
		    if(document.forms["payForm"]["card_no"].value==''){ 
				$count++; $msg="Please Enter the Card Number"; 
			}
	    }
	    if(($count==0)&&(txt==2)){
	...
	function switchPayment(){
		...
		if(type_val==4){	
			...
			document.getElementById("sw_card").style.display = "block";
	  		document.getElementById("div_bank_sw").innerHTML='<input type="hidden" name="cash_bank_switch" value="2" />';
...
<div class="w3-container" style="margin-top:75px; padding:8px;">
	<?php 
	...
	<div class="w3-row">
	 	...
	 	<div class="w3-col">
		<table align="center" style="font-size:11pt"><tr><td style="vertical-align:top;" align="center">
		<h3 class="style2">Customer Payment</h3>
			<form name="payForm" id="payForm" action="index.php?components=billing&action=add_payment" method="post" >
				...
				print '<tr><td width="50px"></td><td style="font-size:12pt">Salesman</td><td colspan="2"><input type="text" name="cust" id="sm" /></td><td width="50px"></td></tr>';
				}else{
				...
				<?php } ?>
				<?php	if(isset($_GET['cust'])){ ?>
				<tr><td></td><td style="font-size:12pt" width="120px">Invoice No</td><td><input type="number" name="invoice_no" id="invoice_no" onchange="invoiceNumberChange();"/></td><td><input type="button" value="check" onclick="validateInvoice()" /></td><td><div id="invoice_div"></div></td></tr>
				<tr><td width="50px"></td><td style="font-size:12pt">Payment Type<br /><br /></td><td colspan="2">
					<input type="radio" name="payment_type" id="payment_type" value="1" onchange="switchPayment()"> Cash
					<input type="radio" name="payment_type" id="payment_type" value="4" onchange="switchPayment()"  style="style="margin-left:5px;"> Card
					<input type="radio" name="payment_type" id="payment_type" value="3" onchange="switchPayment()"  style="style="margin-left:5px;"> Bank
				 	<input type="radio" name="payment_type" id="payment_type" value="2" onchange="switchPayment()" style="style="margin-left:5px;"> Chque
				...
				<tr><td></td><td colspan="2">
					<div id="sw_card" style="display:none">
							...
							<tr><td style="font-size:12pt" width="120px">Bank</td><td>
							<select name="card_bank" id="card_bank" style="width: 190px;">
							...
							<tr id="card_tr" style="display:none">
								...
								<td style="font-size:12pt; padding-top:8px;">
									<input type="text" id="card_no" name="card_no" style="width:192px" placeholder="1400-4400-0000-1000" />
								</td>
							</tr>
							</table>
				...
				<tr><td></td><td colspan="2">
					<div id="sw_bank" style="display:none">
							<table width="100%" style="font-size:12pt" cellspacing="0">
							<tr><td style="font-size:12pt" width="82px">Bank</td><td>
				...
				<tr><td></td><td colspan="2">
					...
					<table cellspacing="0">
						<tr>
							<td></td>
							<td style="font-size:12pt" width="120px">Chque</td>
							<td>
								<input type="number" name="chque_no" id="chque_no" value="" style="width:70px" placeholder="Code"/>
								<input type="number" name="chque_bank" id="tags4" value="" style="width:50px" placeholder="Bank"/>
				...
				<tr><td></td><td></td><td colspan="3" height="10px"><div id="addpayment"><input type="button" value="Add Payment" style="width:110px; height:50px"  onclick="validatePayment();"/></div></td></tr>
				<?php } ?>
