...
<!-- ------------------------------------------------------------------------------------ -->
<?php
 include_once  'components/billing/view/tpl/pos_rtn.php';
?>
  	...
  	<table width="90%"><tr><td style="vertical-align:top;">
		...
		<tr><td>
			...
			<div style="background-color:#FF9191; border:medium; border-color:black; width:80px; text-align:center">
				<a class="shortcut-button" onclick="deleteReturn(<?php print $_GET['id']; ?>)" href="#"><span style="text-decoration:none; font-family:Arial; color:navy;">
