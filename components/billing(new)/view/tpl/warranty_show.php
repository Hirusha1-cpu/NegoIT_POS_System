	...
	<br />
		...
		<tr><td rowspan="2" valign="top">
			...
			if($war_cu_name!=''){
				...
				print '<tr><td>Inv</td><td>: <a href="index.php?components=billing&action=finish_bill&id='.$war_bminv.'" style="text-decoration:none">'.str_pad($war_bminv, 7, "0", STR_PAD_LEFT).'</a></td></tr>';
