...
<div id="print_top"></div>
	<table border="0" cellspacing="0" ><tr><td>
		...
		<?php
			 ...
			 if($dn=='no'){
				if($pay_type==3) $cash_name='Bank Transfer';
				elseif($pay_type==4) $cash_name='Card'; else $cash_name='Cash';
				...
				print '<tr style="font-size:10pt;"><td colspan="3" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:0; border-top:0;">'.$advance.' Payment: Chque</td><td align="right">'.number_format($chque_amount).'&nbsp;&nbsp;</td></tr>';	
