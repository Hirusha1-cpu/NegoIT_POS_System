...
</td><td></td><td align="right"><span style="font-family:'Arial Black'; font-size:20pt">PAYMENT</span><br /><span style="font-size:12pt; font-family:Arial"></span><br /></td></tr>
...
<hr /><br />
	...
	<table align="center" width="350px" border="1" cellspacing="0" >
		<tr style="font-family:Arial; font-size:10pt"><td colspan="2"><strong>Chque Details</strong></td></tr>
		...
		<tr style="font-family:Arial; font-size:10pt"><td height="30px" style="padding-left:15px" >Chque No</td><td align="right" style="padding-right:15px"><strong><?php print $chque_no; ?></strong></td></tr>
		<tr style="font-family:Arial; font-size:10pt"><td height="30px" style="padding-left:15px" >Chque Date</td><td align="right" style="padding-right:15px"><?php print $chque_date; ?></td></tr>
	</table>
