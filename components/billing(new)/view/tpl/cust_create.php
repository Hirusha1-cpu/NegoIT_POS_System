...
<?php if (!($_GET['action'] == 'onetime_cust')) { ?>
	...
	<form enctype="multipart/form-data" action="index.php?components=<?php print $components; ?>&action=<?php print $form_action; ?>&s=<?php print $_GET['s']; ?>&cust_odr=<?php print $_GET['cust_odr']; ?>" method="POST" id="image_form" name="image_form">
