...
<tr height="16px"><td width="0px"></td><td style="font-size:7pt"><div class="no-print"><strong>Date </strong></div></td><td><div class="no-print">:</div></td><td><?php print $bill_date; ?></td><td style="font-size:7pt" ><div class="no-print"><strong></strong></div></td><td></td><td></td></tr>
<tr height="16px"><td width="0px"></td><td style="font-size:7pt"><div class="no-print"><strong>Cashier </strong></div></td><td><div class="no-print">:</div></td><td></td><td style="font-size:7pt" width="50px"><div class="no-print"><strong>Salesman</strong></div></td><td><div class="no-print">:</div></td><td><?php print ucfirst($bill_salesman); ?></td></tr>
...
<tr><td width="0px"></td><td width="400px">
	...
	<tr height="11px" style="background-color:navy; color:white;"><td width="23px" align="center"><div class="no-print">Line</div></td><td width="188px" align="center"><div class="no-print">ITEM</div></td><td width="22px" align="center"><div class="no-print">Qty</div></td><td width="30px" align="center"><div class="no-print">Price</div></td><td width="32px" align="center"><div class="no-print">D. Rs</div></td><td width="20px" align="center"><div class="no-print">D.%</div></td><td width="48px" align="center"><div class="no-print">Extra Pay</div></td></tr>
	<?php
	$total_extra=0;
	for($i=0;$i<sizeof($bill_item);$i++){
		print '<tr height="16px" style="background-color:#A2C5CE; border-bottom-color:black; font-size:9pt; font-family:'."'Lucida Console'".';"><td align="right">'.($i+1).'&nbsp;</td><td>'.$bill_item[$i].'</td><td align="right">'.number_format($bill_qty[$i]).'&nbsp;</td><td></td><td></td><td></td><td align="right">'.number_format($extra_pay[$i]).'</td></tr>';
		$total_extra+=$extra_pay[$i];
	}
	?>
	</table>
	<table border="0" cellspacing="0" style="font-size:7pt; font-family:'Draft 10cpi'">
	<tr height="17px"><td width="0px"></td><td width="40px" style="font-family:Verdana;"><div class="no-print"><strong>Cash</strong></div></td><td><div class="no-print">:</div></td><td width="65px" align="right" style="font-size:9pt; font-family:'Lucida Console';"><?php print number_format($total_extra); ?>&nbsp;&nbsp;</td><td width="110px"></td><td width="70px" style="font-size:6pt; font-family:Verdana;"><div class="no-print"><strong>Gross Amount</strong></div><td><div class="no-print">:</div></td><td align="right" width="42px" style="font-size:9pt; font-family:'Lucida Console';"><?php print number_format($total_extra); ?></td></tr>
	...
	<tr height="17px"><td></td><td style="font-family:Verdana;"><div class="no-print"><strong>Chq No</strong></div></td><td><div class="no-print">:</div></td><td align="right" style="font-size:9pt; font-family:'Lucida Console';"></td><td></td><td style="font-size:6pt; font-family:Verdana;"><div class="no-print"><strong>Net Amount</strong></div><td><div class="no-print">:</div></td><td align="right" style="font-size:9pt; font-family:'Lucida Console';"><?php print number_format($total_extra); ?></td></tr>
	</table>
