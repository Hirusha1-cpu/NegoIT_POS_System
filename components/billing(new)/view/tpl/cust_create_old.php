			...
			$.ajax({
				...
				success: function(data) {
					...
					if (obj.user_create) {
						...
						// console.log("customer id" + obj.cust_id);
...
<form enctype="multipart/form-data" onsubmit="return validateCust2(event)" method="post" method="post" style="font-family:Calibri">
	...
	<table align="center" bgcolor="#E5E5E5" style="font-size:11pt; border-radius: 15px 15px 0px 0px;" >
		<tr>
...
<?php if (!($_GET['action'] == 'onetime_cust')) { ?>
	...
	<form enctype="multipart/form-data" action="index.php?components=<?php print $components; ?>&action=<?php print $form_action; ?>&s=<?php print $_GET['s']; ?>&cust_odr=<?php print $_GET['cust_odr']; ?>" id="image_form" method="POST" id="image_form" name="image_form">
...
<?php
if (isset($GET['message2'])) {

	$re = $_GET['re'];

	if ($re == 'success') {

		$message22 = $_GET['message2'];
		...
		echo "<script>
		   ...
		   toastr.warning('$message21','Success!');
