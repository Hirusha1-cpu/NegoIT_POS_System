...
<div class="w3-row">
  ...
  <div class="w3-col">
	...
	<?php } ?>
		...
		<span style="font-weight:bold; font-size:12pt;" >Return Invoice No: &nbsp;&nbsp;&nbsp;<?php print str_pad($_REQUEST['id'], 7, "0", STR_PAD_LEFT); ?></span>
		<?php } ?>
		<table align="center">
		<tr><td>
			...
			<?php }else{ ?>
			<tr><td width="50px"></td><td style="font-size:12pt">Return Item Code</td><td colspan="2"><input type="text" name="code" id="tags1" value="<?php if($unic_item_code!='') print $unic_item_code; ?>" /></td><td width="50px"></td></tr>
			...
			<tr><td width="50px"></td><td style="font-size:12pt">Replacement Item Code</td><td colspan="2"><input type="text" name="rplace_code" id="tags6" value="<?php if($unic_item_code!='') print $unic_item_code; ?>" /></td><td width="50px"></td></tr>
	  ...
	  <div class="w3-col" style="vertical-align:top">
		<div id="portrait">
			...
			<?php }else{	?>	
					...
					<tr><td style="font-size:12pt;"><input type="text" style="width:100px" name="search1" id="search1" placeholder="Search Return" /><input type="Submit" value="Search" /></td></tr>
					</table>
					</form>
			<?php } ?>
	  </div>
