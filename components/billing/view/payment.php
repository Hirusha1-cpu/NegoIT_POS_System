...
<!-- -------------------------------------------------------------------------------------------------------------------------------------- -->
	...
	<table height="100%" style="color:#0158C2; font-family:Calibri; font-size:16pt; vertical-align:middle"><tr><td><strong>Customer Payment</strong></td></tr></table>
		...
		<?php } ?>
		<?php	if(isset($_GET['cust'])){ ?>
		<tr><td></td><td style="font-size:12pt">Invoice No</td><td><input type="text" name="invoice_no" id="invoice_no" /></td><td><input type="button" value="check" onclick="validateInvoice()" /></td><td><div id="invoice_div"></div></td></tr>
