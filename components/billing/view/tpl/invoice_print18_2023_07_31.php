        ...
        <table align="center" height="<?php print $page_height; ?>px" width="100%" border="1" cellspacing="0" >
			...
			<?php
				...
				if($dn=='no'){
					...
					if($sub_system==0) $colspan=3; else $colspan=3;
					if($pay_type==3) $cash_name='Bank Transfer'; else $cash_name='Cash';
					print '<tr style="font-family:Calibri; font-size:11pt; font-weight:900; color:black; background-color:white; -webkit-print-color-adjust: exact;"><td colspan="'.$colspan.'" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:1;">Total Amount</td><td align="right">'.number_format($total,2).'&nbsp;&nbsp;</td></tr>';
					print '<tr style="font-family:Calibri; font-size:11pt; font-weight:900; color:black; background-color:white; -webkit-print-color-adjust: exact;"><td colspan="'.$colspan.'" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:1; border-top:0; color:black;">'.$advance.' Payment: '.$cash_name.'</td><td align="right">'.number_format($cash_amount,2).'&nbsp;&nbsp;</td></tr>';
					print '<tr style="font-family:Calibri; font-size:11pt; font-weight:900; color:black; background-color:white; -webkit-print-color-adjust: exact;"><td colspan="'.$colspan.'" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:1; border-top:0; color:black;">'.$chequedate.'<span style="padding-right:30px">'.$chq0_fullNo.'</span>'.$advance.' Payment: Cheque</td><td align="right">'.number_format($chque_amount,2).'&nbsp;&nbsp;</td></tr>';
