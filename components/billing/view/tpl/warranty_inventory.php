<script type="text/javascript">
		...
		if(a>-1){
			if(unic[a]==1){
				if(itemid[a]!=itemid0){
					...
					window.location = 'index.php?components=billing&action=warranty_inventory&id='+id+'&itemid='+itemid[a]+'&unic=yes&cashback=no&claim='+claim+'&repair='+repair+'&replace='+replace+'&inv='+inv+'&st='+st;
	...
	<form action="index.php?components=billing&action=add_warranty_inv" method="post">
