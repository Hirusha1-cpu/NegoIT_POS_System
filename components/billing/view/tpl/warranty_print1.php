...
<tr><td>Shop Action</td><td>: <?php print $shop_action; ?></td></tr>
	...
	<br />
		<table align="center" width="100%" style="font-family:Arial; font-size:9pt">
			...
			<tr><td>Customer</td><td> : <?php print '<a href="../../../../index.php?components=billing&action=cust_details&id='.$war_cust_id.'&action2=warranty_print&id2='.$_GET['id'].'" target="_parent" title="'.$war_cust_mobile.'" style="text-decoration:none" >'.ucfirst($war_cu_name).'</a>'; ?></td><td></td><td>Signature</td><td>  ..............................</td></tr>
		</table>
		<br />
	</td></tr>
	</table>
