...
TIME: <?php print substr($bi_time,0,5); ?> &nbsp;&nbsp;&nbsp;&nbsp;DATE: <?php print $bi_date; ?><br /><br />
</span></td></tr>
</table>
...
<?php
	for($i=0;$i<sizeof($bill_id);$i++){
		...
		if($bi_return_odr[$i]==0){
			print '<tr style="font-size:10pt; background-color:'.$color1.'" height="20px"><td align="center" style="border-bottom:0; border-top:0;">'.$bi_drawer[$i].'</td><td style="border-bottom:0; border-top:0;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.number_format($bi_qty[$i]).'</td><td style="border-bottom:0; border-top:0;">&nbsp;&nbsp;&nbsp;&nbsp;'.$bi_desc[$i].'</td>';
