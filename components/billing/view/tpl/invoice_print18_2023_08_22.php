...
<table class="report-container">
    <tbody class="report-content">
		...
		<table width="100%" border="0" style="font-family:Calibri; font-size:11pt;">
			<tr>
				<td colspan="3" style="vertical-align:top">
					<img src="../../../../images/cplogo<?php print $systemid; ?>.png" height="30px" />
				</td>
			</tr>
			<tr>
				<td>
        ...
        <table align="center" height="<?php print $page_height; ?>px" width="100%" border="1" cellspacing="0" >
			...
			<?php
				...
				if($dn=='no'){
					...
					if($sub_system==0) $colspan=4; else $colspan=4;
					if($pay_type==3) $cash_name='Bank Transfer'; else $cash_name='Cash';
                    if($trn_no != '') print '<tr style="font-family:Calibri; font-size:11pt; font-weight:900; color:black; background-color:white; -webkit-print-color-adjust: exact;"><td colspan="'.$colspan.'" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:1;">Value Added Tax '.$tax.'%</td><td align="right">'.number_format($tax_amount,$decimal_places).'&nbsp;&nbsp;</td></tr>';
					print '<tr style="font-family:Calibri; font-size:11pt; font-weight:900; color:black; background-color:white; -webkit-print-color-adjust: exact;"><td colspan="'.$colspan.'" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:1;">Total Amount</td><td align="right">'.number_format($total,$decimal_places).'&nbsp;&nbsp;</td></tr>';
					print '<tr style="font-family:Calibri; font-size:11pt; font-weight:900; color:black; background-color:white; -webkit-print-color-adjust: exact;"><td colspan="'.$colspan.'" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:1; border-top:0; color:black;">'.$advance.' Payment: '.$cash_name.'</td><td align="right">'.number_format($cash_amount,$decimal_places).'&nbsp;&nbsp;</td></tr>';
					print '<tr style="font-family:Calibri; font-size:11pt; font-weight:900; color:black; background-color:white; -webkit-print-color-adjust: exact;"><td colspan="'.$colspan.'" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:1; border-top:0; color:black;">'.$chequedate.'<span style="padding-right:30px">'.$chq0_fullNo.'</span>'.$advance.' Payment: Cheque</td><td align="right">'.number_format($chque_amount,$decimal_places).'&nbsp;&nbsp;</td></tr>';
					print '<tr style="font-family:Calibri; font-size:11pt; font-weight:900; color:black; background-color:white; -webkit-print-color-adjust: exact;"><td colspan="'.$colspan.'" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:1; border-top:0; color:black;">Remaining Balance</td><td align="right">'.number_format(($total-$cash_amount-$chque_amount-$tax_amount),$decimal_places).'&nbsp;&nbsp;</td></tr>';
				}
        	?>
        </table>
        ...
        if($return_odr){
            ...
            print '<tr><td colspan="4"><hr></td></tr>';
            print '<tr><td colspan="3">Total New Replacement Amount:</td><td>'.number_format($total2, $decimal_places).'</td></tr>';
            print '<tr><td colspan="4"><hr></td></tr>';
            print '</table>';
        }
