...
<table align="center" style="font-size:11pt"><tr><td style="vertical-align:top;" align="center">
	<h3 class="style2" >Customer Payment</h3>
		<form name="payForm" action="index.php?components=billing&action=add_payment" onsubmit="return validatePayment(1)" method="post" >
		...
		<?php } ?>
		<?php	if(isset($_GET['cust'])){ ?>
		<tr><td></td><td style="font-size:12pt" width="120px">Invoice No</td><td><input type="number" name="invoice_no" id="invoice_no" /></td><td><input type="button" value="check" onclick="validateInvoice()" /></td><td><div id="invoice_div"></div></td></tr>
		...
		<tr><td></td><td style="font-size:12pt">Amount</td><td><input type="number" name="amount" id="amount_chque" step=0.01 /></td><td></td><td></td></tr>
		...
		<tr><td></td><td colspan="2">
			...
			<table cellspacing="0">
				<tr><td></td><td style="font-size:12pt" width="120px">Chque </td><td>
				<input type="number" name="chque_no" id="chque_no" value="" style="font-size:large; width:80px" placeholder="Code"/>
		...
		<tr><td></td><td></td><td colspan="3" height="10px"><div id="addpayment"><input type="submit" value="Add Payment" style="width:110px; height:50px"  /></div></td></tr>
		<?php } ?>
