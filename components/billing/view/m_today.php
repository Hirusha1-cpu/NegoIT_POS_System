	...
	<div class="w3-row">
  		...
  		<div class="w3-col">
			...
			<table align="center" bgcolor="#E5E5E5" border="1" cellspacing="0" style="font-size:x-small">
				...
				<!--/ Color Codes -->
				<tr>
					<td colspan="4" style="background-color:silver; color:navy; font-family:Calibri; font-size:12pt">&nbsp;&nbsp;&nbsp;<strong>Today Invoices [Completed]</strong></td>
				</tr>
				<tr>
			...
			<table align="center" bgcolor="#E5E5E5" border="1" cellspacing="0" style="font-size:x-small">
				<tr>
					<td colspan="4" style="background-color:silver; color:navy; font-family:Calibri; font-size:12pt">&nbsp;&nbsp;&nbsp;<strong>Pending Invoices</strong></td>
				</tr>
				<tr>
					<th>Invoice No</th>
				...
				$inv=0;
					for($i=0;$i<sizeof($linvoice_no);$i++){
						...
						print '<tr bgcolor="'.$color.'">
								<td>&nbsp;&nbsp;<a href="index.php?components=billing&action=finish_bill&id='.$linvoice_no[$i].'">'.str_pad($linvoice_no[$i], 7, "0", STR_PAD_LEFT).'</a>&nbsp;&nbsp;&nbsp;&nbsp;'.$edit.'</td>
								<td width="50px"  align="center">'.$ldate[$i].'</td>
								<td width="50px" align="right">'.number_format($linvoice_total[$i],$decimal).'&nbsp;&nbsp;</td>
								<td>&nbsp;&nbsp;'.$lcust[$i].'</td>
							</tr>';
					}
				?>	
			...
			<table align="center" bgcolor="#E5E5E5" border="1" cellspacing="0" style="font-size:x-small">
				<tr>
					<td colspan="4" style="background-color:silver; color:navy; font-family:Calibri; font-size:12pt">&nbsp;&nbsp;&nbsp;<strong>Payment Invoices</strong></td>
				</tr>
				<tr>
					<th>Invoice No</th>
				...
				$inv=0;
					for($i=0;$i<sizeof($py_id);$i++){
						if($py_bill_pay[$i]==2){
							...
							print '<tr bgcolor="'.$color.'">
									<td align="center"><a href="index.php?components=billing&action=finish_payment&id='.$py_id[$i].'">'.str_pad($py_id[$i], 7, "0", STR_PAD_LEFT).'</a></td>
									<td width="50px" align="center">'.$py_time[$i].'</td>
			...
			<table align="center" bgcolor="#E5E5E5" border="1" cellspacing="0" style="font-family:Calibri;font-size :x-small">
				<tr>
					<td colspan="4" style="background-color:silver; color:navy; font-family:Calibri; font-size:12pt">&nbsp;&nbsp;&nbsp;<strong>Return Invoices</strong></td>
				</tr>
				<tr>
					<th>Invoice No</th>
					<th width="90px">Time</th>
					<th width="290px">Customer</th>
				</tr>
				<?php
					$inv=0;
					for($i=0;$i<sizeof($rt_invno);$i++){
						...
						if($rt_return_by[$i]==$user_id) $color='#EEEEEE'; else $color='#EEDDDD';
							print '<tr bgcolor="'.$color.'">
									<td align="center"><a href="index.php?components=billing&action=finish_return&id='.$rt_invno[$i].'">'.str_pad($rt_invno[$i], 7, "0", STR_PAD_LEFT).'</a>&nbsp;&nbsp;&nbsp;&nbsp;'.$edit.'</td>
									<td width="50px" align="center">'.$rt_time[$i].'</td>
									<td>&nbsp;&nbsp;'.$rt_cust_name[$i].'</td>
								</tr>';
					}
				?>	
			</table>
			...
			<table align="center" bgcolor="#E5E5E5" border="1" cellspacing="0" style="font-size:x-small;">
				<tr>
					<td colspan="4" style="background-color:silver; color:navy; font-family:Calibri; font-size:12pt">&nbsp;&nbsp;&nbsp;<strong>Warranty Invoices</strong></td>
				</tr>
				<tr>
					<th width="80px" align="center">Invoice No</th>
					<th width="80px" align="center">Warranty No</th>
					<th width="80px" align="center">Time</th>
					<th width="290px">Customer</th>
				</tr>
				<?php
					$inv=0;
					for($i=0;$i<sizeof($w_invno);$i++){
						print '<tr>
								<td align="center"><a style="display:block;" target="_blank" href="index.php?components=billing&action=finish_bill&id='.$w_invno[$i].'">'.str_pad($w_invno[$i], 7, "0", STR_PAD_LEFT).'</a></td>
								<td align="center"><a style="display:block;" target="_blank" href="index.php?components=billing&action=warranty_show&id='.$w_no[$i].'">'.str_pad($w_no[$i], 7, "0", STR_PAD_LEFT).'</a></td>
								<td width="50px" align="center">'.$w_time[$i].'</td>
								<td>&nbsp;&nbsp;'.$w_cust_name[$i].'</td>
							</tr>';
					}
				?>	
