...
<tr><td width="300px" valign="top">
	...
	<tr><td>
		...
		<?php for($i=0;$i<sizeof($bm_no);$i++){
			...
			print '<tr bgcolor="'.$color.'"><td align="center"><a style="text-decoration:none" href="index.php?components=billing&action=finish_bill&id='.$bm_no[$i].'">'.str_pad($bm_no[$i], 7, "0", STR_PAD_LEFT).'</a></td><td align="right" class="shipmentTB4">'.$bm_total[$i].'</td><td align="center" style="color:'.$status_color[$i].'">'.$status_out[$i].'</td><td align="center">'.$bm_store[$i].'</td></tr>';
		} ?>
		</table>
	</td></tr>
	</table>
