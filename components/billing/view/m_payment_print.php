...
<!-- ------------------------------------------------------------------------------------ -->
<?php
 include_once  'components/billing/view/tpl/pos_payment.php';
?>
  ...
  <div class="w3-col">
	...
	<tr><td>
		  ...
		  <tr><td><?php print $tm_company; ?><br />
			...
			?>
			<tr><td>&nbsp;&nbsp;Amount<br/>&nbsp;&nbsp;[<?php print $payment_type_n; ?>]</td><td><?php print 'Rs. '.number_format($amount); ?></td></tr>
	...
	<?php } ?>
			...
			<?php
			if($systemid==17){
				print '<tr><td>&nbsp;&nbsp;Cust.Tax No</td><td >'.$cu_nickname.'</td></tr>';
			} ?>
			<tr><td>&nbsp;&nbsp;Signature</td><td></td></tr>
