...
<table align="center" style="font-size:11pt"><tr><td style="vertical-align:top;" align="center">
	<h3 class="style2" >Customer Payment</h3>
		...
		<?php } ?>
		<?php	if(isset($_GET['cust'])){ ?>
		<tr><td></td><td style="font-size:12pt" width="120px">Invoice No</td><td><input type="text" name="invoice_no" id="invoice_no" /></td><td><input type="button" value="check" onclick="validateInvoice()" /></td><td><div id="invoice_div"></div></td></tr>
