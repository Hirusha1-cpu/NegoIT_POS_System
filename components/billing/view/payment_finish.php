...
<?php
 ...
 if($tm_template==17) print '<iframe id="invoice_iframe" width="250px" height="710px" src="components/billing/view/tpl/payment_print17.php?id='.$_GET['id'].'"></iframe>';
 if($tm_template==18) print '<iframe id="invoice_iframe"  width="'.$page_width.'px" height="540px" src="components/billing/view/tpl/payment_print18.php?id='.$_GET['id'].'"></iframe>';
?>
...
<?php if($py_status==0){
		if($paymentpermission){ ?>
				...
				<a class="shortcut-button" onclick="deletePayment(<?php print $_GET['id']; ?>,'billing')" href="#"><span style="text-decoration:none; font-family:Arial; color:navy;">
