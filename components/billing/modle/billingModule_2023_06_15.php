...
// updated by nirmal 18_03_2022 (add module(=1) column)
		...
		if($_COOKIE['district']!=0){
			...
			if($cust_odr=='yes'){ $bm_status=1; $bm_type=4; }
				...
				*/
				...
				`sub_system`,`status`)
				VALUES ((SELECT MAX(b2.invoice_no)+1 FROM bill_main b2),'$orderhash','$authorize_code','$district','$quot_no','1','$cust',
...
//  edit by nirmal 11-03-2023
function generatePayment(){
	global $systemid,$tm_shop,$tm_company,$tm_address,$tm_tel,$payment_id,$cust_id,$cust_name,$payment_type,$amount,$chque_no,$chque_bank,$chque_bank_code,$chque_branch,$chque_date,$salesman,$payment_date,$invoice_no,$comment,$payment_type_n,$bank_trans,$cu_mobile,$cu_nic,$cu_nickname,$print_time, $payment_time,$payment_cust_address;
