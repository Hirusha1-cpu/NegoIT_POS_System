		...
		<div class="w3-col">
            ...
            <form id="search_form" action="index.php?components=<?php print $components; ?>&action=set_qo_terms&id=<?php print $_GET['id']; ?>" method="post" onsubmit="return validateQoTerms()">
                <table align="center" style="font-family:Calibri; font-size:11pt" >
                    ...
                    <tr>
                        <td><strong><?php if($systemid == 13) print 'Project Duration'; else print 'Lead Time'; ?></strong></td>
                        <td style="padding-right:30px">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea id="note" name="note" style="width:100%" rows="3" ><?php if($tm_note!='') print $tm_note; ?></textarea>
                        </td>
                    </tr>
                    <tr>
