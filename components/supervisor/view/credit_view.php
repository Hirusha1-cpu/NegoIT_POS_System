...
<form action="index.php?components=<?php print $components; ?>&action=credit" method="post">
	<table border="0" width="900px" align="center" height="100%" cellspacing="0"
		...
		<tr>
			<td align="center"><strong>Display</strong>&nbsp;&nbsp;&nbsp;
				<select id="display" onchange="filter();">
					<option value="1" <?php if ($display_cr == 1)
						print 'selected="selected"'; ?>>-ALL-</option>
					<option value="2" <?php if ($display_cr == 2)
						print 'selected="selected"'; ?>>Outstanding Cust</option>
				</select>
				<?php if ($components == 'topmanager' || $components == 'report') { ?>
				</td>
				<td width="30px">
				<td align="center"><strong>Sub System</strong>&nbsp;&nbsp;&nbsp;
				...
				<?php } else {
					print '<input type="hidden" id="sub_system" value="' . $sub_system . '" />';
				} ?>
			</td>
			<td width="30px"></td>
			<td align="center" style="<?php if ($systemid == 24)
				echo 'display:none' ?>"><strong>Asso.
						Shop/Store</strong>&nbsp;&nbsp;&nbsp;
			...
			<td width="30px"></td>
			<?php if ($components == 'report' || $components == 'supervisor' || $components == 'manager' || $components == 'topmanager' || (($systemid == 24) && ($components == 'bill2'))) { ?>
		...
		<tr>
			<td colspan="8"><br> &nbsp;&nbsp;&nbsp;Note: This report shows the amount of Credit per Customer (Unrealized
				cheques are excluded)
				<hr />
			</td>
			<td colspan="3"><strong>As of</strong>&nbsp;&nbsp;&nbsp;<input type="date" name="as_of" id="as_of"
					value="<?php print $as_of; ?>" onchange="filter();" /></td>
		</tr>
	</table>
</form>
...
<div id="printheader" style="display:none">
	...
	<table style="font-size:12pt" border="1" cellspacing="0">
		<tr>
			...
			<td style="background-color:#EEEEEE; padding-left:10px">&nbsp;&nbsp;<?php print $store_report; ?>&nbsp;&nbsp;</td>
		</tr>
		<tr>
			<td style="background-color:#C0C0C0; padding-left:10px">&nbsp;&nbsp;Group &nbsp;&nbsp;&nbsp;</td>
			<td style="background-color:#EEEEEE; padding-left:10px">&nbsp;&nbsp;<?php print $group_report; ?>&nbsp;&nbsp;</td>
		</tr>
		<tr>
			<td style="background-color:#C0C0C0; padding-left:10px">&nbsp;&nbsp;Associated Salesman &nbsp;&nbsp;&nbsp;</td>
			<td style="background-color:#EEEEEE; padding-left:10px">&nbsp;&nbsp;<?php print $salesman_report; ?>&nbsp;&nbsp;
			</td>
		</tr>
	</table><br />
	<p>Note: This report shows the amount of Credit per Customer</p>
	<hr>
</div>
...
<div id="print">
	<table align="center" height="100%" border="1" cellspacing="0" style="font-size:10pt; font-family:Calibri">
		...
		<tr bgcolor="#E5E5E5">
			...
			?>
			<th width="100px" title="Calculation of 'Up to Now'&#13;Invoice Total - Cash Payments - All Chque Payments">Up to
				Now</th>
		</tr>
		<?php
		// updated by nirmal 21_07_2023
		$increment = 1;
				...
				if ($display_cr == 2) {
					...
					if ($out) {
						print '<tr bgcolor="#F5F5F5">
							<td style="padding-right:10px; padding-left:10px" align="center">' . sprintf('%02d', ($increment)) . '</td>
							<td style="padding-right:10px; padding-left:10px">' . ucfirst($cust_name[$i]) . '</td>';
