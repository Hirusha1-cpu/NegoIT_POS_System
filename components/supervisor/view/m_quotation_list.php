...
<div class="w3-container" style="margin-top:75px">
	...
	<div class="w3-row">
		...
		<div class="w3-col">
					...
					<table border="0" align="center" height="100%" cellspacing="0" style="font-size:10pt; font-family:Calibri; border-radius: 15px;" bgcolor="#F0F0F0">
						<tr>
							...
							<td align="center" rowspan="2">
								<table>
									<tr>
										...
										<td><input type="text" id="cust" name="cust" value="<?php print $cust; ?>" /></td>
									</tr>
									<tr>
										<td><strong>Item</strong></td>
										<td><input type="text" id="item0" value="<?php print $item0; ?>" /></td>
									</tr>
									<tr>
										<td><strong>Shop/Store</strong></td>
										<td>
											<select id="st" name="st" onchange="submitQForm()">
												<option value="">-ALL-</option>
												<?php for($i=0;$i<sizeof($store_id);$i++){
														if($store1==$store_id[$i]){
							...
							<td width="30px" rowspan="2">
								<a onclick="submitQForm()" style="cursor:pointer">
						...
						<tr>
							...
							<td width="30px"></td>
							<td style="color:maroon" align="center" rowspan="2">
								<?php
			...
			<br />
			<table align="center" align="center" height="100%" width="100%" style="font-size:10pt; font-family:Calibri;max-width: fit-content;overflow-x: auto;display: block;">
				<tr>
