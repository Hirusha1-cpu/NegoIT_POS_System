...
<table width="100%" >
<tr><td rowspan="2" style="font-family:Calibri; font-size:11pt; vertical-align:top"><img src="../../../../images/cplogo<?php print $systemid; ?>.png" height="33px" />
...
<tr><td width="50px"><?php print '<a href="../../../../index.php?components=billing&action=cust_details&id='.$qo_cust_id.'&action2=qo_finish&id2='.$_GET['id'].'" target="_parent" title="'.$cu_details.'" style="text-decoration:none; color:black" >'.ucfirst($qo_cust_name).'</a>,<br />'.$qo_cust_address; ?></td></tr>
</table>
</td><td></td><td align="right"><br /><br /><span style="font-family:'Arial Black'; font-size:18pt"><em><?php print $q_title; ?></em></span><br /></td></tr>
<tr><td></td><td align="right" style="font-family:Calibri; font-size:12pt">
	<table style="font-family:Calibri; font-size:12pt" cellspacing="">
	<tr><td>DATE</td><td> : </td><td align="right"><?php print $qo_date; ?></td></tr>
	<tr><td><?php print $q_number; ?></td><td> : </td><td align="right"><?php print $q_inv_code.str_pad($quot_no, 7, "0", STR_PAD_LEFT); if($qo_v>1) print 'R'.($qo_v-1); ?></td></tr>
	<tr><td>Created By</td><td> : </td><td align="right"><?php print ucfirst($qo_salesman); ?></td></tr>
	</table>
</td></tr>
</table>
...
<br />
	...
	<tr style="font-family:Arial; font-size:10pt; color:white; background-color:black; -webkit-print-color-adjust: exact;" ><th width="30px">#</th><th height="20px">DESCRIPTION</th><th width="60px">QTY</th><th width="80px">UNIT <br />PRICE</th><th width="100px" >TOTAL</th></tr>
<?php
	$total_discount=0;
	for($i=0;$i<sizeof($qi_item_des);$i++){
		print '<tr style="font-size:10pt; vertical-align:top" height="20px">
			<td align="center" style="border-bottom:0; border-top:0;"><div id="id_'.$i.'">'.($i+1).'</div></td><td style="border-bottom:0; border-top:0;"><div id="des_'.$i.'">&nbsp;&nbsp;&nbsp;&nbsp;'.$qi_item_des[$i].'<br />&nbsp;&nbsp;&nbsp;&nbsp;'.$qi_item_code[$i].'</div><div id="comm_'.$i.'">';
		if($qi_comment[$i]!='') print '&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-family:Calibri; font-weight:900;">'.$qi_comment[$i].'</span>';
		print '</div><br /></td><td style="border-bottom:0; border-top:0;" align="right"><div id="qty_'.$i.'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.number_format($qi_qty[$i]).'&nbsp;&nbsp;</div></td><td width="50px" style="border-bottom:0; border-top:0;" align="right"><div id="uprice_'.$i.'">'.number_format($qi_uprice[$i],2).'&nbsp;&nbsp;</div></td><td align="right" style="border-bottom:0; border-top:0;"><div id="tprice_'.$i.'">'.number_format($qi_qty[$i]*$qi_uprice[$i],2).'&nbsp;&nbsp;</div></td></tr>';
	...
	if($qo_image==1){
		...
		print '<tr style="font-family:Arial; font-size:10pt; font-weight:600; color:white; background-color:black; -webkit-print-color-adjust: exact;"><td colspan="4" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:0; ">Total Amount &nbsp;&nbsp; Rs. </td><td align="right"><div id="total">'.number_format($total,2).'&nbsp;&nbsp;</div></td></tr>';	
...
?>	
	...
	<?php if($qo_warranty!='0') print '<tr><td style="vertical-align:top" width="120px"><strong>Warranty</strong></td><td>'.$qo_warranty.' Months Warranty</td></tr>'; ?>
...
<?php } ?>
	...
	<tr><td align="center"><?php print  $qo_st_name.', '.str_replace(",<br />",", ",$qo_st_add); ?></td></tr>
	</table>
