...
<table align="center" height="<?php print $page_height; ?>px" width="100%" border="1" cellspacing="0" border="1" >
	...
	<?php
		...
		if(($components != 'to')){
            ...
            if(($tax != '') && ($tax != 0)) {
				// vat
				print '<tr style="font-family:Calibri; font-size:11pt; font-weight:900; color:white; background-color:black; -webkit-print-color-adjust: exact;"><td colspan="4" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:0; border-top:0;">Value Added Tax '.$tax.'%</td><td align="right" style="border-bottom:0;">'.number_format($tax_added_value,$decimal).'&nbsp;&nbsp;</td></tr>';
			}

			print '<tr style="font-family:Arial; font-size:10pt; font-weight:600; color:white; background-color:black; -webkit-print-color-adjust: exact;">
					<td colspan="4" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:0; border-top:0;">Total Amount &nbsp;&nbsp; '.$currency.' </td>
					<td align="right" style="border-bottom:0;">
						<div id="total">'.number_format(($total+$tax_added_value),$decimal).'&nbsp;&nbsp;</div>
					</td>
				</tr>';
			...
			if($qo_discount > 0){
				print '<tr
				    ...
				    <td colspan="4" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:0; border-top:0;">
				        '.round(((($qo_discount)*100)/($total-$total_discount)),2).'% Discount &nbsp;&nbsp; '.$currency.' </td>
