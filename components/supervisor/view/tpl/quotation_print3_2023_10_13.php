	...
	<tr>
		<td rowspan="2" style="font-family:Calibri; font-size:11pt; vertical-align:top">
			...
			<table width="100%" style="font-family:Calibri; font-size:12pt" cellspacing="0">
				...
				<tr>
					<td width="50px"><?php print '<a href="../../../../index.php?components='.$bill_module.'&action=cust_details&id='.$qo_cust_id.'&action2=qo_finish&id2='.$_GET['id'].'" target="_parent" title="'.$cu_details.'" style="text-decoration:none; color:black" >'.ucfirst($qo_cust_name).'</a>,<br />'.$qo_cust_address; ?>
				</td>
				</tr>
			</table>
		</td>
