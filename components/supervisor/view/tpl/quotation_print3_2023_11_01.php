	...
	<?php
		...
		if(($components != 'to')){
			...
			if($qo_discount > 0){
				...
				<td align="right">'.number_format($qo_discount,$decimal).'&nbsp;&nbsp;</td>
				</tr>';
			}
			if($qo_discount > 0){
				print '<tr style="font-family:Arial; font-size:10pt; font-weight:600; color:white; background-color:black; -webkit-print-color-adjust: exact;">
					...
					<td align="right">'.number_format($total-$qo_discount,$decimal).'&nbsp;&nbsp;</td>
				</tr>';
			}
		}
...
<table cellspacing="0"  style="font-size:11pt; font-family:Calibri" >
	...
	<?php if($action=='qo_finish'){ ?>
		...
		<?php
			if($qo_leadtime!=''){
				if($systemid == 13) $lead_time_text = 'Project Duration'; else $lead_time_text = 'Lead Time';
				print '<tr>
