	...
	<div class="w3-row">
		<div class="w3-col">
			...
			<table align="center" style="font-family:Calibri">
									...
									<div>
										...
										<?php
											if($tm_template==1 || $tm_template==2 ){
												print '<iframe id="quot_iframe" src="components/supervisor/view/tpl/quotation_print2.php?id='.$_GET['id'].'&action='.$action.'"></iframe>';
											}else if($tm_template==3 || $tm_template==4 || $tm_template==5 || $tm_template==6) {
												print '<iframe id="quot_iframe" src="components/supervisor/view/tpl/quotation_print3.php?id='.$_GET['id'].'&action='.$action.'&sub_components='.$components.'"></iframe>';
											}else{
												print '<iframe id="quot_iframe" src="components/supervisor/view/tpl/quotation_print1.php?id='.$_GET['id'].'&action='.$action.'"></iframe>';
											}
										?>
									</div>
								</td>
				...
				<tr>
					<td valign="top" align="center" style="  display: flex; flex-direction: column; flex-wrap: wrap; max-height: 150px;">
						<?php
							if(($qm_status==2 && $approver) && ($components != 'to')){ ?>
