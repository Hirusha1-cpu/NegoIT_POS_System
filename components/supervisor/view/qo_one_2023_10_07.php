	...
	if(isset($_REQUEST['message'])){
		if($_REQUEST['re']=='success') $color00='green'; else $color00='#DD3333';
			print '<script type="text/javascript">
					document.getElementById("notifications").innerHTML='."'".'<span style="color:'.$color00.'; font-weight:bold;font-size:12pt;">'.$_REQUEST['message'].'</span>'."'".';
			</script>';
	}
?>

<div id="loading" style="display:none">
	<img src="images/loading.gif" style="width:70px" /><br>
	<span style="color:maroon; vertical-align:middle">Please Wait</span>
</div>
...
<input type="hidden" id="quot_no" value="<?php print $_GET['id']; ?>" />
<table align="center" style="font-family:Calibri">
	<tr>
		<!-- -------------------------------- Left Side Panel Start -------------------------------- -->
		<td valign="top">
			<div id="details_link">
				<a style="cursor:pointer; color:blue" onclick="showHideDetails()">
			...
			<div id="details_div" style="display:none">
				<table align="center" style="font-size:11pt; font-family:Calibri" >
					<tr>
						...
						<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print $main_sub_system; ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print substr($main_created_date,0,16); ?></td>
					</tr>
					<tr>
						<td style="background-color:#467898; color:white;" class="shipmentTB4">Generated By</td>
						<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print ucfirst($main_created_by); ?></td>
					</tr>
					<tr>
						<td style="background-color:#467898; color:white;" class="shipmentTB4">Processed Date</td>
						<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print substr($main_approved_date,0,16); ?>
						</td>
					</tr>
					<tr>
						<td style="background-color:#467898; color:white;" class="shipmentTB4">Processed By</td>
						<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print ucfirst($main_approved_by); ?>
						</td>
					</tr>
					<tr>
						<td style="background-color:#467898; color:white;" class="shipmentTB4">Submited Date</td>
						<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print substr($main_submited_date,0,16); ?></td>
					</tr>
					<tr>
						<td style="background-color:#467898; color:white;" class="shipmentTB4">Submited By</td>
						<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print ucfirst($main_submited_by); ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print ucfirst($main_deleted_by); ?></td>
					</tr>
					<tr>
						<td style="background-color:#467898; color:white;" class="shipmentTB4">
							<a style="text-decoration:none; color:white; cursor:pointer" title="Once selected, only the fist comment in the item list will be shown.&#013;The QTY will be '1' and Unit price will shown as a total.">Once Description Mode</a>
						</td>
						<td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><input type="checkbox" id="onemode" onchange="oneDescriptionMode()" /></td>
					</tr>
					<?php
						if($qm_status==5){
			...
			<table align="center" style="font-size:11pt" >
				<tr>
					<td bgcolor="#467898" style="font-family:Calibri; color:white; padding-left:10px">
						Quotation Status : <span <?php if($status=='Deleted') print 'class="blink"'; ?> style="color:<?php print $color; ?>;"><strong><?php print $status; ?></strong></span>
					</td>
					<td></td>
				</tr>
				<tr>
					<td valign="top">
						<!-- --------------------------------Quotation Item List Start-------------------------------- -->
						<table>
						...
						<table align="center" width="100%" border="1" cellspacing="0" border="1" >
							<tr style="font-family:Arial; font-size:10pt; color:white; background-color:black; -webkit-print-color-adjust: exact;">
								...
								<th class="shipmentTB3">ORDER<br/>QTY</th>
								<th class="shipmentTB3">DELIVERED<br />QTY</th>
							</tr>
							<?php
								$total_discount=0;
								for($i=0;$i<sizeof($qi_item_des);$i++){
									print '<tr style="font-size:10pt; vertical-align:top" height="20px">
											<td align="center" style="border-bottom:0; border-top:0; padding-top: 6px;">
												<div id="id_'.$i.'">'.($i+1).'</div>
											</td>
											<td style="border-bottom:0; border-top:0; padding-top: 6px;">
										...
										print '</div>
											...
											<td style="border-bottom:0; border-top:0; padding-top: 6px;" align="right" '.$color1.'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.number_format($qi_qty[$i]).'&nbsp;&nbsp;</td>
											<td width="50px" style="border-bottom:0; border-top:0; padding-top: 6px;" align="right" '.$color1.'>'.number_format($qi_filled_qty[$i]).'&nbsp;&nbsp;</td>
										</tr>';
										$total_discount+=$qi_qty[$i]*$qi_discount[$i];
								}
								print
									'<tr style="font-family:Arial; font-size:10pt; font-weight:600; color:white; background-color:black; -webkit-print-color-adjust: exact;">
										<td colspan="5" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:0; ">&nbsp</td>
									</tr>';
							?>
						</table>
						<!-- --------------------------------Quotation Item List End-------------------------------- -->
					</td>
					<td width="20px"></td>
					<td valign="top" align="center">
						...
						for($i=0;$i<sizeof($bm_no);$i++){ ?>
							...
							<div id="button_div1" style="background-color:#6699FF; border:medium; border-color:black; width:80px; border-radius: 15px; font-size:10pt">
								<a class="shortcut-button" href="index.php?components=<?php print $bill_module; ?>&action=finish_bill&id=<?php print $bm_no[$i]; ?>" style="text-decoration:none;">
									<span style="text-decoration:none; font-family:Arial; color:navy;">
										Order-In-Place<br /><br />
