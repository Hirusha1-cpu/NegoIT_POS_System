						...
						'<tr bgcolor="'.$row_color.'">
							...
							<td align="center">
								<div id="col1_'.$qm_id[$i].'">
									<a href="index.php?components='.$components.'&action='.$action0.'&id='.$qm_id[$i].'" title="Name: '.$qm_custname[$i].'Mobile: '.$qm_mobile[$i].'Tel: '.$qm_tel[$i].'">'.str_pad($qm_id[$i], 7, "0", STR_PAD_LEFT).'
									</a>
								</div>
							</td>
							<td align="center">
							...
							<td class="shipmentTB3" align="right">
								<div id="col7_'.$qm_id[$i].'">'.number_format($qm_amount[$i]).'</div></td>
							<td align="right" class="shipmentTB3" >
