...
<table align="center" style="font-family:Calibri"><tr><td valign="top"><div id="details_link"><a style="cursor:pointer; color:blue" onclick="showHideDetails()"><strong>+ Show Details</strong></a></div>
	...
	<!-- ------------------Item List----------------------- -->
	<?php
	// if($tm_template==1 || $tm_template==2) print '<iframe id="quot_iframe" width="'.$page_width.'px" height="'.$page_height.'px" src="components/supervisor/view/tpl/quotation_print1.php?id='.$_GET['id'].'"></iframe>';
	 if($tm_template==1 || $tm_template==2 ){ print '<iframe id="quot_iframe" width="'.$page_width.'px" height="'.$page_height.'px" src="components/supervisor/view/tpl/quotation_print2.php?id='.$_GET['id'].'&action='.$action.'"></iframe>';
	 }else if($tm_template==3 || $tm_template==4 || $tm_template==5 || $tm_template==6) {	print '<iframe id="quot_iframe" width="'.$page_width.'px" height="'.$page_height.'px" src="components/supervisor/view/tpl/quotation_print3.php?id='.$_GET['id'].'&action='.$action.'"></iframe>';
	 }else{ print '<iframe id="quot_iframe" width="'.$page_width.'px" height="'.$page_height.'px" src="components/supervisor/view/tpl/quotation_print1.php?id='.$_GET['id'].'&action='.$action.'"></iframe>'; }
	?>
	...
	<?php } else if($qm_status==3 || $qm_status==5 || $qm_status==6){ ?>
					...
					<a class="shortcut-button" style="text-decoration:none; font-family:Arial; color:white;" onclick="print_quot(<?php print $_GET['id']; ?>)" href="#">
	...
	<br />
		...
		<?php }else if($qm_status==6 || $qm_status==7){ 
						if($qm_status==6){?>
							<div id="button_div1" class="prtbutton1">
							<?php if($systemid==15){ 
								print '<a class="shortcut-button" target="_blank" href="index.php?components=bill2&action=new_tmp_bill3&quotation='.$_GET['id'].'&cust_odr=no&cust_id='.$qm_cust.'&sm_id='.$qm_created_by.'" style="text-decoration:none;">';
							}else{
								print '<a class="shortcut-button" target="_blank" href="index.php?components=billing&action=new_bill&quotation='.$_GET['id'].'&cust_odr=yes&cust_id='.$qm_cust.'&salesman='.$qm_created_by.'" style="text-decoration:none;">';
							}
							?>
	...
	<?php if($action=='qo_finish' && $qm_status==8){ ?>
					<div style="background-color:#6699FF; border:medium; border-color:black; width:80px; border-radius: 15px; font-size:10pt">
					<a class="shortcut-button" style="text-decoration:none;" target="_blank" href="index.php?components=<?php print $components; ?>&action=qo_com_inv&id=<?php print $_GET['id']; ?>">
