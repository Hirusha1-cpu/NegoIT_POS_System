        ...
        <div class="w3-col">
            ...
            <form id="search_form"
                ...
                <table align="center" style="font-family:Calibri; font-size:11pt">
                    ...
                    <tr>
                        <td><strong><?php if ($systemid == 13)
                            print 'Project Duration';
                        else
                            print 'Lead Time'; ?></strong>
                        </td>
                        <td style="padding-right:30px">
                            <input type="text" name="leadtime" id="leadtime"
                                value="<?php if ($tm_leadtime != '')
                                    print $tm_leadtime;
                                else
                                    print $qo_leadtime; ?>" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="padding-right:30px">
                            ...
                            <br />
                            <textarea id="terms1" name="terms1" style="width:170px"
                                rows="5"><?php if ($tm_terms1 != '')
                    ...
                    <tr>
                        <td style="vertical-align:top;"><strong>Payment Terms</strong></td>
                        <td>
                            <textarea id="terms2" name="terms2" style="width:170px"
                                rows="5"><?php if ($tm_terms2 != '')
                        ...
                        <td>
                            <select id="from_add" name="from_add" onchange="showAddress()">
                                ...
                                <option value="1" <?php if ($tm_address == 1)
                                    print 'selected="selected"'; ?>>Store Address
                                </option>
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <div id="finalyze"><input type="submit" value="Finalyze" style="width:100px; height:40px" />
                            </div>
                        </td>
                    </tr>
                </table>
