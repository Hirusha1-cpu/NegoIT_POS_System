...
<script type="text/javascript">
	function filter(){
		...
		window.location = 'index.php?components=<?php print $components; ?>&action=credit&st='+$store+'&gp='+$group+'&up='+$salesman+'&display='+$display+'&sub_system='+$sub_system+'&as_of='+$as_of;
	}
</script>

<form action="index.php?components=<?php print $components; ?>&action=credit" method="post">
	<table width="900px" align="center" height="100%" cellspacing="0" style="font-size:10pt; font-family:Calibri; border-radius: 5px;" bgcolor="#F0F0F0">
	...
	<tr><td colspan="6"><br> &nbsp;&nbsp;&nbsp;Note: This report shows the amount of Credit per Customer (Unrealized cheques are excluded) <hr /></td>
...
<div id="printheader" style="display:none" >
	...
	<h2 align="center" style="color:#3333FF; text-decoration:underline">Credit Report</h2>
