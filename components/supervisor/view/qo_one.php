				...
				<tr>
					<td valign="top">
						...
						<table align="center" width="100%" border="1" cellspacing="0" border="1" >
							<tr style="font-family:Arial; font-size:10pt; color:white; background-color:black; -webkit-print-color-adjust: exact;">
								<th width="30px" class="shipmentTB3">#</th>
								<th class="shipmentTB3">DESCRIPTION</th>
								<th class="shipmentTB3">ORDER<br/>QTY</th>
								<th class="shipmentTB3">TEMP INVOICED<br/>QTY</th>
								<th class="shipmentTB3">INVOICED<br/>QTY</th>
								<th class="shipmentTB3">DELIVERED<br />QTY</th>
							</tr>
							<?php
								$total_discount=0;
								for($i=0;$i<sizeof($qi_item_des);$i++){
									print '<tr style="font-size:10pt; vertical-align:top">
											<td align="center" style="border-bottom:0; border-top:0; padding:5px;">
												<div id="id_'.$i.'">'.($i+1).'</div>
											</td>
											<td style="border-bottom:0; border-top:0; padding:5px;">
												<div id="des_'.$i.'">'.$qi_item_des[$i].'<br />'.$qi_item_code[$i].'</div>
												<div id="comm_'.$i.'">';
													if($qi_comment[$i]!='') print '<span style="font-family:Calibri; font-weight:900;">'.html_entity_decode($qi_comment[$i]).'</span>';
													if($qi_qty[$i]==$qi_filled_qty[$i]) $color1='bgcolor="#FFA500"'; else $color1='';
										print '</div>
												<br />
											</td>
								...
								print
									'<tr style="font-family:Arial; font-size:10pt; font-weight:600; color:white; background-color:black; -webkit-print-color-adjust: exact;">
										<td colspan="6" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:0; ">&nbsp</td>
									</tr>';
							?>
						</table>
					...
					<td valign="top" align="center">
						...
						for($i=0;$i<sizeof($bm_no);$i++){ ?>
							<br />
							<div id="button_div1" style="background-color:#6699FF; border:medium; border-color:black; width:75px; border-radius: 15px; font-size:10pt; padding: 5px;">
						...
						<?php }
						for($i=0;$i<sizeof($qi_tmp_invoice_no);$i++){ ?>
							<br />
							<div id="button_div1" style="background-color:#999999; border:medium; border-color:black; width:75px; border-radius: 15px; font-size:10pt; padding: 5px;">
								<a class="shortcut-button" href="index.php?components=<?php print $bill_module; ?>&action=bill_item&cust_odr=yes&bill_no=<?php print $qi_tmp_invoice_no[$i]; ?>" style="text-decoration:none;">
									<span style="text-decoration:none; font-family:Arial; color:black;">
										Temp QO Bill<br /><br />
										<span style="color:white;">
										<?php print str_pad($qi_tmp_invoice_no[$i], 7, "0", STR_PAD_LEFT); ?>
										</span>
									</span>
								</a>
							</div>
