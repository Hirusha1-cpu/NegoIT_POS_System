...
<input type="hidden" id="term_5_1" value='All payments should be settled by cheque in favor of "<strong><?php print $sys_comp_name; ?></strong>"' />
<input type="hidden" id="term_5_2" value='* 60% Should be paid when confirmation the job and rest 40% should be settled when Finished the job.' />
<input type="hidden" id="term_6_1" value='All payments should be settled by cheque in favor of "<strong><?php print $sys_comp_name; ?></strong>"' />
<input type="hidden" id="term_6_2" value='* Please confirm the job officially and the total amount should be settled when completed the job.' />
	...
	<table align="center" style="font-family:Calibri; font-size:11pt" >
		<tr bgcolor="#EEEEEE">
			...
			<td style="padding-right:30px">
				<input type="text" name="att" value="<?php if($tm_att!='') print $tm_att; else print 'M/S'; ?>" onclick="this.value=''" />
			</td>
			<td width="100px"></td>
			<td style="padding-left:30px"><strong>Heading</strong></td>
			<td style="padding-right:30px">
				<input type="text" name="heading" value="<?php if($tm_heading!='') print $tm_heading; ?>" />
			</td>
		</tr>
		<tr bgcolor="#EEEEEE">
			<td style="padding-left:30px"><strong>Warranty</strong></td>
			<td style="padding-right:30px">
				<input type="number" name="warranty" id="warranty" value="<?php if($tm_warranty!='') print $tm_warranty; else print $qo_warranty; ?>" placeholder="Number of Months" />
			</td>
			<td></td>
			<td style="padding-left:30px"><strong>Validity</strong></td>
			<td style="padding-right:30px">
				<input type="number" name="validity" id="validity" value="<?php if($tm_validity!='') print $tm_validity; else print $qo_validity; ?>" placeholder="Number of Days" />
			</td>
		</tr>
		<tr bgcolor="#EEEEEE">
			<td style="padding-left:30px"><strong><?php if($systemid == 13) print 'Project Duration'; else print 'Lead Time'; ?></strong></td>
			<td style="padding-right:30px">
				<input type="text" name="leadtime" id="leadtime" value="<?php if($tm_leadtime!='') print $tm_leadtime; else print $qo_leadtime; ?>" />
			</td>
			<td></td>
			<td></td>
			<td></td>
		...
		<tr bgcolor="#EEEEEE">
			...
			<td>
				<br />
				<textarea id="terms2" name="terms2" style="width:170px" rows="5" ><?php if($tm_terms2!='') print $tm_terms2; ?></textarea>
				<br />
		...
		<tr bgcolor="#EEEEEE">
			...
			<td style="padding-right:30px" colspan="4">
				<textarea id="note" name="note" style="width:570px" rows="3" ><?php if($tm_note!='') print $tm_note; ?></textarea>
			</td>
		</tr>
		<tr bgcolor="#EEEEEE">
		...
		<tr bgcolor="#EEEEEE">
			<td colspan="5" align="center">
				<div id="finalyze"><input type="submit" value="Finalyze" style="width:100px; height:40px" /></div>
			</td>
		</tr>
	</table>
</form>
