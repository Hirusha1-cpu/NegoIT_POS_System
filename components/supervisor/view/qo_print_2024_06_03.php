...
<style>
	...
	.checkbox-container input[type="checkbox"] {
		...
		transform: scale(1.5); /* Increase the size by scaling */
	}
...
<script type="text/javascript">
	...
	function print_quot($id){
		...
		<?php } ?>
		<?php if($systemid == 13){ ?>
			var checkbox = document.getElementById("show_tax_quot");
			if (checkbox.checked) {
...
<div id="loading" style="display:none">
	<img src="images/loading.gif" style="width:70px" /><br><span style="color:maroon; vertical-align:middle">Please Wait</span>
</div>
...
<table align="center" style="font-family:Calibri">
	<tr>
		<td valign="top">
			...
			<div>
				<table cellspacing="0">
					<tr><td style="font-weight:bold; color:#467898">Discount estimates</td></tr>
					<tr>
						<td>
							<table border="0" bordercolor="#C0C0C0" bgcolor="#EEEEEE" cellspacing="0" width="300px">
								<tr>
						...
						<?php
							if($tm_template==1 || $tm_template==2 ){
								...
								if($systemid == 13){ // techneeds tax invoice
									print '<iframe id="quot_iframe_3" width="'.$page_width.'px" height="'.$page_height.'px" src="components/supervisor/view/tpl/quotation_print3_2.php?id='.$_GET['id'].'&action='.$action.'&sub_components='.$components.'" style="display:none;"></iframe>';
								}
							}else{
					...
					<td valign="top" align="center">
						<?php if($systemid == 13){ ?>
							...
							<div class="checkbox-container prtbutton3">
								<input type="checkbox" id="show_tax_quot">
								<label for="show_tax_quot">Show Tax Quot</label>
							</div>
							<br>
						<?php } ?>
						<?php if((($qm_status==2 || $qm_status==1) && $approver) && ($components != 'to')){ ?>
								...
								<div id="button_div2" class="prtbutton1">
									<a class="shortcut-button" style="text-decoration:none;" onclick="editQuot(<?php print $_GET['id']; ?>,<?php print $qm_created_by; ?>,<?php print $qm_cust; ?>)" href="#">
										<span style="text-decoration:none; font-family:Arial; color:navy;">
						...
						<?php }else if(($qm_status==6 || $qm_status==7) && ($components != 'to')){
								if(($qm_status==6)){?>
									...
									<a class="shortcut-button" href="index.php?components=<?php print $bill_module; ?>&action=finish_bill&id=<?php print $bm_no[$i]; ?>" style="text-decoration:none;" target="_blank">
									<span style="text-decoration:none; font-family:Arial; color:navy;">
...
<script>
<?php if($systemid == 13){ ?>
	document.getElementById("show_tax_quot").addEventListener("change", function() {
		var checkbox = document.getElementById("show_tax_quot");
		if (checkbox.checked) {
			document.getElementById("quot_iframe").style.display = "none";
			document.getElementById("quot_iframe_3").style.display = "block";
		} else {
			document.getElementById("quot_iframe_3").style.display = "none";
			document.getElementById("quot_iframe").style.display = "block";
		}
	});
<?php } ?>
</script>