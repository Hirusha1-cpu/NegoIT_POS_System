...
<?php 
	if(isset($_REQUEST['message'])){
		if($_REQUEST['re']=='success') $color00='green'; else $color00='#DD3333';
...
<div id="loading2" style="display:none"><img src="images/loading.gif" style="width:40px" /></div>
...
<table align="center" style="font-family:Calibri"><tr><td valign="top"><div id="details_link"><a style="cursor:pointer; color:blue" onclick="showHideDetails()"><strong>+ Show Details</strong></a></div>
	...
	<tr><td style="background-color:#467898; color:white;" class="shipmentTB4">Pricing District</td><td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print $main_district; ?></td></tr>
	<tr><td style="background-color:#467898; color:white;" class="shipmentTB4">Quotation Store</td><td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print $main_store; ?></td></tr>
	...
	<tr><td style="background-color:#467898; color:white;" class="shipmentTB4">Quotation Type</td><td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print $main_type; ?></td></tr>
	<tr><td style="background-color:#467898; color:white;" class="shipmentTB4">Generated Date</td><td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print substr($main_created_date,0,16); ?></td></tr>
	<tr><td style="background-color:#467898; color:white;" class="shipmentTB4">Generated By</td><td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print ucfirst($main_created_by); ?></td></tr>
	<tr><td style="background-color:#467898; color:white;" class="shipmentTB4">Processed Date</td><td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print substr($main_approved_date,0,16); ?></td></tr>
	<tr><td style="background-color:#467898; color:white;" class="shipmentTB4">Processed By</td><td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print ucfirst($main_approved_by); ?></td></tr>
	<tr><td style="background-color:#467898; color:white;" class="shipmentTB4">Submited Date</td><td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print substr($main_submited_date,0,16); ?></td></tr>
	<tr><td style="background-color:#467898; color:white;" class="shipmentTB4">Submited By</td><td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><?php print ucfirst($main_submited_by); ?></td></tr>
	...
	<tr><td style="background-color:#467898; color:white;" class="shipmentTB4"><a style="text-decoration:none; color:white; cursor:pointer" title="Once selected, only the fist comment in the item list will be shown.&#013;The QTY will be '1' and Unit price will shown as a total.">Once Description Mode</a></td><td style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4"><input type="checkbox" id="onemode" onchange="oneDescriptionMode()" /></td></tr>
	<?php 
		 if($qm_status==5){
		...
		if($main_image==0){
			print '<tr><td colspan="2" style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4" align="center"><form enctype="multipart/form-data" action="index.php?components='.$components.'&action=qo_add_image&id='.$_GET['id'].'" method="post" onsubmit="return validateQOImage()"><input type="file" name="fileToUpload1" id="fileToUpload1" /><div id="div_submit"><input type="submit" value="add image" /></div></form></td></tr>';
		}else{
			print '<tr><td colspan="2" style="background-color:#DDDDDD; color:maroon;" class="shipmentTB4" align="center"><form action="index.php?components='.$components.'&action=qo_img_height&id='.$_GET['id'].'" method="post" onsubmit="return validateImgHeight()"><strong>Image</strong>&nbsp;&nbsp;<input type="number" name="height" id="height" value="'.$main_image_hei.'" style="width:50px" /><input type="submit" value="set" />&nbsp;&nbsp;&nbsp;<input type="button" value="Remove" onclick="deleteQOImage('.$_GET['id'].')" /><div id="div_submit"></div></form></td></tr>';
		}
		}
		?>
	</table>
	...
	<div>
	<table cellspacing="0">
	<tr><td style="font-weight:bold; color:#467898"><em>Followup Notes</em></td></tr>
	<tr><td>
		<table border="0" bordercolor="#C0C0C0" bgcolor="#EEEEEE" cellspacing="0" width="300px"><tr><td>
		<?php for($i=0;$i<sizeof($qn_noid);$i++){
			if($edit_note[$i]) $edit_button='<a href="index.php?components=supervisor&action=qo_finish&id='.$_GET['id'].'&comid='.$qn_noid[$i].'"><img src="/images/edit.gif" /></a>'; else $edit_button='';
			print '<div style="background-color:#99CCEE; font-size:10pt; border-radius: 5px; padding-left:4px; padding-right:3px"><strong>'.$qn_user[$i].'</strong><br />'.$qn_note[$i].' '.$edit_button.'<br />
	...
	<tr><td>
		<?php if($edit_note0=='') $action0='qo_add_note'; else $action0='qo_update_note'; ?>
		<form action="index.php?components=<?php print $components; ?>&action=<?php print $action0; ?>&id=<?php print $_GET['id']; ?>" onsubmit="return validateNote()" method="post" >
	...
	<tr><td bgcolor="#467898" style="font-family:Calibri; color:white; padding-left:10px">Quotation Status : <span <?php if($status=='Deleted') print 'class="blink"'; ?> style="color:<?php print $color; ?>;"><strong><?php print $status; ?></strong></span></td><td></td></tr>
	<tr><td valign="top">
	<!-- ------------------Quotation Item List-------------------------------------------------------- -->
	<table>
	<tr><td>Quotation No</td><td>:</td><td>QTN<?php print str_pad($quot_no, 7, "0", STR_PAD_LEFT); if($qo_v>1) print 'R'.($qo_v-1); ?></td></tr>
	<tr><td>Date</td><td>:</td><td><?php print $qo_date; ?></td></tr>
	<tr><td>Created By</td><td>:</td><td><?php print ucfirst($qo_salesman); ?></td></tr>
	<tr><td>Customer</td><td>:</td><td><?php print ucfirst($qo_cust_name); ?></td></tr>
	<tr><td>Subject</td><td>:</td><td><strong><?php print $qo_heading; ?></strong></td></tr>
	</table>
	<hr />
	<table align="center" width="100%" border="1" cellspacing="0" border="1" >
	<tr style="font-family:Arial; font-size:10pt; color:white; background-color:black; -webkit-print-color-adjust: exact;" ><th width="30px">#</th><th height="20px">DESCRIPTION</th><th class="shipmentTB3">ORDER<br/>QTY</th><th class="shipmentTB3">DELIVERED<br />QTY</th><th width="100px" >WORKFLOW</th></tr>
<?php
	$total_discount=0;
	for($i=0;$i<sizeof($qi_item_des);$i++){
		...
		$workflow_table='<table border="1" cellspacing="0"><tr bgcolor="#467898" style="color:#F9F9F9;"><th>Primary</th><th>Secondary</th></tr><tr><td><select><option>-SELECT-</option><option value="1">Shipping</option><option value="2">Manufacturing</option></select></td><td><select><option>-SELECT-</option><option value="1">Shipping</option><option value="2">Manufacturing</option></select></td></tr><tr><td><select><option>-SELECT-</option><option value="1">Shipping</option><option value="2">Manufacturing</option></select></td><td><select><option>-SELECT-</option><option value="1">Shipping</option><option value="2">Manufacturing</option></select></td></tr></table>';
		if($qi_qty[$i]==$qi_filled_qty[$i]) $color1='bgcolor="#EE7898"'; else $color1='';
		print '</div><br /></td><td style="border-bottom:0; border-top:0;" align="right" '.$color1.'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.number_format($qi_qty[$i]).'&nbsp;&nbsp;</td><td width="50px" style="border-bottom:0; border-top:0;" align="right" '.$color1.'>'.number_format($qi_filled_qty[$i]).'&nbsp;&nbsp;</td><td align="right" style="border-bottom:0; border-top:0;">'.$workflow_table.'</td></tr>';
		$total_discount+=$qi_qty[$i]*$qi_discount[$i];
	}
		print '<tr style="font-family:Arial; font-size:10pt; font-weight:600; color:white; background-color:black; -webkit-print-color-adjust: exact;"><td colspan="5" align="right" height="20px" style="padding-right:5px; border-right:1; border-bottom:0; ">&nbsp</td></tr>';	
?>	
	</table>
	
	<!-- --------------------------------------------------------------------------------------------- -->
	</td><td width="20px"></td><td valign="top" align="center">
					<div class="prtbutton1">
					<a class="shortcut-button" style="text-decoration:none; font-family:Arial; color:white;" target="_blank" href="index.php?components=<?php print $components; ?>&action=qo_finish&id=<?php print $_GET['id']; ?>">
						<img src="images/quotation.png" alt="icon" /><br />
						Print View
					</a>
					</div>
	<?php 
		if($qm_status==2 && $approver){ ?>
					<div id="button_div1" class="prtbutton1">
					<a class="shortcut-button" style="text-decoration:none;" onclick="setQuotStatus('<?php print $_GET['id']; ?>','Approve')" href="#">
			...
			<br />
					...
					<a class="shortcut-button" style="text-decoration:none;" onclick="setQuotStatus('<?php print $_GET['id']; ?>','Reject')" href="#">
					<span style="text-decoration:none; font-family:Arial; color:navy;">
	...
	<?php } ?>
	<?php if($qm_status==2 || $qm_status==3 || $qm_status==5){ ?>
					<br />
					<div id="revise_div" class="prtbutton1">
					<a class="shortcut-button" style="text-decoration:none; font-family:Arial; color:white;" onclick="reviseQuot(<?php print $_GET['id']; ?>)" href="#">
						<img src="images/revise.png" alt="icon" /><br />
						Revise
					</a>
					</div>
	<?php } ?>
	<br />
		<?php if(($authorize)&&($qm_status==1 || $qm_status==2 || $qm_status==3)){ ?>
					<div id="button_div1" class="prtbutton2">
					<a class="shortcut-button" style="text-decoration:none; font-family:Arial; color:navy;" onclick="setQuotStatus('<?php print $_GET['id']; ?>','Delete')" href="#">
						<img src="images/cancel.png" alt="icon" /><br />
						Cancel
					</a>
					</div>
		<?php }else if($qm_status==6 || $qm_status==7){ 
						if($qm_status==6){?>
							<div id="button_div1" class="prtbutton1">
							<a class="shortcut-button" target="_blank" href="index.php?components=billing&action=new_bill&quotation=<?php print $_GET['id']; ?>&cust_odr=yes&cust_id=<?php print $qm_cust; ?>&salesman=<?php print $qm_created_by; ?>" style="text-decoration:none;">
							...
							<br />
							<div id="button_div1" class="prtbutton1">
							<a class="shortcut-button" target="_blank" href="index.php?components=purchase_order&action=home&item_list=<?php print $qitem_list; ?>&qty_list=<?php print $qqty_list; ?>" style="text-decoration:none;">
							<span style="text-decoration:none; font-family:Arial; color:white;">
					...
					<br />
					<div id="button_div1" style="background-color:#6699FF; border:medium; border-color:black; width:80px; border-radius: 15px; font-size:10pt">
					<a class="shortcut-button" href="index.php?components=billing&action=finish_bill&id=<?php print $bm_no[$i]; ?>" style="text-decoration:none;">
					<span style="text-decoration:none; font-family:Arial; color:navy;">
