...
<div id="printheader" style="display:none" >
	...
	<h2 align="center" style="color:#3333FF; text-decoration:underline">Temporary Bills [Store : <?php print $_COOKIE['store_name']; ?>]</h2>
</div>
...
<table align="center" style="font-family:Calibri; border-radius: 15px; padding-left:20px; padding-right:20px" bgcolor="#EEEEEE" width="600px"	>
    <tr>
        <td colspan="2" style="color:navy; font-size:14pt; font-weight:bold" align="center">List Of Temporary Bills [Current Store]</td>
    </tr>
</table>
