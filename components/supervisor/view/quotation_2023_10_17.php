	...
	<tr>
						...
						<?php }else{ ?>
							...
							<tr>
								<td colspan="2" align="right"><br />
									<div id="addtobill">
										<?php if(sizeof($qo_itm_des)<$apend_limit) print '<input type="submit" value="Add to Quot" style="width:100px; height:30px" onclick="cashBack()" />'; ?>
									</div>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<td valign="top">
			...
			<div style="background-color:#D1D8F1; border-radius: 5px; padding-left:20px; padding-right:20px; height:500px;">
				<br />
				<?php if(isset($_REQUEST['id'])) { ?>
					<span style="font-weight:bold; font-size:12pt;" >Quotation No: &nbsp;&nbsp;&nbsp;<?php print str_pad($_REQUEST['id'], 7, "0", STR_PAD_LEFT); ?>
					</span>
					<br /><br /><br />
							...
							for($i=0;$i<sizeof($qo_itm_des);$i++){
								...
								print '<tr style="font-size:12pt">
										...
										if(($systemid != 13) && ($components != 'to')){
											print '<td width="80px" align="right">'.number_format(($qo_itm_uprice[$i]*$qo_itm_qty[$i]),2).'</td>';
										 }
								print '</tr>';
							}
							if(($systemid != 13) && ($components != 'to')){
