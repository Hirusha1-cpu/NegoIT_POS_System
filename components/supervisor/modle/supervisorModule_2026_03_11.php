...
function generateQuot($case)
{
	...
	$qi_tmp_invoice_no, $tax_added_value, $sub_total, $trn_no, $tax, $qo_price_inc_tax, $qo_comment;
	$quot_no = $_REQUEST['id'];
	$total = 0;
...
function qoDetails()
{
	...
	$main_image, $main_image_hei, $qitem_list, $qqty_list, $is_quotation_sent_with_tax, $tax_display_format, $main_comment;
	include('config.php');
	$quot_no = $_GET['id'];
...
function getReportNote($sub_system)
{
	...
	$qn_status_color, $qm_custname, $qm_mobile, $qm_tel;
