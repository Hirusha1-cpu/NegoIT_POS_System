...
<table align="center" style="font-family:Calibri; font-weight:bold;" width="300px"><tr style="background-color:#EEEEEE"><td align="center"><input type="text" id="invoice_no" name="invoice_no" placeholder="Job No" style="width:80px; text-align:center" value="<?php print $invoice_no; ?>" /></td><td width="50px" align="center"><div id="auth_result" style="color:red; font-weight:bold"></div></td><td><input type="submit" value="Search Job" style="width:80px; height:40px" /></td></tr></table>
</form>
