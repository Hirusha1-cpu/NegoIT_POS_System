...
function handleDeleteInvoiceValue($conn, $batch_id, $action_name)
{
    ...
    `entity_type`, `entity_id`, `entity_name`, `invoice_total`, `class_id`, `department_id`
...
function handlePaymentInsertThroughBillInsert($conn, $batch_id, $action_name)
{
    ...
    // }
    // Fetch all records for the given batch
    $query = "SELECT `id`, `payment_id`, `invoice_no`, `posting_type`, `account_id`, `account_name`, `amount`, `description`, `entity_type`, `entity_id`, `entity_name`,`class_id`,`department_id`
          FROM qb_queue WHERE `batch_id` = '$batch_id'";
    $result = mysqli_query($conn, $query);
...
{
    $query = "SELECT `id`, `invoice_no`, `posting_type`, `account_id`, `account_name`, `amount`, `description`, `entity_type`, `entity_id`, `entity_name`,`class_id`,`department_id`
          FROM qb_queue WHERE `batch_id` = '$batch_id'";
    $result = mysqli_query($conn, $query);
...
function handleReturnItemInvoiceInsertThroughODRInsert($conn, $batch_id, $action_name)
{
    ...
    // 	$result = mysqli_query($conn, $error_log_query);
    // }
    $query = "SELECT `id`, `invoice_no`, `posting_type`, `account_id`, `amount`, `account_name`, `description`, `entity_type`, `entity_id`, `entity_name`, `class_id`, `department_id`
          FROM qb_queue WHERE `batch_id` = '$batch_id'";
    $result = mysqli_query($conn, $query);
...
function handleInvoiceInsertThroughODRInsert($conn, $batch_id, $action_name)
{
    ...
    // 	$result = mysqli_query($conn, $error_log_query);
    // }
    $query = "SELECT `id`, `invoice_no`, `posting_type`, `account_id`, `account_name`, `description`, `entity_type`, `entity_id`, `entity_name`, `invoice_total`, `invoice_cost`, `class_id`, `department_id`
          FROM qb_queue WHERE `batch_id` = '$batch_id'";
    $result = mysqli_query($conn, $query);
...
function handleShipmentInsert($conn, $batch_id, $action_name)
{
    ...
    $query = "SELECT `id`, `posting_type`, `account_id`, `account_name`, `amount`, `description`, `entity_type`, `entity_id`, `entity_name`, `shipment_no`, `class_id`, `department_id` FROM qb_queue
...
function handleShipmentPayInsert($conn, $batch_id, $action_name)
{
    ...
    $query = "SELECT `id`, `posting_type`, `account_id`, `account_name`, `amount`, `description`, `entity_type`, `entity_id`, `entity_name`, `shipment_no`, `class_id`, `department_id`
          FROM qb_queue WHERE `batch_id` = '$batch_id'";
    $result = mysqli_query($conn, $query);
...
function handleShipmentPayDelete($conn, $batch_id, $action_name)
{
    ...
    $query = "SELECT `id`, `posting_type`, `account_id`, `account_name`, `amount`, `description`, `entity_type`, `entity_id`, `entity_name`, `shipment_no`,`shipment_pay_id`,`class_id`, `department_id`
          FROM qb_queue WHERE `batch_id` = '$batch_id'";
    $result = mysqli_query($conn, $query);
...
function handleClearChequeInsertThroughPaymentDeposit($conn, $batch_id, $action_name)
{
    ...
    $query = "SELECT `id`, `payment_id`, `posting_type`, `account_id`, `account_name`, `amount`, `description`, `entity_type`, `entity_id`,`class_id`, `department_id`
          FROM qb_queue WHERE `batch_id` = '$batch_id'";
    $result = mysqli_query($conn, $query);
...
function handleDeleteInvoiceCost($conn, $batch_id, $action_name)
{
    ...
    // Fetch all records for the given batch
    $query = "SELECT `id`, `invoice_no`, `posting_type`, `account_id`, `account_name`, `description`, `entity_type`, `entity_id`, `entity_name`, `invoice_cost`, `class_id`, `department_id`
          FROM qb_queue WHERE `batch_id` = '$batch_id'";
    $result = mysqli_query($conn, $query);
...
{
    // Fetch all records for the given batch
    $query = "SELECT `id`, `invoice_no`, `posting_type`, `account_id`, `account_name`, `description`, `entity_type`, `entity_id`, `entity_name`, `amount`, `class_id`, `department_id`
          FROM qb_queue WHERE `batch_id` = '$batch_id'";
    $result = mysqli_query($conn, $query);
...
function handleQtyAdjustInsert($conn, $batch_id, $action_name)
{
    ...
    $query = "SELECT `id`, `posting_type`, `account_id`, `account_name`, `amount`, `description`, `entity_type`, `entity_id`,`class_id`, `department_id`
          FROM qb_queue WHERE `batch_id` = '$batch_id'";
    $result = mysqli_query($conn, $query);
...
{
    // Fetch all journal entries for the given batch from qb_queue
    $query = "SELECT `id`, `journal_id`, `posting_type`, `account_id`, `account_name`, `amount`, `description`, `entity_type`, `entity_id`, `entity_name`, `class_id`, `department_id`
          FROM qb_queue WHERE `batch_id` = '$batch_id'";
    $result = mysqli_query($conn, $query);
...
function handleBillTaxInsert($conn, $batch_id, $action_name)
{
    // Fetch all records for the given batch from the qb_queue
    $query = "SELECT id, invoice_no, posting_type, account_id, account_name, amount, `description`, entity_type, entity_id, `class_id`, `department_id`
          FROM qb_queue WHERE batch_id = '$batch_id'";
    $result = mysqli_query($conn, $query);
    ...
    if (count($journal_entries) > 1) {
        try {
            ...
            if (isset($qb_result['status']) && $qb_result['status'] == 'success') {
                ...
                if ($qb_journal_entry_id != '') {
                    $update_query = "UPDATE bill_main SET `qb_bill_tax_id` = '$qb_journal_entry_id' WHERE `invoice_no` = '$invoice_no'";
                    $update_result = mysqli_query($conn, $update_query);
                    ...
                    if (!$update_result) {
                        ...
                        $update_deleted_queue = "UPDATE qb_queue SET `status` = 2 WHERE `id` IN ($failed_ids_str)";
                        mysqli_query($conn, $update_deleted_queue);
                        logQbError($conn, $action_name, "QuickBooks bill_main qb_bill_tax_id update error. Journal Entry ID: " . $qb_journal_entry_id, $invoice_no);
                    } else {
                        $failed_ids = array();
                        foreach ($queue_ids as $id) {
                            $delete_query = "DELETE FROM qb_queue WHERE `id` = $id";
...
function handleBillTaxDelete($conn, $batch_id, $action_name)
{
    // Fetch all records for the given batch from the qb_queue
    $query = "SELECT id, invoice_no, posting_type, account_id, account_name, amount, `description`, entity_type, entity_id,`class_id`, `department_id`
          FROM qb_queue WHERE batch_id = '$batch_id'";
    ...
    if (count($journal_entries) > 1) {
        try {
            ...
            if (isset($qb_result['status']) && $qb_result['status'] == 'success') {
                ...
                if ($qb_journal_entry_id != '') {
                    $update_query = "UPDATE bill_main SET `qb_bill_tax_deleted_id` = '$qb_journal_entry_id' WHERE `invoice_no` = '$invoice_no'";
                    $update_result = mysqli_query($conn, $update_query);
                    ...
                    if (!$update_result) {
                        ...
                        $update_deleted_queue = "UPDATE qb_queue SET `status` = 2 WHERE `id` IN ($failed_ids_str)";
                        mysqli_query($conn, $update_deleted_queue);
                        logQbError($conn, $action_name, "QuickBooks bill_main qb_bill_tax_deleted_id update error. Journal Entry ID: " . $qb_journal_entry_id, $invoice_no);
                    } else {
                        $failed_ids = array();
                        foreach ($queue_ids as $id) {
                            $delete_query = "DELETE FROM qb_queue WHERE `id` = $id";
            ...
            if ($row = mysqli_fetch_assoc($result)) {
                ...
                switch ($action_name) {
                    ...
                    case 'revers_bank_payment_deposit': // back end
                        $handlerSuccess = handleCashOnHandDepositInsert($conn, $batch_id, $action_name);
                        break;
                    case 'bill_tax_insert': // back end
                        $handlerSuccess = handleBillTaxInsert($conn, $batch_id, $action_name);
                        break;
                    case 'bill_tax_delete': // back end
                        $handlerSuccess = handleBillTaxDelete($conn, $batch_id, $action_name);
                        break;
                    default:
