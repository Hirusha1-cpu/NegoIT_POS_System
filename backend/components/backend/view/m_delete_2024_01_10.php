...
<!-- ------------------Item List----------------------- -->
	...
	?></td></tr></table>
	<table align="center">
	<tr><td bgcolor="#DDDDDD" style="padding-left:10px; padding-right:10px;">Bill</td><td><form method="post" action="index.php?components=backend&action=delete_search&type=bill"><input type="number" style="width:100px" name="search1" id="search1" placeholder="Invoice Number" /><input type="Submit" value="Search" /></form></td></tr>
	<tr><td bgcolor="#DDDDDD" style="padding-left:10px; padding-right:10px;">Payment</td><td><form method="post" action="index.php?components=backend&action=delete_search&type=pay"><input type="number" style="width:100px" name="search2" id="search2" placeholder="Payment Number" /><input type="Submit" value="Search" /></form></td></tr>
	<tr><td bgcolor="#DDDDDD" style="padding-left:10px; padding-right:10px;">Commission Report</td><td><form method="post" action="index.php?components=backend&action=delete_search&type=commission"><input type="number" style="width:100px" name="search3" id="search3" placeholder="Commission Number" /><input type="Submit" value="Search" /></form></td></tr>
	</table>
	<br>
	<?php 
