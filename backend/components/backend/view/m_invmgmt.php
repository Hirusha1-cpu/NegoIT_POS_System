		...
		<div class="w3-col">
			...
			if ($inv_found) { ?>
				<table align="center" style="font-family:Calibri;">
					<tr>
						<th style="background-color:#467898;color :white;" width="150px">Bill No</th>
					...
					<table align="center" style="font-family:Calibri;" bgcolor="#EEEEEE">
						<tr>
							<td>
								<table align="center" style="font-family:Calibri;">
									<tr>
										<th style="background-color:#467898;color:white;" width="100px">Type</th>
										<th>
											<select name="type" id="typeSelect" onchange="updateStatus()">
												<option value="1" <?php if ($inv_type_id == 1)
													print 'selected="selected"'; ?>>Sales Bill</option>
												<option value="4" <?php if ($inv_type_id == 4)
													print 'selected="selected"'; ?>>Cust Order</option>
											</select>
										</th>
									</tr>
									<tr>
									...
									<tr>
										<th style="background-color:#467898;color:white;" width="100px">SMS</th>
										<th>
											<select name="sms">
												<option value="1" <?php if ($inv_sms == 1)
													print 'selected="selected"'; ?>>Sent</option>
												<option value="0" <?php if ($inv_sms == 0)
													print 'selected="selected"'; ?>>Not Send</option>
											</select>
										</th>
									</tr>
								</table>
								...
								<script>
									function updateStatus() {
										...
										// If "Cust Order" (value 4) is selected, set status to "Billed" (value 1)
