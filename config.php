...
if (file_exists(__DIR__ . '/config.local.php')) {
    ...
    return; // stop here, don't run the SERVER_NAME switch
}
switch ($_SERVER['SERVER_NAME']) {
	...
	case "billing1.localhost.local":
		$conn = mysqli_connect('localhost', 'zigo_dbuser', 'zigo1234', 'zigo');
		$conn2 = mysqli_connect('localhost', 'zigo_dbuser', 'zigo1234', 'zigo');
		if (mysqli_connect_errno()) {
			echo "Failed to connect to MySQL: " . mysqli_connect_error();
		}
		break;
	...
	case "billing24.localhost.local":
		$conn = mysqli_connect('localhost', 'orient_dbuser', 'orient#44512', 'orientcare24');
		$conn2 = mysqli_connect('localhost', 'orient_dbuser', 'orient#44512', 'orientcare24');
		if (mysqli_connect_errno()) {
			echo "Failed to connect to MySQL: " . mysqli_connect_error();
		}
		break;
	...
	case "billing26.localhost.local":
		$conn = mysqli_connect('localhost', 'nego_test', 'ggdjJs612#212', 'testbilling26');
		$conn2 = mysqli_connect('localhost', 'nego_test', 'ggdjJs612#212', 'testbilling26');
		if (mysqli_connect_errno()) {
			echo "Failed to connect to MySQL: " . mysqli_connect_error();
		}
		break;
